...
description: Generate SWLOR NPC-delivered quest content from concepts or batch specs. Use when creating, expanding, or repairing quests end to end in this repository, including quest definitions, NPC dialogue and player replies, journal text, rewards, prerequisite quests or key items, key item grants/removals, kill or collect objectives, lore-appropriate content hooks, NPC/enemy placement in Module JSON, spawn table wiring, and validation.
---
