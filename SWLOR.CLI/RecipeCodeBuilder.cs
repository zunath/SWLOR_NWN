    ...
    internal class RecipeCodeBuilder
    {
        ...
        public void Process()
        {
            ...
            foreach (var line in inputLines)
            {
                ...
                var component2Quantity = data[14].Trim();
                var component3Resref = data[15].Trim();
                var component3Quantity = data[16].Trim();
                var component4Resref = data[17].Trim();
                var component4Quantity = data[18].Trim();
