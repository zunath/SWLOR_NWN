...
namespace SWLOR.Component.Ability.Definitions.Devices
{
    public class KoltoGrenadeAbilityDefinition : ExplosiveBaseAbilityDefinition
    {
        ...
        public KoltoGrenadeAbilityDefinition(
        ...
        private void KoltoGrenade1(IAbilityBuilder builder)
        {
            builder.Create(FeatType.KoltoGrenade1, PerkType.KoltoGrenade)
                ...
                .Level(1)
                .HasRecastDelay(RecastGroupType.KoltoGrenade, 30f)
                ...
                {
                    ExplosiveImpact(activator, location, EffectVisualEffect(VisualEffectType.Vfx_Fnf_Gas_Explosion_Nature), string.Empty, RadiusSize.Large, (target) =>
                    {
