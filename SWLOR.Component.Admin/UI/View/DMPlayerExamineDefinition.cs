...
namespace SWLOR.Component.Admin.UI.View
{
    public class DMPlayerExamineDefinition : IGuiWindowDefinition
    {
        ...
        private readonly GuiWindowBuilder<DMPlayerExamineViewModel> _builder;

        public DMPlayerExamineDefinition(IGuiService guiService)
        {
            _guiService = guiService;
            _builder = new GuiWindowBuilder<DMPlayerExamineViewModel>(_guiService);
        }
