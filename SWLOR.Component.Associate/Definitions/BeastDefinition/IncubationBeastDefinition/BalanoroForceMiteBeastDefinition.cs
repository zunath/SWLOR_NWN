...
{
    public class BalanoroForceMiteBeastDefinition: IBeastListDefinition
    {
        private readonly BeastBuilder _builder = new();

        public Dictionary<BeastType, BeastDetail> Build()
        {
            _builder.Create(BeastType.BalanoroForceMite)
                .Name("Balanoro Force Mite")
                .Appearance(AppearanceType.BugGFSquittyPLUSHHYENAofDOOM)
                .AppearanceScale(1f)
                .SoundSetId(9)
                .PortraitId(150)
