...
{
    public class BinarianSabercatBeastDefinition: IBeastListDefinition
    {
        private readonly BeastBuilder _builder = new();

        public Dictionary<BeastType, BeastDetail> Build()
        {
            _builder.Create(BeastType.BinarianSabercat)
                .Name("Binarian Sabercat")
                .Appearance(AppearanceType.CatKirreCCCMecheon)
                .AppearanceScale(1f)
                .SoundSetId(17)
                .PortraitId(165)
