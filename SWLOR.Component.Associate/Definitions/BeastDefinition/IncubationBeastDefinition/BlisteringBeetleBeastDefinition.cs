...
namespace SWLOR.Component.Associate.Definitions.BeastDefinition.IncubationBeastDefinition
{
    public class BlisteringBeetleBeastDefinition: IBeastListDefinition
    {
        private readonly BeastBuilder _builder = new();

        public Dictionary<BeastType, BeastDetail> Build()
        {
            _builder.Create(BeastType.BlisteringBeetle)
                .Name("Blistering Beetle")
                .Appearance(AppearanceType.BeetleBombardierBiowareSoulFilcher)
                .AppearanceScale(1f)
                .SoundSetId(9)
                .PortraitId(150)
		...
		private void Level45()
		{
			_builder
				...
				.MaxSavingThrowBonus(SavingThrowCategoryType.Will, 1)
				.MaxSavingThrowBonus(SavingThrowCategoryType.Fortitude, 1)
				.MaxSavingThrowBonus(SavingThrowCategoryType.Reflex, 5);
		}
