...
{
    public class BomaBeastBabyBeastDefinition: IBeastListDefinition
    {
        private readonly BeastBuilder _builder = new();

        public Dictionary<BeastType, BeastDetail> Build()
        {
            _builder.Create(BeastType.BomaBeastBaby)
                .Name("Boma Beast Baby")
                .Appearance(AppearanceType.SWLORBomaBeastBaby)
                .AppearanceScale(1f)
                .SoundSetId(323)
                .PortraitId(184)
