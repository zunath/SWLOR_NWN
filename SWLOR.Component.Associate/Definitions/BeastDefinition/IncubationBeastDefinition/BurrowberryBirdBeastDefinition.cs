...
{
    public class BurrowberryBirdBeastDefinition: IBeastListDefinition
    {
        private readonly BeastBuilder _builder = new();

        public Dictionary<BeastType, BeastDetail> Build()
        {
            _builder.Create(BeastType.BurrowberryBird)
                .Name("Burrowberry Bird")
                .Appearance(AppearanceType.BirdAxeBeak1CCP)
                .AppearanceScale(1f)
                .SoundSetId(324)
                .PortraitId(206)
