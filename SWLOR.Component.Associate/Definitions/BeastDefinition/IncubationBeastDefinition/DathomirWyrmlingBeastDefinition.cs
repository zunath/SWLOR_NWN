...
{
    public class DathomirWyrmlingBeastDefinition: IBeastListDefinition
    {
        private readonly BeastBuilder _builder = new();

        public Dictionary<BeastType, BeastDetail> Build()
        {
            _builder.Create(BeastType.DathomirWyrmling)
                .Name("Dathomir Wyrmling")
                .Appearance(AppearanceType.DragonChrBlackWyrmlingHardpoints)
                .AppearanceScale(1f)
                .SoundSetId(332)
                .PortraitId(191)
