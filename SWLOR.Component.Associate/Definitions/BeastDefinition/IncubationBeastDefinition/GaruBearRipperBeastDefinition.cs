...
{
    public class GaruBearRipperBeastDefinition: IBeastListDefinition
    {
        private readonly BeastBuilder _builder = new();

        public Dictionary<BeastType, BeastDetail> Build()
        {
            _builder.Create(BeastType.GaruBearRipper)
                .Name("Garu Bear Ripper")
                .Appearance(AppearanceType.BeastmanBear2bloodsong)
                .AppearanceScale(1f)
                .SoundSetId(12)
                .PortraitId(3479)
