...
{
    public class GiantGaruBearBeastDefinition: IBeastListDefinition
    {
        private readonly BeastBuilder _builder = new();

        public Dictionary<BeastType, BeastDetail> Build()
        {
            _builder.Create(BeastType.GiantGaruBear)
                .Name("Giant Garu Bear")
                .Appearance(AppearanceType.BeastmanBear1bloodsong)
                .AppearanceScale(1f)
                .SoundSetId(12)
                .PortraitId(3479)
