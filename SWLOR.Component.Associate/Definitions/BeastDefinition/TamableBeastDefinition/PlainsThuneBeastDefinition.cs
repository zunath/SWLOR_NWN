...
namespace SWLOR.Component.Associate.Definitions.BeastDefinition.TamableBeastDefinition
{
    public class PlainsThuneBeastDefinition: IBeastListDefinition
    {
        ...
        public Dictionary<BeastType, BeastDetail> Build()
        {
            _builder.Create(BeastType.PlainsThune)
                .Name("Plains Thune")
                .Appearance(AppearanceType.ElephantProjectQDraygothTheAmethystDragon)
