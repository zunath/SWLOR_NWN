...
namespace SWLOR.Game.Server.Feature.GuiDefinition
{
    internal class DroidAssemblyDefinition: IGuiWindowDefinition
    {
        ...
        private readonly GuiWindowBuilder<DroidAssemblyViewModel> _builder;

        public DroidAssemblyDefinition(IGuiService guiService)
        {
            _guiService = guiService;
            _builder = new GuiWindowBuilder<DroidAssemblyViewModel>(_guiService);
        }
