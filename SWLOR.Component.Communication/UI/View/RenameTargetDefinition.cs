...
namespace SWLOR.Component.Communication.UI.View
{
    public class RenameTargetDefinition : IGuiWindowDefinition
    {
        ...
        private readonly GuiWindowBuilder<RenameTargetViewModel> _builder;

        public RenameTargetDefinition(IGuiService guiService)
        {
            _guiService = guiService;
            _builder = new GuiWindowBuilder<RenameTargetViewModel>(_guiService);
        }
