...
namespace SWLOR.Component.Crafting.UI.View
{
    public class CraftDefinition : IGuiWindowDefinition
    {
        ...
        private readonly GuiWindowBuilder<CraftViewModel> _builder;

        public CraftDefinition(IGuiService guiService)
        {
            _guiService = guiService;
            _builder = new GuiWindowBuilder<CraftViewModel>(_guiService);
        }
