...
namespace SWLOR.Component.Crafting.UI.View
{
    public class RecipesDefinition : IGuiWindowDefinition
    {
        ...
        private readonly GuiWindowBuilder<RecipesViewModel> _builder;

        public RecipesDefinition(IGuiService guiService)
        {
            _guiService = guiService;
            _builder = new GuiWindowBuilder<RecipesViewModel>(_guiService);
        }
