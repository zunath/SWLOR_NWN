...
namespace SWLOR.Component.Crafting.UI.View
{
    public class RefineryDefinition : IGuiWindowDefinition
    {
        ...
        private readonly GuiWindowBuilder<RefineryViewModel> _builder;

        public RefineryDefinition(IGuiService guiService)
        {
            _guiService = guiService;
            _builder = new GuiWindowBuilder<RefineryViewModel>(_guiService);
        }
