...
namespace SWLOR.Component.Crafting.UI.View
{
    public class ResearchDefinition: IGuiWindowDefinition
    {
        private readonly IGuiService _guiService;
        private readonly GuiWindowBuilder<ResearchViewModel> _builder;

        public ResearchDefinition(IGuiService guiService)
        {
            _guiService = guiService;
            _builder = new GuiWindowBuilder<ResearchViewModel>(_guiService);
        }
