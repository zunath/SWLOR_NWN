...
namespace SWLOR.Component.Crafting.UI.ViewModel
{
        ...
        IGuiRefreshable<PerkRefundedRefreshEvent>
    {
        ...
        private RecipesUIModeType _mode;
        ...
        private void LoadSkills()
        {
            ...
            var set = _mode == RecipesUIModeType.Research 
        ...
        private void Search()
        {
            ...
            if (SelectedSkillId > 0 && SelectedCategoryId > 0)
            {
                ...
                if (_mode == RecipesUIModeType.Research)
                {
            ...
            if (!string.IsNullOrWhiteSpace(SearchText))
            {
                recipes = recipes
                    .Where(x =>
                        _itemCache.GetItemNameByResref(x.Value.Resref)
                            .ToLower()
            ...
            {
                recipes = recipes
                    .Where(x => _mode == RecipesUIModeType.Research
            ...
            {
                var canCraft = _mode == RecipesUIModeType.Research
