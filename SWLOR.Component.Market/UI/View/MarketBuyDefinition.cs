...
namespace SWLOR.Component.Market.UI.View
{
    public class MarketBuyDefinition : IGuiWindowDefinition
    {
        ...
        private readonly GuiWindowBuilder<MarketBuyViewModel> _builder;

        public MarketBuyDefinition(IGuiService guiService)
        {
            _guiService = guiService;
            _builder = new GuiWindowBuilder<MarketBuyViewModel>(_guiService);
        }
