...
namespace SWLOR.Component.Market.UI.View
{
    public class MarketListingDefinition : IGuiWindowDefinition
    {
        ...
        private readonly GuiWindowBuilder<MarketListingViewModel> _builder;

        public MarketListingDefinition(IGuiService guiService)
        {
            _guiService = guiService;
            _builder = new GuiWindowBuilder<MarketListingViewModel>(_guiService);
        }
