...
namespace SWLOR.Component.Player.UI.View
{
    public class CharacterFullRebuildDefinition : IGuiWindowDefinition
    {
        ...
        private readonly GuiWindowBuilder<CharacterFullRebuildViewModel> _builder;

        public CharacterFullRebuildDefinition(IGuiService guiService)
        {
            _guiService = guiService;
            _builder = new GuiWindowBuilder<CharacterFullRebuildViewModel>(_guiService);
        }
