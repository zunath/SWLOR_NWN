...
namespace SWLOR.Component.Properties.UI.View
{
    public class ManageStructuresDefinition: IGuiWindowDefinition
    {
        ...
        private readonly GuiWindowBuilder<ManageStructuresViewModel> _builder;

        public ManageStructuresDefinition(IGuiService guiService)
        {
            _guiService = guiService;
            _builder = new GuiWindowBuilder<ManageStructuresViewModel>(_guiService);
        }
