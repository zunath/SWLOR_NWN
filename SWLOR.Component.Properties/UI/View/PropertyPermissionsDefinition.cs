...
namespace SWLOR.Component.Properties.UI.View
{
    public class PropertyPermissionsDefinition: IGuiWindowDefinition
    {
        ...
        private readonly GuiWindowBuilder<PropertyPermissionsViewModel> _builder;

        public PropertyPermissionsDefinition(IGuiService guiService)
        {
            _guiService = guiService;
            _builder = new GuiWindowBuilder<PropertyPermissionsViewModel>(_guiService);
        }
