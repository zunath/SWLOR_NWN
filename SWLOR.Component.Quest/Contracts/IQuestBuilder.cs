...
namespace SWLOR.Component.Quest.Contracts
{
    public interface IQuestBuilder
    {
        ...
        /// <returns>A QuestBuilder with the configured options.</returns>
        IQuestBuilder OnAcceptAction(AcceptQuestDelegate action);
        ...
        /// <returns>A QuestBuilder with the configured options.</returns>
        IQuestBuilder OnAbandonAction(AbandonQuestDelegate action);
        ...
        /// <returns>A QuestBuilder with the configured options.</returns>
        IQuestBuilder OnAdvanceAction(AdvanceQuestDelegate action);
        ...
        /// <returns>A QuestBuilder with the configured options.</returns>
        IQuestBuilder OnCompleteAction(CompleteQuestDelegate action);
