    ...
    public class QuestDetail
    {
        ...
        private void RequestRewardSelectionFromPC(uint player, uint questSource)
        {
            ...
            if (AllowRewardSelection)
            {
                ...
                _dialog.StartConversation(player, player, nameof(QuestRewardSelectionDialog));
            }
            else
            {
        ...
        public void Accept(uint player, uint questSource)
        {
            ...
            var playerId = GetObjectUUID(player);
            var dbPlayer = _db.Get<Player>(playerId);
            var quest = _quest.GetQuestById(QuestId);
            ...
            _gui.PublishRefreshEvent(player, new QuestAcquiredRefreshEvent(QuestId));
        }
        ...
        public void Advance(uint player, uint questSource)
        {
            ...
            else
            {
                ...
                _gui.PublishRefreshEvent(player, new QuestProgressedRefreshEvent(QuestId));
            }
