...
namespace SWLOR.Component.Space.Feature.ShipModuleDefinition
{
    public class IonCannonModuleDefinition : IShipModuleListDefinition
    {
        ...
        public IonCannonModuleDefinition(IServiceProvider serviceProvider, IShipModuleBuilder builder)
        {
            ...
            _builder.Create(itemTag)
                ...
                .ActivatedAction((activator, activatorShipStatus, target, targetShipStatus, moduleBonus) =>
                {
                    ...
                    if (isHit)
                    {
                        ...
                        {
                            var effect = EffectBeam(VisualEffectType.Vfx_Beam_Mind, activator, BodyNodeType.Chest);
                        ...
                        DelayCommand(0.1f, () =>
                        {
                            AssignCommand(activator, () =>
                            {
                                ...
                                var effect = EffectVisualEffect(VisualEffectType.Vfx_Imp_Dispel, false, 0.5f);
                    ...
                    else
                    {
                        AssignCommand(activator, () =>
                        {
                            var effect = EffectBeam(VisualEffectType.Vfx_Beam_Cold, activator, BodyNodeType.Chest, true);
                            ApplyEffectToObject(DurationType.Temporary, effect, target, 1.0f);
                        });
