...
namespace SWLOR.Component.Space.UI.View
{
    public class TargetStatusDefinition : IGuiWindowDefinition
    {
        private readonly IGuiService _guiService;
        private readonly GuiWindowBuilder<TargetStatusViewModel> _builder;

        public TargetStatusDefinition(IGuiService guiService)
        {
            _guiService = guiService;
            _builder = new GuiWindowBuilder<TargetStatusViewModel>(_guiService);
        }
