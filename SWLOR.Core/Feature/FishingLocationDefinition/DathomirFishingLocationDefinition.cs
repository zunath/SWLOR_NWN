using SWLOR.Core.Service.FishingService;

namespace SWLOR.Core.Feature.FishingLocationDefinition
{
    public class DathomirFishingLocationDefinition : IFishingLocationDefinition
    {
        ...
        {
            _builder
                .Create(FishingLocationType.DathomirDesertWestSide)
        ...
        {
            _builder
                .Create(FishingLocationType.DathomirGrottoCaverns)
        ...
        {
            _builder
                .Create(FishingLocationType.DathomirGrottos)
        ...
        {
            _builder
                .Create(FishingLocationType.DathomirMountains)
        ...
        {
            _builder
                .Create(FishingLocationType.DathomirTribeVillage)
