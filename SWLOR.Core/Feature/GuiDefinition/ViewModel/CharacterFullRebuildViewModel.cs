...
using Ability = SWLOR.Core.Service.Ability;
using ClassType = SWLOR.Core.NWScript.Enum.ClassType;
using InventorySlot = SWLOR.Core.NWScript.Enum.InventorySlot;
using RacialType = SWLOR.Core.NWScript.Enum.RacialType;
using SavingThrow = SWLOR.Core.NWScript.Enum.SavingThrow;
using Skill = SWLOR.Core.Service.Skill;
