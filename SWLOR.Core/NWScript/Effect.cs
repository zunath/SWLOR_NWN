...
using Alignment = SWLOR.Core.NWScript.Enum.Alignment;
using DamageType = SWLOR.Core.NWScript.Enum.DamageType;
using RacialType = SWLOR.Core.NWScript.Enum.RacialType;
using SpellSchool = SWLOR.Core.NWScript.Enum.SpellSchool;

namespace SWLOR.Core.NWScript
{
