        ...
        public List<AbilityBehaviorCase> BuildCases()
        {
            return new List<AbilityBehaviorCase>
            {
                ...
                new()
                {
                    ...
                    ExpectsSTMCost = true,
                    ExpectsRecast = true,
                    Notes = "Extends existing Venom/Infection status durations on hit; requires a pre-existing status not present on a fresh target, not asserted.",
                },
                new()
                {
                ...
                new()
                {
                    ...
                    ExpectsSTMCost = true,
                    ExpectsRecast = true,
                    Notes = "ExposedStatusEffect on the target grants extra damage on hit; not asserted (weapon-queued, no landed-hit assertions).",
                },
                new()
                {
                ...
                new()
                {
                    ...
                    ExpectsSTMCost = true,
                    ExpectsRecast = true,
                    Notes = "VenomStatusEffect application is an on-hit rider; weapon-queued abilities only assert queue/cost/recast.",
                },
                new()
                {
