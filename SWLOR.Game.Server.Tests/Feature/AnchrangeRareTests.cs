...
public class AnchrangeRareTests
{
    private static readonly (string Resref, string RareLootTable)[] RareElites =
    {
        ("canyonbulwrk", "ANCHRANGE_CANYON_RARES"),
        ("dunedeadeye", "ANCHRANGE_DEADEYE_RARES"),
        ("deadhandzeph", "ANCHRANGE_DEADHAND_RARES"),
    };
    private const string RareSpawnTable = "ANCHORHEAD_CANYON_RANGE_RARES";
    private static readonly (string Blueprint, RecipeType Recipe, string CraftedResref, string Component)[] RareRecipes =
    {
        ("bp_canyonbulwrk", RecipeType.SalvagedCanyonGauntlets, "canyonbulwrkcr", "canyonbulwrkcm"),
        ("bp_dunedeadeye", RecipeType.SalvagedDeadeyeVisor, "dunedeadeyecr", "dunedeadeyecm"),
        ("bp_deadhandzeph", RecipeType.SalvagedDeadHandCuirass, "deadhandzephcr", "deadhandzephcm"),
    };

    [Test]
    public void AnchrangeRareTests_UseWeightedRareEntriesInDedicatedTable()
    {
        var spawns = new TatooineSpawnDefinition().BuildSpawnTables()[RareSpawnTable].Spawns;
    ...
    [Test]
    public void AnchrangeRareTests_LootIsUniqueRareGear()
    {
    ...
    [Test]
    public void AnchrangeRareTests_RecipesAreRegisteredWithSalvageComponents()
    {
    ...
    [Test]
    public void AnchrangeRareTests_BlueprintsLearnRegisteredRecipes()
    {
