...
public class DanenclaveRareTests
{
    private static readonly (string Resref, string RareLootTable)[] RareElites =
    {
        ("sabraetrial", "DANENCLAVE_SABRAE_RARES"),
        ("enclavesentl", "DANENCLAVE_SENTINEL_RARES"),
        ("cycloneadpt", "DANENCLAVE_CYCLONE_RARES"),
    };
    private const string RareSpawnTable = "DANTOOINE_JEDI_ENCLAVE_TRIAL_HALLS_RARES";
    private static readonly (string Blueprint, RecipeType Recipe, string CraftedResref, string Component)[] RareRecipes =
    {
        ("bp_sabraetrial", RecipeType.SalvagedSabraeGauntlets, "sabraetrialcr", "sabraetrialcm"),
        ("bp_enclavesentl", RecipeType.SalvagedSentinelVisor, "enclavesentlcr", "enclavesentlcm"),
        ("bp_cycloneadpt", RecipeType.SalvagedCycloneCuirass, "cycloneadptcr", "cycloneadptcm"),
    };

    [Test]
    public void DanenclaveRareTests_UseWeightedRareEntriesInDedicatedTable()
    {
        var spawns = new DantooineSpawnDefinition().BuildSpawnTables()[RareSpawnTable].Spawns;
    ...
    [Test]
    public void DanenclaveRareTests_LootIsUniqueRareGear()
    {
    ...
    [Test]
    public void DanenclaveRareTests_RecipesAreRegisteredWithSalvageComponents()
    {
    ...
    [Test]
    public void DanenclaveRareTests_BlueprintsLearnRegisteredRecipes()
    {
