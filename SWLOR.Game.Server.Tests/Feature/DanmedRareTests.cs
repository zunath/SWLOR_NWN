...
public class DanmedRareTests
{
    private static readonly (string Resref, string RareLootTable)[] RareElites =
    {
        ("triagewarden", "DANMED_TRIAGE_RARES"),
        ("chemslinger", "DANMED_CHEM_RARES"),
        ("conduitmatrn", "DANMED_CONDUIT_RARES"),
    };
    private const string RareSpawnTable = "DANTOOINE_MEDICAL_SUBLEVEL_RARES";
    private static readonly (string Blueprint, RecipeType Recipe, string CraftedResref, string Component)[] RareRecipes =
    {
        ("bp_triagewarden", RecipeType.SalvagedTriageGauntlets, "triagewardencr", "triagewardencm"),
        ("bp_chemslinger", RecipeType.SalvagedChemVisor, "chemslingercr", "chemslingercm"),
        ("bp_conduitmatrn", RecipeType.SalvagedConduitCuirass, "conduitmatrncr", "conduitmatrncm"),
    };

    [Test]
    public void DanmedRareTests_UseWeightedRareEntriesInDedicatedTable()
    {
    ...
    [Test]
    public void DanmedRareTests_LootIsUniqueRareGear()
    {
    ...
    [Test]
    public void DanmedRareTests_RecipesAreRegisteredWithSalvageComponents()
    {
