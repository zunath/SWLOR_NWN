...
public class DathomirGrottoRareTests
{
    private static readonly (string Resref, string RareLootTable)[] RareElites =
    {
        ("grottoalpha", "DATHGROTTO_ALPHA_RARES"),
        ("spinequill", "DATHGROTTO_SPINE_RARES"),
        ("ritestalker", "DATHGROTTO_STALKER_RARES"),
    };
    private const string RareSpawnTable = "DATHOMIR_GROTTO_APEX_DEN_RARES";
    private static readonly (string Blueprint, RecipeType Recipe, string CraftedResref, string Component)[] RareRecipes =
    {
        ("bp_fanggaunt", RecipeType.SalvagedFangGauntlet, "fang_gaunt", "alpha_fang"),
        ("bp_ridgeplate", RecipeType.SalvagedRidgebonePlate, "ridge_plate", "spine_quill"),
        ("bp_ritecrown", RecipeType.SalvagedRiteCrown, "rite_crown", "spirit_totem"),
    };

    [Test]
    public void DathomirGrottoRareElites_UseWeightedRareEntriesInDedicatedTable()
    {
    ...
    [Test]
    public void DathomirGrottoRareEliteLoot_IsUniqueRareGear()
    {
    ...
    [Test]
    public void DathomirGrottoRareRecipes_AreRegisteredWithSalvageComponents()
    {
