...
// The Fight Club Backrooms dungeon (pw_sc_emfbackr) exists and carries the ambient capstone
// spawn table plus the three warden mini-bosses. The final masters live in the attached Private
// Pit boss arena, which is not built yet, so this suite covers only the dungeon wardens.
