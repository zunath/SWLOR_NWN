...
public class KorcryptRareTests
{
    private static readonly (string Resref, string RareLootTable)[] RareElites =
    {
        ("cryptwarden", "KORCRYPT_CRYPT_RARES"),
        ("markahunger", "KORCRYPT_HUNGER_RARES"),
        ("eclipseshade", "KORCRYPT_ECLIPSE_RARES"),
    };
    private const string RareSpawnTable = "KORRIBAN_SITH_CRYPT_DEPTHS_RARES";
    private static readonly (string Blueprint, RecipeType Recipe, string CraftedResref, string Component)[] RareRecipes =
    {
        ("bp_cryptwarden", RecipeType.SalvagedCryptGauntlets, "cryptwardencr", "cryptwardencm"),
        ("bp_markahunger", RecipeType.SalvagedHungerVisor, "markahungercr", "markahungercm"),
        ("bp_eclipseshade", RecipeType.SalvagedEclipseCuirass, "eclipseshadecr", "eclipseshadecm"),
    };

    [Test]
    public void KorcryptRareTests_UseWeightedRareEntriesInDedicatedTable()
    {
        var spawns = new KorribanSpawnDefinition().BuildSpawnTables()[RareSpawnTable].Spawns;
    ...
    [Test]
    public void KorcryptRareTests_LootIsUniqueRareGear()
    {
        var tables = new KorribanLootTableDefinition().BuildLootTables();
    ...
    [Test]
    public void KorcryptRareTests_RecipesAreRegisteredWithSalvageComponents()
    {
    ...
    [Test]
    public void KorcryptRareTests_BlueprintsLearnRegisteredRecipes()
    {
