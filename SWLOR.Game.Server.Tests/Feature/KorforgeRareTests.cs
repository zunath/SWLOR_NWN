...
public class KorforgeRareTests
{
    private static readonly (string Resref, string RareLootTable)[] RareElites =
    {
        ("forgewright", "KORFORGE_FORGE_RARES"),
        ("flameweaver", "KORFORGE_FLAME_RARES"),
        ("banecaller", "KORFORGE_BANE_RARES"),
    };
    private const string RareSpawnTable = "KORRIBAN_FORGE_CAVERNS_RARES";
    private static readonly (string Blueprint, RecipeType Recipe, string CraftedResref, string Component)[] RareRecipes =
    {
        ("bp_forgewright", RecipeType.SalvagedForgeGauntlets, "forgewrightcr", "forgewrightcm"),
        ("bp_flameweaver", RecipeType.SalvagedFlameVisor, "flameweavercr", "flameweavercm"),
        ("bp_banecaller", RecipeType.SalvagedBaneCuirass, "banecallercr", "banecallercm"),
    };

    [Test]
    public void KorforgeRareTests_UseWeightedRareEntriesInDedicatedTable()
    {
    ...
    [Test]
    public void KorforgeRareTests_LootIsUniqueRareGear()
    {
    ...
    [Test]
    public void KorforgeRareTests_RecipesAreRegisteredWithSalvageComponents()
    {
    ...
    [Test]
    public void KorforgeRareTests_BlueprintsLearnRegisteredRecipes()
    {
