...
public class SettingsWindowTests
{
    ...
    public void Tabs_UseSeparatePartialViewsAndPreserveWindowGeometry()
    {
        ...
        var partialSwap = changeSettingsView.IndexOf("SwapNestedPartialView(SettingsView, partialName, onAfterApply: RefreshPartialViewBindings);", StringComparison.Ordinal);
