...
public class VelesRareTests
{
    private static readonly (string Resref, string RareLootTable)[] RareElites =
    {
        ("invictus", "VELES_INVICTUS_RARES"),
        ("ruptorvane", "VELES_RUPTOR_RARES"),
        ("blackoutwrd", "VELES_BLACKOUT_RARES"),
    };
    private const string RareSpawnTable = "VELES_MILITIA_ANNEX_RARES";
    private static readonly (string Blueprint, RecipeType Recipe, string CraftedResref, string Component)[] RareRecipes =
    {
        ("bp_invictus", RecipeType.SalvagedInvictusGauntlets, "invictuscr", "invictuscm"),
        ("bp_ruptorvane", RecipeType.SalvagedRuptorVisor, "ruptorvanecr", "ruptorvanecm"),
        ("bp_blackoutwrd", RecipeType.SalvagedBlackoutCuirass, "blackoutwrdcr", "blackoutwrdcm"),
    };

    [Test]
    public void VelesRareTests_UseWeightedRareEntriesInDedicatedTable()
    {
    ...
    [Test]
    public void VelesRareTests_LootIsUniqueRareGear()
    {
    ...
    [Test]
    public void VelesRareTests_RecipesAreRegisteredWithSalvageComponents()
    {
    ...
    [Test]
    public void VelesRareTests_BlueprintsLearnRegisteredRecipes()
    {
