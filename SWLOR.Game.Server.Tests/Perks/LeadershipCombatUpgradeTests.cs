...
public class LeadershipCombatUpgradeTests
{
    ...
    public void LeadershipFeatAndAbilityDescriptions_MatchCombatBible()
    {
        ...
        {
            (FeatType.RallyingStandard1, "Aura: Nearby party members gain +3% physical and Force ability hit chance. SOC scaling can raise this to +4%."),
            (FeatType.PressTheAttack1, "Nearby party members deal +8% damage for 30 seconds. SOC scaling can raise this to +10%."),
            (FeatType.CoordinatedFocus1, "Aura: Nearby party members gain +3% critical hit chance. SOC scaling can raise this to +4%."),
            (FeatType.ChargeOrder1, "Aura: Nearby party members gain +10% movement speed and +30 Mobility Resistance. SOC scaling can raise these to +12% movement speed and +40 Mobility Resistance."),
            (FeatType.PressTheAttack2, "Nearby party members deal +11% damage for 30 seconds. SOC scaling can raise this to +14%."),
            (FeatType.RallyingStandard2, "Aura: Nearby party members gain +5% physical and Force ability hit chance. SOC scaling can raise this to +6%."),
            (FeatType.BreakMorale1, "Nearby enemies suffer Flash for 30 seconds, reducing physical and Force ability hit chance by 10%. SOC scaling can raise the penalty to 12%. This command applies reliably to valid nearby enemies."),
            (FeatType.CoordinatedFocus2, "Aura: Nearby party members gain +4% critical hit chance and +5% critical damage. SOC scaling can raise these to +5% and +7%."),
            (FeatType.ChargeOrder2, "Aura: Nearby party members gain +15% movement speed and +50 Mobility Resistance. SOC scaling can raise these to +18% movement speed and +65 Mobility Resistance."),
            (FeatType.PressTheAttack3, "Nearby party members gain +14% damage and +5% physical and Force ability hit chance for 30 seconds. SOC scaling can raise these to +18% damage and +7% hit chance."),
            (FeatType.BreakMorale2, "Nearby enemies suffer Flash, reducing physical and Force ability hit chance by 15%, and Weakened, reducing Attack by 12%, for 30 seconds. SOC scaling can raise these penalties to 18% and 15%. This command applies reliably to valid nearby enemies."),
            (FeatType.CoordinatedFocus3, "Aura: Nearby party members gain +6% critical hit chance and +8% critical damage. SOC scaling can raise these to +7% and +10%."),
            ...
            (FeatType.WatchfulPresence1, "Aura: Nearby party members take 4% less physical and Force damage. SOC scaling can raise this to 5%."),
            ...
            (FeatType.SteadyFormation1, "Aura: Nearby party members gain +3% evasion chance, +30 Mind Resistance, and +30 Mobility Resistance. SOC scaling can raise these to +4% evasion chance, +40 Mind Resistance, and +40 Mobility Resistance."),
            (FeatType.FieldRecovery1, "Aura: Nearby party members restore 1 STM every 4 seconds. SOC scaling can raise this to 2 STM per tick."),
            ...
            (FeatType.WatchfulPresence2, "Aura: Nearby party members take 6% less physical and Force damage. SOC scaling can raise this to 7%."),
            (FeatType.CleanseOrder1, "Removes one standard elemental or trauma ailment from nearby party members and grants temporary HP equal to 6% of maximum HP for 30 seconds. SOC scaling can raise temporary HP to 8%."),
            (FeatType.SteadyFormation2, "Aura: Nearby party members gain +5% evasion chance, +50 Mind Resistance, and +50 Mobility Resistance. SOC scaling can raise these to +6% evasion chance, +65 Mind Resistance, and +65 Mobility Resistance."),
            (FeatType.FieldRecovery2, "Aura: Nearby party members restore 2 STM every 4 seconds. SOC scaling can raise this to 3 STM per tick."),
            ...
            (FeatType.CleanseOrder2, "Removes one major negative status effect from nearby party members and grants 12% damage reduction for 30 seconds. SOC scaling can raise this to 15%."),
            (FeatType.WatchfulPresence3, "Aura: Nearby party members take 8% less physical and Force damage. SOC scaling can raise this to 10%."),
