...
namespace SWLOR.Game.Server.Conversation
{
    public class MessageBoard: ConversationBase
    {
            ...
            switch (responseID)
            {
                case 1: // Remove Post
                    if (model.IsConfirming)
                    {
                        ...
                        DataService.SubmitDataChange(message, DatabaseActionType.Set);
        ...
        private void LoadCreatePostPage()
        {
            ...
            player.SetLocalBoolean("MESSAGE_BOARD_LISTENING", true);
        }
            ...
            switch (responseID)
            {
                ...
                case 3: // Post Message
                    ...
                    if (model.IsConfirming)
                    {
                        ...
                        DataService.SubmitDataChange(post, DatabaseActionType.Set);
