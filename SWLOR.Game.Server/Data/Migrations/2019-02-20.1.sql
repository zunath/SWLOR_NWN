...
CREATE TABLE PCMarketListing(
	...
	SellerPlayerID UNIQUEIDENTIFIER NOT NULL,
	...
	BuyerPlayerID UNIQUEIDENTIFIER NULL,
	...
	CONSTRAINT FK_PCMarketListing_PlayerID FOREIGN KEY(SellerPlayerID)
	...
	CONSTRAINT FK_PCMarketListing_BuyerPlayerID FOREIGN KEY(BuyerPlayerID)
		REFERENCES dbo.Player(ID)
