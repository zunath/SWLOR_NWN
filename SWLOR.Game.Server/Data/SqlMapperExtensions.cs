...
// NOTE: Pulled from the Dapper.Contrib library and modified to include
// run-time Insert/Update/Delete methods.
...
namespace SWLOR.Game.Server.Data
{
    ...
    public static partial class SqlMapperExtensions
    {
        ...
        {
            return Insert(connection, typeof(T), entityToInsert, transaction, commandTimeout);
        }
        ...
        /// </summary>
        /// <param name="connection">Open SqlConnection</param>
        /// <param name="type">The type of object to insert.</param>
        /// <param name="entityToInsert">Entity to insert, can be list of entities</param>
        /// <param name="transaction">The transaction to run under, null (the default) if none</param>
        /// <param name="commandTimeout">Number of seconds before command execution timeout</param>
        /// <returns>Identity of inserted entity, or number of inserted rows if inserting a list</returns>
        public static long Insert(this IDbConnection connection, Type type, object entityToInsert, IDbTransaction transaction = null, int? commandTimeout = null)
        {
            var isList = false;
        ...
        {
            return Update(connection, typeof(T), entityToUpdate, transaction, commandTimeout);
        }
        ...
        /// </summary>
        /// <param name="connection">Open SqlConnection</param>
        /// <param name="type">The type of object to update.</param>
        /// <param name="entityToUpdate">Entity to be updated</param>
        /// <param name="transaction">The transaction to run under, null (the default) if none</param>
        /// <param name="commandTimeout">Number of seconds before command execution timeout</param>
        /// <returns>true if updated, false if not found or not modified (tracked entities)</returns>
        public static bool Update(this IDbConnection connection, Type type, object entityToUpdate, IDbTransaction transaction = null, int? commandTimeout = null)
        {
        ...
        {
            return Delete(connection, typeof(T), entityToDelete, transaction, commandTimeout);
        }
        ...
        /// <param name="commandTimeout">Number of seconds before command execution timeout</param>
        /// <returns>true if deleted, false if not found</returns>
        public static bool Delete(this IDbConnection connection, Type type, object entityToDelete, IDbTransaction transaction = null, int? commandTimeout = null)
        {
