    ...
    public sealed class IronHideAbilityDefinition : IAbilityListDefinition
    {
        ...
        private static void IronHide1(AbilityBuilder builder)
        {
            builder
                ...
                .HasAIScore(AIScore.SelfStatBelow(StatType.IronHideRank, 1, 1))
                .IsCastedAbility()
                .BreaksStealth()
        ...
        private static void IronHide2(AbilityBuilder builder)
        {
            builder
                ...
                .HasAIScore(AIScore.SelfStatBelow(StatType.IronHideRank, 2, 2))
                .IsCastedAbility()
                .BreaksStealth()
        ...
        private static void IronHide3(AbilityBuilder builder)
        {
            builder
                ...
                .HasAIScore(AIScore.SelfStatBelow(StatType.IronHideRank, 3, 3))
                .IsCastedAbility()
                .BreaksStealth()
