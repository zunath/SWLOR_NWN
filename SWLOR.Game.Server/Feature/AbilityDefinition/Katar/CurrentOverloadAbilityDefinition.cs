...
namespace SWLOR.Game.Server.Feature.AbilityDefinition.Katar
{
    public class CurrentOverloadAbilityDefinition : IAbilityListDefinition
    {
        ...
        private static void ImpactAction(uint activator, uint target, int level, Location targetLocation)
        {
            ...
            {
                case 1:
                    Ability.ApplyCombatImpact(activator, target, targetLocation, SkillType.Katar, 35, 3, 18, SavingThrow.Reflex, StatusEffectType.Poison, AbilityControlEffect.Stunned, false);
                    break;
            }
        }
    }
