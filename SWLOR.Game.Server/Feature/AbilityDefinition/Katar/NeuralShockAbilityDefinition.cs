...
namespace SWLOR.Game.Server.Feature.AbilityDefinition.Katar
{
    public class NeuralShockAbilityDefinition : IAbilityListDefinition
    {
        ...
        private static void ImpactAction(uint activator, uint target, int level, Location targetLocation)
        {
            ...
            {
                case 1:
                    Ability.ApplyCombatImpact(activator, target, targetLocation, SkillType.Katar, 20, 3, 16, SavingThrow.Reflex, StatusEffectType.Invalid, AbilityControlEffect.Dazed, false);
                    break;
            }
        }
    }
