...
namespace SWLOR.Game.Server.Feature.AbilityDefinition.Katar
{
    public class StrikingCobraAbilityDefinition : WeaponActiveAbilityDefinitionBase, IAbilityListDefinition
    {
        public Dictionary<FeatType, AbilityDetail> BuildAbilities()
        {
            ...
            ConfigureWeapon(
                builder
                    .Create(FeatType.StrikingCobra1, PerkType.StrikingCobra)
            ...
            ConfigureWeapon(
                builder
                    .Create(FeatType.StrikingCobra2, PerkType.StrikingCobra)
            ...
            ConfigureWeapon(
                builder
                    .Create(FeatType.StrikingCobra3, PerkType.StrikingCobra)
