...
namespace SWLOR.Game.Server.Feature.AbilityDefinition.Lightsaber
{
    public class OverwhelmingStrikeAbilityDefinition : IAbilityListDefinition
    {
        ...
        private static void ImpactAction(uint activator, uint target, int level, Location targetLocation)
        {
            ...
            {
                case 1:
                    Ability.ApplyCombatImpact(activator, target, targetLocation, SkillType.Lightsaber, 15, 30, 15, SavingThrow.Fortitude, StatusEffectType.Invalid, AbilityControlEffect.None, true);
                    break;
            }
        }
    }
