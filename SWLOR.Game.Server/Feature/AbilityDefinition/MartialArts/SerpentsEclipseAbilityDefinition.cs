...
namespace SWLOR.Game.Server.Feature.AbilityDefinition.MartialArts
{
    public class SerpentsEclipseAbilityDefinition : IAbilityListDefinition
    {
        ...
        private static void ImpactAction(uint activator, uint target, int level, Location targetLocation)
        {
            ...
            {
                case 1:
                    Ability.ApplyCombatImpact(activator, target, targetLocation, SkillType.MartialArts, 25, 0, 18, SavingThrow.Fortitude, StatusEffectType.Poison, AbilityControlEffect.None, true);
                    break;
            }
        }
    }
