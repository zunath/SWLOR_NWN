...
namespace SWLOR.Game.Server.Feature.AbilityDefinition.MartialArts
{
    public class SkullRattleAbilityDefinition : IAbilityListDefinition
    {
        ...
        private static void ImpactAction(uint activator, uint target, int level, Location targetLocation)
        {
            ...
            {
                case 1:
                    Ability.ApplyCombatImpact(activator, target, targetLocation, SkillType.MartialArts, 34, 3, 16, SavingThrow.Fortitude, StatusEffectType.Invalid, AbilityControlEffect.Dazed, false);
                    break;
            }
        }
    }
