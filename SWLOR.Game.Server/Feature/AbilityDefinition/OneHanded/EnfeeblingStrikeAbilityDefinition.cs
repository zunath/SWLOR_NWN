...
namespace SWLOR.Game.Server.Feature.AbilityDefinition.OneHanded
{
    public class EnfeeblingStrikeAbilityDefinition : IAbilityListDefinition
    {
        ...
        private static void ImpactAction(uint activator, uint target, int level, Location targetLocation)
        {
            ...
            {
                case 1:
                    Ability.ApplyCombatImpact(activator, target, targetLocation, SkillType.OneHanded, 12, 15, 10, SavingThrow.Fortitude, StatusEffectType.Invalid, AbilityControlEffect.None, false);
                    break;
                case 2:
                    Ability.ApplyCombatImpact(activator, target, targetLocation, SkillType.OneHanded, 24, 15, 14, SavingThrow.Fortitude, StatusEffectType.Invalid, AbilityControlEffect.None, false);
                    break;
                case 3:
                    Ability.ApplyCombatImpact(activator, target, targetLocation, SkillType.OneHanded, 36, 15, 18, SavingThrow.Fortitude, StatusEffectType.Invalid, AbilityControlEffect.None, false);
                    break;
            }
        }
    }
