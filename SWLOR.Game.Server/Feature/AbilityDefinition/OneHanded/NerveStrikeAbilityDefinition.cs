...
namespace SWLOR.Game.Server.Feature.AbilityDefinition.OneHanded
{
    public class NerveStrikeAbilityDefinition : IAbilityListDefinition
    {
        ...
        private static void ImpactAction(uint activator, uint target, int level, Location targetLocation)
        {
            ...
            {
                case 1:
                    Ability.ApplyCombatImpact(activator, target, targetLocation, SkillType.OneHanded, 22, 12, 14, SavingThrow.Fortitude, StatusEffectType.Invalid, AbilityControlEffect.None, false);
                    break;
            }
        }
    }
