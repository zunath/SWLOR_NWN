...
namespace SWLOR.Game.Server.Feature.AbilityDefinition.OneHanded
{
    public class RippleSlashAbilityDefinition : IAbilityListDefinition
    {
        ...
        private static void ImpactAction(uint activator, uint target, int level, Location targetLocation)
        {
            ...
            {
                case 1:
                    Ability.ApplyCombatImpact(activator, target, targetLocation, SkillType.OneHanded, 30, 20, 15, SavingThrow.Reflex, StatusEffectType.Invalid, AbilityControlEffect.None, true);
                    break;
            }
        }
    }
