...
namespace SWLOR.Game.Server.Feature.AbilityDefinition.Pistol
{
    public class LowShotAbilityDefinition : IAbilityListDefinition
    {
        ...
        private static void ImpactAction(uint activator, uint target, int level, Location targetLocation)
        {
            ...
            {
                case 1:
                    Ability.ApplyCombatImpact(activator, target, targetLocation, SkillType.Pistol, 20, 12, 16, SavingThrow.Reflex, StatusEffectType.Invalid, AbilityControlEffect.None, false);
                    break;
            }
        }
    }
