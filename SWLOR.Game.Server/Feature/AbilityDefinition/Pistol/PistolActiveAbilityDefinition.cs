...
namespace SWLOR.Game.Server.Feature.AbilityDefinition.Pistol
{
    public class PistolActiveAbilityDefinition : WeaponActiveAbilityDefinitionBase, IAbilityListDefinition
    {
        public Dictionary<FeatType, AbilityDetail> BuildAbilities()
        {
            ...
            ConfigureInterrupt(builder.Create(FeatType.InterruptingShot1, PerkType.InterruptingShot).Name("Interrupting Shot I").Level(1), SkillType.Pistol, 0, 12, 12, SavingThrow.Will, typeof(FoggyMindStatusEffect), 6, FoggyMind(2));
            ...
            ConfigureInterrupt(builder.Create(FeatType.InterruptingShot2, PerkType.InterruptingShot).Name("Interrupting Shot II").Level(2), SkillType.Pistol, 20, 20, 16, SavingThrow.Will, typeof(FoggyMindStatusEffect), 8, FoggyMind(2));
