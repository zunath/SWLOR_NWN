...
namespace SWLOR.Game.Server.Feature.AbilityDefinition.Ranged
{
    public class LastWordAbilityDefinition : IAbilityListDefinition
    {
        ...
        private static void ImpactAction(uint activator, uint target, int level, Location targetLocation)
        {
            ...
            {
                case 1:
                    Ability.ApplyCombatImpact(activator, target, targetLocation, SkillType.Ranged, 35, 3, 18, SavingThrow.Reflex, StatusEffectType.Invalid, AbilityControlEffect.Dazed, true);
                    break;
            }
        }
    }
