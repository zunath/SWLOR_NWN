...
namespace SWLOR.Game.Server.Feature.AbilityDefinition.Ranged
{
    public class PerfectThrowAbilityDefinition : IAbilityListDefinition
    {
        ...
        private static void ImpactAction(uint activator, uint target, int level, Location targetLocation)
        {
            ...
            {
                case 1:
                    Ability.ApplyCombatImpact(activator, target, targetLocation, SkillType.Ranged, 80, 15, 0, SavingThrow.Will, StatusEffectType.Bleed, AbilityControlEffect.None, false);
                    break;
            }
        }
    }
