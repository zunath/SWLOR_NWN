...
namespace SWLOR.Game.Server.Feature.AbilityDefinition.Ranged
{
    public class RainOfSteelAbilityDefinition : IAbilityListDefinition
    {
        ...
        private static void ImpactAction(uint activator, uint target, int level, Location targetLocation)
        {
            ...
            {
                case 1:
                    Ability.ApplyCombatImpact(activator, target, targetLocation, SkillType.Ranged, 35, 60, 18, SavingThrow.Reflex, StatusEffectType.Bleed, AbilityControlEffect.None, true);
                    break;
            }
        }
    }
