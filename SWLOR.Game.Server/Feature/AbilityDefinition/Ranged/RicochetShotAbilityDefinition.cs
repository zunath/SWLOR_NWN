...
namespace SWLOR.Game.Server.Feature.AbilityDefinition.Ranged
{
    public class RicochetShotAbilityDefinition : IAbilityListDefinition
    {
        ...
        private static void ImpactAction(uint activator, uint target, int level, Location targetLocation)
        {
            ...
            {
                case 1:
                    Ability.ApplyCombatImpact(activator, target, targetLocation, SkillType.Ranged, 12, 6, 14, SavingThrow.Reflex, StatusEffectType.Invalid, AbilityControlEffect.Blind, false);
                    break;
            }
        }
    }
