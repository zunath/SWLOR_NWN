...
namespace SWLOR.Game.Server.Feature.AbilityDefinition.Ranged
{
    public class SmokeRoundAbilityDefinition : IAbilityListDefinition
    {
        ...
        private static void ImpactAction(uint activator, uint target, int level, Location targetLocation)
        {
            ...
            {
                case 1:
                    Ability.ApplyCombatImpact(activator, target, targetLocation, SkillType.Ranged, 0, 12, 16, SavingThrow.Fortitude, StatusEffectType.Invalid, AbilityControlEffect.Blind, true);
                    break;
            }
        }
    }
