...
namespace SWLOR.Game.Server.Feature.AbilityDefinition.Ranged
{
    public class SuppressiveLineAbilityDefinition : IAbilityListDefinition
    {
        ...
        private static void ImpactAction(uint activator, uint target, int level, Location targetLocation)
        {
            ...
            {
                case 1:
                    Ability.ApplyCombatImpact(activator, target, targetLocation, SkillType.Ranged, 22, 12, 14, SavingThrow.Reflex, StatusEffectType.Invalid, AbilityControlEffect.None, true);
                    break;
            }
        }
    }
