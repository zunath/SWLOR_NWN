...
namespace SWLOR.Game.Server.Feature.AbilityDefinition.Rifle
{
    public class PiercingRoundAbilityDefinition : IAbilityListDefinition
    {
        ...
        private static void ImpactAction(uint activator, uint target, int level, Location targetLocation)
        {
            ...
            {
                case 1:
                    Ability.ApplyCombatImpact(activator, target, targetLocation, SkillType.Rifle, 14, 12, 12, SavingThrow.Fortitude, StatusEffectType.Invalid, AbilityControlEffect.None, false);
                    break;
                case 2:
                    Ability.ApplyCombatImpact(activator, target, targetLocation, SkillType.Rifle, 26, 12, 15, SavingThrow.Fortitude, StatusEffectType.Invalid, AbilityControlEffect.None, false);
                    break;
                case 3:
                    Ability.ApplyCombatImpact(activator, target, targetLocation, SkillType.Rifle, 38, 15, 18, SavingThrow.Fortitude, StatusEffectType.Invalid, AbilityControlEffect.None, false);
                    break;
            }
        }
    }
