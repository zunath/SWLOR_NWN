...
namespace SWLOR.Game.Server.Feature.AbilityDefinition.Spear
{
    public class HamperingBarrageAbilityDefinition : IAbilityListDefinition
    {
        ...
        private static void ImpactAction(uint activator, uint target, int level, Location targetLocation)
        {
            ...
            {
                case 1:
                    Ability.ApplyCombatImpact(activator, target, targetLocation, SkillType.Spear, 30, 12, 16, SavingThrow.Reflex, StatusEffectType.Invalid, AbilityControlEffect.None, true);
                    break;
            }
        }
    }
