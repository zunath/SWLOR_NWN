...
namespace SWLOR.Game.Server.Feature.AbilityDefinition.Staff
{
    public class BonecrusherAbilityDefinition : IAbilityListDefinition
    {
        ...
        private static void ImpactAction(uint activator, uint target, int level, Location targetLocation)
        {
            ...
            {
                case 1:
                    Ability.ApplyCombatImpact(activator, target, targetLocation, SkillType.Staff, 50, 3, 18, SavingThrow.Fortitude, StatusEffectType.Invalid, AbilityControlEffect.Stunned, false);
                    break;
            }
        }
    }
