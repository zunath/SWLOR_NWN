...
namespace SWLOR.Game.Server.Feature.AbilityDefinition.Staff
{
    public class LineBreakerAbilityDefinition : IAbilityListDefinition
    {
        ...
        private static void ImpactAction(uint activator, uint target, int level, Location targetLocation)
        {
            ...
            {
                case 1:
                    Ability.ApplyCombatImpact(activator, target, targetLocation, SkillType.Staff, 18, 12, 14, SavingThrow.Reflex, StatusEffectType.Invalid, AbilityControlEffect.None, true);
                    break;
            }
        }
    }
