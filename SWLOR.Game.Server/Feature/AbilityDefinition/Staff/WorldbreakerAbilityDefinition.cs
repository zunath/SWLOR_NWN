...
namespace SWLOR.Game.Server.Feature.AbilityDefinition.Staff
{
    public class WorldbreakerAbilityDefinition : IAbilityListDefinition
    {
        ...
        private static void ImpactAction(uint activator, uint target, int level, Location targetLocation)
        {
            ...
            {
                case 1:
                    Ability.ApplyCombatImpact(activator, target, targetLocation, SkillType.Staff, 45, 4, 18, SavingThrow.Reflex, StatusEffectType.Invalid, AbilityControlEffect.Knockdown, true);
                    break;
            }
        }
    }
