...
namespace SWLOR.Game.Server.Feature.AbilityDefinition.TwinBlade
{
    public class FeintingCutAbilityDefinition : IAbilityListDefinition
    {
        ...
        private static void ImpactAction(uint activator, uint target, int level, Location targetLocation)
        {
            ...
            {
                case 1:
                    Ability.ApplyCombatImpact(activator, target, targetLocation, SkillType.TwinBlade, 12, 12, 12, SavingThrow.Reflex, StatusEffectType.Invalid, AbilityControlEffect.None, false);
                    break;
                case 2:
                    Ability.ApplyCombatImpact(activator, target, targetLocation, SkillType.TwinBlade, 22, 12, 15, SavingThrow.Reflex, StatusEffectType.Invalid, AbilityControlEffect.None, false);
                    break;
                case 3:
                    Ability.ApplyCombatImpact(activator, target, targetLocation, SkillType.TwinBlade, 32, 15, 18, SavingThrow.Reflex, StatusEffectType.Invalid, AbilityControlEffect.None, false);
                    break;
            }
        }
    }
