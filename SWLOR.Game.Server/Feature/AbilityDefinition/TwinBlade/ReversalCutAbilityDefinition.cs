...
namespace SWLOR.Game.Server.Feature.AbilityDefinition.TwinBlade
{
    public class ReversalCutAbilityDefinition : IAbilityListDefinition
    {
        ...
        private static void ImpactAction(uint activator, uint target, int level, Location targetLocation)
        {
            ...
            {
                case 1:
                    Ability.ApplyCombatImpact(activator, target, targetLocation, SkillType.TwinBlade, 40, 3, 16, SavingThrow.Reflex, StatusEffectType.Invalid, AbilityControlEffect.Dazed, false);
                    break;
            }
        }
    }
