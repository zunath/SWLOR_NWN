...
namespace SWLOR.Game.Server.Feature.AbilityDefinition.TwoHanded
{
    public class HamperingBarrageAbilityDefinition : IAbilityListDefinition
    {
        ...
        private static void ImpactAction(uint activator, uint target, int level, Location targetLocation)
        {
            ...
            {
                case 1:
                    Ability.ApplyCombatImpact(activator, target, targetLocation, SkillType.TwoHanded, 30, 12, 16, SavingThrow.Reflex, StatusEffectType.Invalid, AbilityControlEffect.None, true);
                    break;
            }
        }
    }
