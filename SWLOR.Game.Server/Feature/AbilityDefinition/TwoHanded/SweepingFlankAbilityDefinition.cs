...
namespace SWLOR.Game.Server.Feature.AbilityDefinition.TwoHanded
{
    public class SweepingFlankAbilityDefinition : IAbilityListDefinition
    {
        ...
        private static void ImpactAction(uint activator, uint target, int level, Location targetLocation)
        {
            ...
            {
                case 1:
                    Ability.ApplyCombatImpact(activator, target, targetLocation, SkillType.TwoHanded, 18, 30, 16, SavingThrow.Fortitude, StatusEffectType.Invalid, AbilityControlEffect.None, true);
                    break;
            }
        }
    }
