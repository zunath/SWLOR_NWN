...
namespace SWLOR.Game.Server.Feature.AbilityDefinition.Vibroknife
{
    public class CascadeFailureAbilityDefinition : IAbilityListDefinition
    {
        ...
        private static void ImpactAction(uint activator, uint target, int level, Location targetLocation)
        {
            ...
            {
                case 1:
                    Ability.ApplyCombatImpact(activator, target, targetLocation, SkillType.Vibroknife, 25, 12, 15, SavingThrow.Fortitude, StatusEffectType.Invalid, AbilityControlEffect.None, true);
                    break;
            }
        }
    }
