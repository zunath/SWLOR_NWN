...
namespace SWLOR.Game.Server.Feature.AbilityDefinition.Vibroknife
{
    public class VitalStrikeAbilityDefinition : IAbilityListDefinition
    {
        ...
        private static void ImpactAction(uint activator, uint target, int level, Location targetLocation)
        {
            ...
            {
                case 1:
                    Ability.ApplyCombatImpact(activator, target, targetLocation, SkillType.Vibroknife, 55, 12, 20, SavingThrow.Fortitude, StatusEffectType.Invalid, AbilityControlEffect.None, false);
                    break;
            }
        }
    }
