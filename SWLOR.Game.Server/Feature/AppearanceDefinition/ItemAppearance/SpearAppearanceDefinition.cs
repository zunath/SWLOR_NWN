namespace SWLOR.Game.Server.Feature.AppearanceDefinition.ItemAppearance
{
    public class SpearAppearanceDefinition : WeaponAppearanceBaseDefinition
    {
        ...
        public override int[] TopParts { get; } =
        {
            ...
            301, 302, 303, 304, 306, 307, 308, 309, 310, 324, // Color #3
            401, 402, 403, 404, 406, 407, 408, 409, 410, 424, // Color #4
            // Color #5
            // Color #6
            // Color #7
            // Color #8
        ...
        {
            101, 102, 103, 104, 106, 107, 114, // Color #1
            201, 202, 203, 204, 206, // Color #2
            301, 302, 303, 304, 306, 324, // Color #3
        ...
        {
            101, 102, 103, 104, 106, 108, 109, 110, 114, // Color #1
            201, 202, 203, 204, 206, 209, 210, // Color #2
            301, 302, 303, 304, 306, 309, 310, 324, // Color #3
