...
namespace SWLOR.Game.Server.Feature.AppearanceDefinition.TintMap
{
    public static class TintMapMaterialRegistry
    {
        ...
        {
            { TintMapLayerType.Skin, new TintMapLayerDefinition("Skin", "rowSkin", "gui_pal_skin", 0) },
            { TintMapLayerType.Hair, new TintMapLayerDefinition("Hair", "rowHair", "gui_pal_hair01", 176) },
            { TintMapLayerType.Metal1, new TintMapLayerDefinition("Metal 1", "rowMetal1", "gui_pal_armor01", 352) },
            { TintMapLayerType.Metal2, new TintMapLayerDefinition("Metal 2", "rowMetal2", "gui_pal_armor01", 528) },
            { TintMapLayerType.Cloth1, new TintMapLayerDefinition("Cloth 1", "rowCloth1", "gui_pal_tattoo", 704) },
            { TintMapLayerType.Cloth2, new TintMapLayerDefinition("Cloth 2", "rowCloth2", "gui_pal_tattoo", 704) },
            { TintMapLayerType.Leather1, new TintMapLayerDefinition("Leather 1", "rowLeath1", "gui_pal_tattoo", 704) },
            { TintMapLayerType.Leather2, new TintMapLayerDefinition("Leather 2", "rowLeath2", "gui_pal_tattoo", 704) },
            { TintMapLayerType.Tattoo1, new TintMapLayerDefinition("Tattoo 1", "rowTat1", "gui_pal_tattoo", 704) },
            { TintMapLayerType.Tattoo2, new TintMapLayerDefinition("Tattoo 2", "rowTat2", "gui_pal_tattoo", 704) }
        };
