...
{
    public class AbysswebRavagerBeastDefinition: IBeastListDefinition
    {
        private readonly BeastBuilder _builder = new();

        public Dictionary<BeastType, BeastDetail> Build()
        {
            _builder.Create(BeastType.AbysswebRavager)
                .Name("Abyssweb Ravager")
                .Appearance(AppearanceType.DemonBebilith3Ryuujin)
