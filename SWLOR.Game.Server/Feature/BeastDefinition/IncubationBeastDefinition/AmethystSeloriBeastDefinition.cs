...
{
    public class AmethystSeloriBeastDefinition: IBeastListDefinition
    {
        private readonly BeastBuilder _builder = new();

        public Dictionary<BeastType, BeastDetail> Build()
        {
            _builder.Create(BeastType.AmethystSelori)
                .Name("Amethyst Selori")
                .Appearance(AppearanceType.DragonGemAmethystWyrmlingHardpoints)
                .AppearanceScale(1f)
                .SoundSetId(331)
                .PortraitId(3171)
