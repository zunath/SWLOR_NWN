...
{
    public class BlinkstepVekaraBeastDefinition: IBeastListDefinition
    {
        private readonly BeastBuilder _builder = new();

        public Dictionary<BeastType, BeastDetail> Build()
        {
            _builder.Create(BeastType.BlinkstepVekara)
                .Name("Blinkstep Vekara")
                .Appearance(AppearanceType.DogBlinkDog)
                .AppearanceScale(1f)
                .SoundSetId(106)
                .PortraitId(207)
