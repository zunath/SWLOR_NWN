...
{
    public class BloodtuskRavorBeastDefinition: IBeastListDefinition
    {
        private readonly BeastBuilder _builder = new();

        public Dictionary<BeastType, BeastDetail> Build()
        {
            _builder.Create(BeastType.BloodtuskRavor)
                .Name("Bloodtusk Ravor")
                .Appearance(AppearanceType.SwineBoarDire)
                .AppearanceScale(1f)
                .SoundSetId(948)
                .PortraitId(181)
