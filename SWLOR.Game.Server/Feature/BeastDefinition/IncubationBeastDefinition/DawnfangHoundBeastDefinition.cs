...
{
    public class DawnfangHoundBeastDefinition: IBeastListDefinition
    {
        private readonly BeastBuilder _builder = new();

        public Dictionary<BeastType, BeastDetail> Build()
        {
            _builder.Create(BeastType.DawnfangHound)
                .Name("Dawnfang Hound")
                .Appearance(AppearanceType.DogAoskarianHoundLightCODISchazzwozzer)
                .AppearanceScale(1f)
                .SoundSetId(27)
                .PortraitId(319)
		...
		private void Level47()
		{
			_builder
				...
				.Delay(21)
				.Stat(AbilityType.Might, 46)
				.Stat(AbilityType.Perception, 37)
				.Stat(AbilityType.Vitality, 38)
				.Stat(AbilityType.Willpower, 36)
				.Stat(AbilityType.Agility, 25)
				.Stat(AbilityType.Social, 17)
