...
{
    public class DeepstoneGraxalBeastDefinition: IBeastListDefinition
    {
        private readonly BeastBuilder _builder = new();

        public Dictionary<BeastType, BeastDetail> Build()
        {
            _builder.Create(BeastType.DeepstoneGraxal)
                .Name("Deepstone Graxal")
                .Appearance(AppearanceType.CattleRotheDeep)
                .AppearanceScale(1f)
                .SoundSetId(25)
                .PortraitId(1276)
