...
{
    public class DreadmawBarghestBeastDefinition: IBeastListDefinition
    {
        private readonly BeastBuilder _builder = new();

        public Dictionary<BeastType, BeastDetail> Build()
        {
            _builder.Create(BeastType.DreadmawBarghest)
                .Name("Dreadmaw Barghest")
                .Appearance(AppearanceType.DogBarghestGreater2Karkanos)
                .AppearanceScale(1f)
                .SoundSetId(106)
                .PortraitId(3477)
