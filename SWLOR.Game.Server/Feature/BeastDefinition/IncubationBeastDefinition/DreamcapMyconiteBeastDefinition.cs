...
{
    public class DreamcapMyconiteBeastDefinition: IBeastListDefinition
    {
        private readonly BeastBuilder _builder = new();

        public Dictionary<BeastType, BeastDetail> Build()
        {
            _builder.Create(BeastType.DreamcapMyconite)
                .Name("Dreamcap Myconite")
                .Appearance(AppearanceType.MyconidSchazzwozzer)
