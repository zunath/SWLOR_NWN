...
{
    public class DuskfangHoundBeastDefinition: IBeastListDefinition
    {
        private readonly BeastBuilder _builder = new();

        public Dictionary<BeastType, BeastDetail> Build()
        {
            _builder.Create(BeastType.DuskfangHound)
                .Name("Duskfang Hound")
                .Appearance(AppearanceType.DogAoskarianHoundDarkCODISchazzwozzer)
                .AppearanceScale(1f)
                .SoundSetId(27)
                .PortraitId(319)
