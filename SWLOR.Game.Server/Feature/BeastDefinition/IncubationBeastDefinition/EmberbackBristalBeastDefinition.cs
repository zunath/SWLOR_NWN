...
{
    public class EmberbackBristalBeastDefinition: IBeastListDefinition
    {
        private readonly BeastBuilder _builder = new();

        public Dictionary<BeastType, BeastDetail> Build()
        {
            _builder.Create(BeastType.EmberbackBristal)
                .Name("Emberback Bristal")
                .Appearance(AppearanceType.SwineBoar)
                .AppearanceScale(1f)
                .SoundSetId(904)
                .PortraitId(159)
