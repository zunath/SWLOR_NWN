...
{
    public class GraymireAmalgamBeastDefinition: IBeastListDefinition
    {
        private readonly BeastBuilder _builder = new();

        public Dictionary<BeastType, BeastDetail> Build()
        {
            _builder.Create(BeastType.GraymireAmalgam)
                .Name("Graymire Amalgam")
                .Appearance(AppearanceType.OozeGrayOoze)
                .AppearanceScale(1f)
                .SoundSetId(83)
                .PortraitId(736)
