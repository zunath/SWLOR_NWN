...
{
    public class IcewingKestrelithBeastDefinition: IBeastListDefinition
    {
        private readonly BeastBuilder _builder = new();

        public Dictionary<BeastType, BeastDetail> Build()
        {
            _builder.Create(BeastType.IcewingKestrelith)
                .Name("Icewing Kestrelith")
                .Appearance(AppearanceType.BirdFalcon)
                .AppearanceScale(1f)
                .SoundSetId(451)
                .PortraitId(730)
