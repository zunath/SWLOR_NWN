...
{
    public class MustardlashSlimeBeastDefinition: IBeastListDefinition
    {
        private readonly BeastBuilder _builder = new();

        public Dictionary<BeastType, BeastDetail> Build()
        {
            _builder.Create(BeastType.MustardlashSlime)
                .Name("Mustardlash Slime")
                .Appearance(AppearanceType.OozeMustardJellyMediumHalfscan)
                .AppearanceScale(1f)
                .SoundSetId(110)
                .PortraitId(2252)
