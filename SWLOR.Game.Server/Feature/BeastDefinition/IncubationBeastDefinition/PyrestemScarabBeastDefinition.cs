...
{
    public class PyrestemScarabBeastDefinition: IBeastListDefinition
    {
        private readonly BeastBuilder _builder = new();

        public Dictionary<BeastType, BeastDetail> Build()
        {
            _builder.Create(BeastType.PyrestemScarab)
                .Name("Pyrestem Scarab")
                .Appearance(AppearanceType.BeetleFireMedium)
                .AppearanceScale(1f)
                .SoundSetId(85)
                .PortraitId(2040)
