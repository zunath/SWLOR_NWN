...
{
    public class RedcrestTatterquillBeastDefinition: IBeastListDefinition
    {
        private readonly BeastBuilder _builder = new();

        public Dictionary<BeastType, BeastDetail> Build()
        {
            _builder.Create(BeastType.RedcrestTatterquill)
                .Name("Redcrest Tatterquill")
                .Appearance(AppearanceType.BirdChicken)
                .AppearanceScale(1f)
                .SoundSetId(38)
                .PortraitId(282)
