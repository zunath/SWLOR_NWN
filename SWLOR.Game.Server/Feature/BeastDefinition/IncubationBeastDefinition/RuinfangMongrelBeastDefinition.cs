...
{
    public class RuinfangMongrelBeastDefinition: IBeastListDefinition
    {
        private readonly BeastBuilder _builder = new();

        public Dictionary<BeastType, BeastDetail> Build()
        {
            _builder.Create(BeastType.RuinfangMongrel)
                .Name("Ruinfang Mongrel")
                .Appearance(AppearanceType.MdrnMutantDog)
                .AppearanceScale(1f)
                .SoundSetId(27)
                .PortraitId(4027)
