...
{
    public class SapphireVeyloriBeastDefinition: IBeastListDefinition
    {
        private readonly BeastBuilder _builder = new();

        public Dictionary<BeastType, BeastDetail> Build()
        {
            _builder.Create(BeastType.SapphireVeylori)
                .Name("Sapphire Veylori")
                .Appearance(AppearanceType.DragonGemSapphireWyrmlingHardpoints)
                .AppearanceScale(1f)
                .SoundSetId(330)
                .PortraitId(3176)
