...
{
    public class ShatterpeltLuraxBeastDefinition: IBeastListDefinition
    {
        private readonly BeastBuilder _builder = new();

        public Dictionary<BeastType, BeastDetail> Build()
        {
            _builder.Create(BeastType.ShatterpeltLurax)
                .Name("Shatterpelt Lurax")
                .Appearance(AppearanceType.CatLeopard)
                .AppearanceScale(1f)
                .SoundSetId(18)
                .PortraitId(167)
