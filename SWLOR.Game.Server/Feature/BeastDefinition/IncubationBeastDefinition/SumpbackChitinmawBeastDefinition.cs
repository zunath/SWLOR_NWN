...
{
    public class SumpbackChitinmawBeastDefinition: IBeastListDefinition
    {
        private readonly BeastBuilder _builder = new();

        public Dictionary<BeastType, BeastDetail> Build()
        {
            _builder.Create(BeastType.SumpbackChitinmaw)
                .Name("Sumpback Chitinmaw")
                .Appearance(AppearanceType.BeetleStinkMedium)
                .AppearanceScale(1f)
                .SoundSetId(86)
                .PortraitId(2089)
