...
{
    public class TempestBulwarkBeastDefinition: IBeastListDefinition
    {
        private readonly BeastBuilder _builder = new();

        public Dictionary<BeastType, BeastDetail> Build()
        {
            _builder.Create(BeastType.TempestBulwark)
                .Name("Tempest Bulwark")
                .Appearance(AppearanceType.SWLORStormBeast)
                .AppearanceScale(1f)
                .SoundSetId(55)
                .PortraitId(356)
