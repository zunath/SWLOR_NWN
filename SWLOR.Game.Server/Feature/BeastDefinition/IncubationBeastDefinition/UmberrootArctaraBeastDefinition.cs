...
{
    public class UmberrootArctaraBeastDefinition: IBeastListDefinition
    {
        private readonly BeastBuilder _builder = new();

        public Dictionary<BeastType, BeastDetail> Build()
        {
            _builder.Create(BeastType.UmberrootArctara)
                .Name("Umberroot Arctara")
                .Appearance(AppearanceType.BearBrown)
                .AppearanceScale(1f)
                .SoundSetId(99)
                .PortraitId(149)
