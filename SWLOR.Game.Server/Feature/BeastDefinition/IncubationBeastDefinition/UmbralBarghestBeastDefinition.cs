...
{
    public class UmbralBarghestBeastDefinition: IBeastListDefinition
    {
        private readonly BeastBuilder _builder = new();

        public Dictionary<BeastType, BeastDetail> Build()
        {
            _builder.Create(BeastType.UmbralBarghest)
                .Name("Umbral Barghest")
                .Appearance(AppearanceType.DogBarghest2Karkanos)
                .AppearanceScale(1f)
                .SoundSetId(104)
                .PortraitId(1021)
