...
{
    public class UmbratalonCorvaxBeastDefinition: IBeastListDefinition
    {
        private readonly BeastBuilder _builder = new();

        public Dictionary<BeastType, BeastDetail> Build()
        {
            _builder.Create(BeastType.UmbratalonCorvax)
                .Name("Umbratalon Corvax")
                .Appearance(AppearanceType.BirdRaven)
