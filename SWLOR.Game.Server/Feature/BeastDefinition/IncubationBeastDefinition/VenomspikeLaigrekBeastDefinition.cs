...
{
    public class VenomspikeLaigrekBeastDefinition: IBeastListDefinition
    {
        private readonly BeastBuilder _builder = new();

        public Dictionary<BeastType, BeastDetail> Build()
        {
            _builder.Create(BeastType.VenomspikeLaigrek)
                .Name("Venomspike Laigrek")
                .Appearance(AppearanceType.SWLORLaigrek)
                .AppearanceScale(1f)
                .SoundSetId(55)
                .PortraitId(356)
