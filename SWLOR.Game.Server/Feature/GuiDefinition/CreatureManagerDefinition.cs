...
namespace SWLOR.Game.Server.Feature.GuiDefinition
{
    public class CreatureManagerDefinition : IGuiWindowDefinition
    {
        ...
        private readonly GuiWindowBuilder<CreatureManagerViewModel> _builder;

        public CreatureManagerDefinition(IGuiService guiService)
        {
            _guiService = guiService;
            _builder = new GuiWindowBuilder<CreatureManagerViewModel>(_guiService);
        }
