...
namespace SWLOR.Game.Server.Feature.GuiDefinition
{
    public class ElectionDefinition: IGuiWindowDefinition
    {
        ...
        private readonly GuiWindowBuilder<ElectionViewModel> _builder;

        public ElectionDefinition(IGuiService guiService)
        {
            _guiService = guiService;
            _builder = new GuiWindowBuilder<ElectionViewModel>(_guiService);
        }
