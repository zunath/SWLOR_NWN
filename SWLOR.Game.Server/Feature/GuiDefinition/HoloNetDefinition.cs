...
namespace SWLOR.Game.Server.Feature.GuiDefinition
{
    public class HoloNetDefinition : IGuiWindowDefinition
    {
        ...
        private readonly GuiWindowBuilder<HoloNetViewModel> _builder;

        public HoloNetDefinition(IGuiService guiService)
        {
            _guiService = guiService;
            _builder = new GuiWindowBuilder<HoloNetViewModel>(_guiService);
        }
