...
namespace SWLOR.Game.Server.Feature.GuiDefinition
{
    public class ManageApartmentDefinition: IGuiWindowDefinition
    {
        ...
        private readonly GuiWindowBuilder<ManageApartmentViewModel> _builder;

        public ManageApartmentDefinition(IGuiService guiService)
        {
            _guiService = guiService;
            _builder = new GuiWindowBuilder<ManageApartmentViewModel>(_guiService);
        }
