...
namespace SWLOR.Game.Server.Feature.GuiDefinition
{
    public class ManageCityDefinition: IGuiWindowDefinition
    {
        ...
        private readonly GuiWindowBuilder<ManageCityViewModel> _builder;

        public ManageCityDefinition(IGuiService guiService)
        {
            _guiService = guiService;
            _builder = new GuiWindowBuilder<ManageCityViewModel>(_guiService);
        }
