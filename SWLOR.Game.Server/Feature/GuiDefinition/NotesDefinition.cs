...
namespace SWLOR.Game.Server.Feature.GuiDefinition
{
    public class NotesDefinition : IGuiWindowDefinition
    {
        ...
        private readonly GuiWindowBuilder<NotesViewModel> _builder;

        public NotesDefinition(IGuiService guiService)
        {
            _guiService = guiService;
            _builder = new GuiWindowBuilder<NotesViewModel>(_guiService);
        }
