...
namespace SWLOR.Game.Server.Feature.GuiDefinition
{
    public class OutfitDefinition : IGuiWindowDefinition
    {
        ...
        private readonly GuiWindowBuilder<OutfitViewModel> _builder;

        public OutfitDefinition(IGuiService guiService)
        {
            _guiService = guiService;
            _builder = new GuiWindowBuilder<OutfitViewModel>(_guiService);
        }
