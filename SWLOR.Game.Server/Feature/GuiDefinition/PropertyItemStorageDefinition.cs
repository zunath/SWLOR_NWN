...
namespace SWLOR.Game.Server.Feature.GuiDefinition
{
    public class PropertyItemStorageDefinition : IGuiWindowDefinition
    {
        ...
        private readonly GuiWindowBuilder<PropertyItemStorageViewModel> _builder;

        public PropertyItemStorageDefinition(IGuiService guiService)
        {
            _guiService = guiService;
            _builder = new GuiWindowBuilder<PropertyItemStorageViewModel>(_guiService);
        }
