...
namespace SWLOR.Game.Server.Feature.GuiDefinition
{
    public class RentApartmentDefinition: IGuiWindowDefinition
    {
        ...
        private readonly GuiWindowBuilder<RentApartmentViewModel> _builder;

        public RentApartmentDefinition(IGuiService guiService)
        {
            _guiService = guiService;
            _builder = new GuiWindowBuilder<RentApartmentViewModel>(_guiService);
        }
