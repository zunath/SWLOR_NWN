...
namespace SWLOR.Game.Server.Feature.GuiDefinition
{
    public class SettingsDefinition : IGuiWindowDefinition
    {
        ...
        private readonly GuiWindowBuilder<SettingsViewModel> _builder;

        public SettingsDefinition(IGuiService guiService)
        {
            _guiService = guiService;
            _builder = new GuiWindowBuilder<SettingsViewModel>(_guiService);
        }
