...
{
    public class FluxDiverterItemDefinition : IItemListDefinition
    {
        ...
        public Dictionary<string, ItemDetail> BuildItems()
        {
            _builder.Create("fx_diverter")
                ...
                {
                    StatusEffect.ApplyStatusEffect(user, user, new FluxDiverterStatusEffect(), 90f);
