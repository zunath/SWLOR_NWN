...
{
    public class GhostkeyRelayItemDefinition : IItemListDefinition
    {
        ...
        public Dictionary<string, ItemDetail> BuildItems()
        {
            _builder.Create("nv_relay")
                ...
                {
                    StatusEffect.ApplyStatusEffect(user, user, new GhostkeyRelayStatusEffect(), 90f);
