    ...
    public class SpaceLootTableDefinition : ILootTableDefinition
    {
        ...
        private void Tier5()
        {
            ...
            _builder.Create("SPACE_BOSS_T6")
                ...
                .AddItem("recipe_sv004", 1)
                .AddItem("recipe_sv006", 1)
                .AddItem("recipe_sv016", 1)
                .AddItem("recipe_sv019", 1)
                .AddItem("recipe_sv029", 1)
                .AddItem("recipe_sv041", 1)
                .AddItem("recipe_sv042", 1)
                .AddItem("recipe_sv046", 1)
                .AddItem("recipe_sv047", 1)
                .AddItem("recipe_sv049", 1)
                .AddItem("recipe_sv050", 1)
                .AddItem("recipe_sv053", 1)
                .AddItem("recipe_sv054", 1)
                .AddItem("recipe_sv056", 1)
                .AddItem("recipe_sv057", 1)
                .AddItem("recipe_sv058", 1)
                .AddItem("recipe_sv063", 1)
                .AddItem("recipe_sv064", 1)
                .AddItem("recipe_sv067", 1)
                .AddItem("recipe_sv068", 1)
                .AddItem("recipe_sv070", 1)
                .AddItem("recipe_sv071", 1)
                .AddItem("recipe_sv073", 1)
                .AddItem("recipe_sv074", 1)
                .AddItem("recipe_sv076", 1)
                .AddItem("recipe_sv077", 1)
                .AddItem("recipe_sv078", 1)
                .AddItem("recipe_sv079", 1)
