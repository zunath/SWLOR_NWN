    ...
    public sealed class BeastBruiserPerkDefinition : IPerkListDefinition
    {
        ...
        private void IceBreath()
        {
            _builder.Create(PerkCategoryType.BeastBruiser, PerkType.IceBreath)
                ...
                .AddPerkLevel()
                .Description("The beast breathes ice at hostile targets in a cone, dealing 10 ice DMG plus MGT scaling and slowing affected enemies for 30 seconds.")
                .Price(2)
                ...
                .AddPerkLevel()
                .Description("The beast breathes ice at hostile targets in a cone, dealing 14 ice DMG plus MGT scaling and slowing affected enemies for 30 seconds.")
                .Price(2)
                ...
                .AddPerkLevel()
                .Description("The beast breathes ice at hostile targets in a cone, dealing 18 ice DMG plus MGT scaling and immobilizing affected enemies for 30 seconds.")
                .Price(4)
