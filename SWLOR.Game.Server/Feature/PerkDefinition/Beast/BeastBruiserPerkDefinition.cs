    ...
    public sealed class BeastBruiserPerkDefinition : IPerkListDefinition
    {
        ...
        private void PoisonBreath()
        {
            _builder.Create(PerkCategoryType.BeastBruiser, PerkType.PoisonBreath)
                ...
                .AddPerkLevel()
                .Description("The beast breathes poison at hostile targets in a cone, dealing 10 poison DMG plus MGT scaling and attempting to inflict Poison.")
                .Price(2)
                ...
                .AddPerkLevel()
                .Description("The beast breathes poison at hostile targets in a cone, dealing 14 poison DMG plus MGT scaling and attempting to inflict Poison.")
                .Price(3)
                ...
                .AddPerkLevel()
                .Description("The beast breathes poison at hostile targets in a cone, dealing 18 poison DMG plus MGT scaling and attempting to inflict Poison.")
                .Price(3)
        ...
        private void IceBreath()
        {
            _builder.Create(PerkCategoryType.BeastBruiser, PerkType.IceBreath)
                ...
                .AddPerkLevel()
                .Description("The beast breathes ice at hostile targets in a cone, dealing 10 ice DMG plus MGT scaling and slowing affected enemies for 4 seconds.")
                .Price(2)
                ...
                .AddPerkLevel()
                .Description("The beast breathes ice at hostile targets in a cone, dealing 14 ice DMG plus MGT scaling and slowing affected enemies for 5 seconds.")
                .Price(2)
                ...
                .AddPerkLevel()
                .Description("The beast breathes ice at hostile targets in a cone, dealing 18 ice DMG plus MGT scaling and immobilizing affected enemies for 2 seconds.")
                .Price(4)
        ...
        private void CrushingSlam()
        {
            _builder.Create(PerkCategoryType.BeastBruiser, PerkType.CrushingSlam)
                ...
                .AddPerkLevel()
                .Description("The beast slams nearby hostile enemies for 10 physical DMG plus MGT scaling and Dazes them for 2 seconds.")
                .Price(3)
                ...
                .AddPerkLevel()
                .Description("The beast slams nearby hostile enemies for 14 physical DMG plus MGT scaling and Dazes them for 2 seconds.")
                .Price(4)
                ...
                .AddPerkLevel()
                .Description("The beast slams nearby hostile enemies for 18 physical DMG plus MGT scaling and Dazes them for 3 seconds.")
                .Price(4)
