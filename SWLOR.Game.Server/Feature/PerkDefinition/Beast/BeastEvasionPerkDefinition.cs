    ...
    public sealed class BeastEvasionPerkDefinition : IPerkListDefinition
    {
        ...
        private void Assault()
        {
            _builder.Create(PerkCategoryType.BeastEvasion, PerkType.Assault)
                ...
                .AddPerkLevel()
                .Description("The beast's next attack deals +10 physical DMG and grants +6% evasion chance for 10 seconds.")
                .Price(2)
                ...
                .AddPerkLevel()
                .Description("The beast's next attack deals +20 physical DMG and grants +10% evasion chance for 10 seconds.")
                .Price(2)
                ...
                .AddPerkLevel()
                .Description("The beast's next attack deals +32 physical DMG and grants +14% evasion chance for 10 seconds.")
                .Price(4)
        ...
        private void DistractingFeint()
        {
            _builder.Create(PerkCategoryType.BeastEvasion, PerkType.DistractingFeint)
                ...
                .AddPerkLevel()
                .Description("The beast's next attack reduces target physical and force ability hit chance by 6% for 15 seconds and generates extra enmity.")
                .Price(3)
                ...
                .AddPerkLevel()
                .Description("The beast's next attack reduces target hit chance and evasion chance by 8% for 15 seconds and generates extra enmity.")
                .Price(4)
                ...
                .AddPerkLevel()
                .Description("The beast's next attack reduces target hit chance and evasion chance by 12% for 15 seconds and generates extra enmity.")
                .Price(4)
        ...
        private void EvasiveChallenge()
        {
            _builder.Create(PerkCategoryType.BeastEvasion, PerkType.EvasiveChallenge)
                ...
                .AddPerkLevel()
                .Description("The beast goads a single target, gains +8% evasion chance for 8 seconds, and restores 1 STM the next time it evades during the effect.")
                .Price(3)
        ...
        private void UntouchableInstinct()
        {
            _builder.Create(PerkCategoryType.BeastEvasion, PerkType.UntouchableInstinct)
                ...
                .AddPerkLevel()
                .Description("The beast gains +20% evasion chance, +30% enmity generation, and 20% movement speed for 15 seconds.")
                .Price(5)
                .RequirementBeastLevel(50)
                .RequirementBeastRole(BeastRoleType.Evasion)
