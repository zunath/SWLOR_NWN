    ...
    public sealed class BeastForcePerkDefinition : IPerkListDefinition
    {
        ...
        private void WardingHowl()
        {
            _builder.Create(PerkCategoryType.BeastForce, PerkType.WardingHowl)
                ...
                .AddPerkLevel()
                .Description("The beast causes nearby allies to take 5% less force damage for 30 seconds.")
                .Price(3)
                ...
                .AddPerkLevel()
                .Description("The beast causes nearby allies to take 8% less force damage for 30 seconds.")
                .Price(4)
                ...
                .AddPerkLevel()
                .Description("The beast causes nearby allies to take 12% less force damage for 30 seconds.")
                .Price(4)
        ...
        private void PsychicCry()
        {
            _builder.Create(PerkCategoryType.BeastForce, PerkType.PsychicCry)
                ...
                .AddPerkLevel()
                .Description("The beast reduces nearby enemies' hit chance by 5% for 30 seconds.")
                .Price(3)
                ...
                .AddPerkLevel()
                .Description("The beast reduces nearby enemies' hit chance by 8% and increases their force damage taken by 5% for 30 seconds.")
                .Price(3)
                ...
                .AddPerkLevel()
                .Description("The beast reduces nearby enemies' hit chance by 12% and increases their force damage taken by 8% for 30 seconds.")
                .Price(3)
