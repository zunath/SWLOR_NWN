    ...
    public class DevicesPerkDefinition: IPerkListDefinition
    {
        ...
        private void IonGrenade()
        {
            _builder.Create(PerkCategoryType.Devices, PerkType.IonGrenade)
                ...
                .AddPerkLevel()
                .Description("Deals 2.0 electrical DMG to all enemies within range of explosion. Consumes explosives on use.")
                .RequirementSkill(SkillType.Devices, 5)
                .RequirementCharacterType(CharacterType.Standard)
                .Price(2)
                ...
                .AddPerkLevel()
                .Description("Deals 4.0 electrical DMG to all enemies within range of explosion. Also has a 50% chance to inflict stun to droids. Consumes explosives on use.")
                .Price(3)
                ...
                .AddPerkLevel()
                .Description("Deals 7.0 electrical DMG to all enemies within range of explosion. Also has a 70% chance to inflict stun to droids. Consumes explosives on use.")
                .Price(3)
                .RequirementSkill(SkillType.Devices, 35)
                .RequirementCharacterType(CharacterType.Standard)
        ...
        private void AdhesiveGrenade()
        {
            _builder.Create(PerkCategoryType.Devices, PerkType.AdhesiveGrenade)
                ...
                .AddPerkLevel()
                .Description("Inflicts slow on all enemies within range of explosion for 12 seconds. Consumes explosives on use.")
                .RequirementSkill(SkillType.Devices, 25)
                .RequirementCharacterType(CharacterType.Standard)
                .Price(2)
                ...
                .AddPerkLevel()
                .Description("Inflicts slow on all enemies within range of explosion for 12 seconds. Also has a 30% chance to inflict immobilize instead. Consumes explosives on use.")
                .Price(3)
                .RequirementSkill(SkillType.Devices, 40)
                .RequirementCharacterType(CharacterType.Standard)
                ...
                .AddPerkLevel()
                .Description("Inflicts slow on all enemies within range of explosion for 18 seconds. Also has a 50% chance to inflict immobilize instead. Consumes explosives on use.")
                .Price(3)
        ...
        private void IncendiaryBomb()
        {
            _builder.Create(PerkCategoryType.Devices, PerkType.IncendiaryBomb)
                ...
                .AddPerkLevel()
                .Description("Creates a fire field at the explosion site, dealing 1.5 fire DMG to all creatures who enter the area of effect for 20 seconds. Consumes explosives on use.")
                ...
                .AddPerkLevel()
                .Description("Creates a fire field at the explosion site, dealing 5.0 fire DMG to all creatures who enter the area of effect for 40 seconds. Consumes explosives on use.")
                .Price(3)
                ...
                .AddPerkLevel()
                .Description("Creates a fire field at the explosion site, dealing 7.5 fire DMG to all creatures who enter the area of effect for 60 seconds. Consumes explosives on use.")
                .Price(3)
        ...
        private void GasBomb()
        {
            _builder.Create(PerkCategoryType.Devices, PerkType.GasBomb)
                ...
                .AddPerkLevel()
                .Description("Creates a poison field at the explosion site, dealing 2.0 poison DMG to all creatures who enter the area of effect for 18 seconds. Consumes explosives on use.")
                ...
                .AddPerkLevel()
                .Description("Creates a poison field at the explosion site, dealing 5.5 poison DMG to all creatures who enter the area of effect for 30 seconds. Consumes explosives on use.")
                .Price(3)
                ...
                .AddPerkLevel()
                .Description("Creates a poison field at the explosion site, dealing 8.0 poison DMG to all creatures who enter the area of effect for 48 seconds. Consumes explosives on use.")
                .Price(3)
        ...
        private void Flamethrower()
        {
            _builder.Create(PerkCategoryType.Devices, PerkType.Flamethrower)
                ...
                .AddPerkLevel()
                .Description("Deals 3.0 fire DMG to all targets within a cone in front of the user.")
                .RequirementSkill(SkillType.Devices, 5)
                .RequirementCharacterType(CharacterType.Standard)
                .Price(2)
                ...
                .AddPerkLevel()
                .Description("Deals 5.0 fire DMG to all targets within a cone in front of the user. Also has a 30% chance to inflict Burning.")
                .Price(3)
                .RequirementSkill(SkillType.Devices, 20)
                .RequirementCharacterType(CharacterType.Standard)
                ...
                .AddPerkLevel()
                .Description("Deals 8.0 fire DMG to all targets within a cone in front of the user. Also has a 50% chance to inflict Burning.")
                .Price(3)
                .RequirementSkill(SkillType.Devices, 40)
                .RequirementCharacterType(CharacterType.Standard)
        ...
        private void WristRocket()
        {
            _builder.Create(PerkCategoryType.Devices, PerkType.WristRocket)
                ...
                .AddPerkLevel()
                .Description("Inflicts 3.5 fire DMG to a single target.")
                .RequirementSkill(SkillType.Devices, 10)
                .RequirementCharacterType(CharacterType.Standard)
                .Price(2)
                ...
                .AddPerkLevel()
                .Description("Inflicts 6.0 fire DMG to a single target. Also has a 30% chance to inflict Knockdown.")
                .Price(3)
                .RequirementSkill(SkillType.Devices, 25)
                .RequirementCharacterType(CharacterType.Standard)
                ...
                .AddPerkLevel()
                .Description("Inflicts 9.5 fire DMG to a single target. Also has a 50% chance to inflict Knockdown.")
                .Price(3)
                .RequirementSkill(SkillType.Devices, 40)
                .RequirementCharacterType(CharacterType.Standard)
