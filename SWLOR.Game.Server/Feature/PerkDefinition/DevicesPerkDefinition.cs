    ...
    public class DevicesPerkDefinition: IPerkListDefinition
    {
        ...
        private void FragGrenade()
        {
            _builder.Create(PerkCategoryType.Devices, PerkType.FragGrenade)
                ...
                .AddPerkLevel()
                .Description("Deals 10 fire DMG to all creatures within range of explosion. Also has a 6DC reflex check to inflict Bleeding. Consumes explosives on use.")
                .Price(3)
                ...
                .AddPerkLevel()
                .Description("Deals 16 fire DMG to all creatures within range of explosion. Also has a 10DC reflex check to inflict Bleeding. Consumes explosives on use.")
                .Price(3)
        ...
        private void ConcussionGrenade()
        {
            _builder.Create(PerkCategoryType.Devices, PerkType.ConcussionGrenade)
                ...
                .AddPerkLevel()
                 .Description("Deals 10 electrical DMG to all creatures within range of explosion. Also has a 6DC reflex check to inflict Knockdown for 3 seconds. Consumes explosives on use.")
                .Price(3)
                ...
                .AddPerkLevel()
                .Description("Deals 16 electrical DMG to all creatures within range of explosion. Also has a 10DC reflex check to inflict Knockdown for 3 seconds. Consumes explosives on use.")
                .Price(3)
        ...
        private void AdhesiveGrenade()
        {
            _builder.Create(PerkCategoryType.Devices, PerkType.AdhesiveGrenade)
                ...
                .AddPerkLevel()
                .Description("Inflicts slow on all enemies within range of explosion for 6 seconds. Also has a 6DC fortitude check to inflict immobilize instead. Consumes explosives on use.")
                .Price(3)
                .RequirementSkill(SkillType.Devices, 40)
                .RequirementCharacterType(CharacterType.Standard)
                ...
                .AddPerkLevel()
                .Description("Inflicts slow on all enemies within range of explosion for 8 seconds. Also has a 10DC fortitude check to inflict immobilize instead. Consumes explosives on use.")
                .Price(3)
        ...
        private void Flamethrower()
        {
            _builder.Create(PerkCategoryType.Devices, PerkType.Flamethrower)
                ...
                .AddPerkLevel()
                .Description("Deals 5 fire DMG to all targets within a cone in front of the user. Also has a 6DC reflex check to inflict Burning.")
                .Price(3)
                .RequirementSkill(SkillType.Devices, 20)
                .RequirementCharacterType(CharacterType.Standard)
                ...
                .AddPerkLevel()
                .Description("Deals 8 fire DMG to all targets within a cone in front of the user. Also has a 10DC reflex check to inflict Burning.")
                .Price(3)
                .RequirementSkill(SkillType.Devices, 40)
                .RequirementCharacterType(CharacterType.Standard)
        ...
        private void WristRocket()
        {
            _builder.Create(PerkCategoryType.Devices, PerkType.WristRocket)
                ...
                .AddPerkLevel()
                .Description("Inflicts 12 fire DMG to a single target. Also has a 6DC fortitude check to inflict Knockdown for 3 seconds.")
                .Price(3)
                .RequirementSkill(SkillType.Devices, 25)
                .RequirementCharacterType(CharacterType.Standard)
                ...
                .AddPerkLevel()
                .Description("Inflicts 20 fire DMG to a single target. Also has a 10DC fortitude check to inflict Knockdown for 3 seconds.")
                .Price(3)
                .RequirementSkill(SkillType.Devices, 40)
                .RequirementCharacterType(CharacterType.Standard)
