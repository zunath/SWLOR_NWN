    ...
    public class DevicesPerkDefinition: IPerkListDefinition
    {
        ...
        private void FragGrenade()
        {
            _builder.Create(PerkCategoryType.Devices, PerkType.FragGrenade)
                ...
                .AddPerkLevel()
                .Description("Deals 3 fire DMG to all creatures within range of explosion. Consumes explosives on use.")
                .Price(2)
                .RequirementCharacterType(CharacterType.Standard)
                .GrantsFeat(FeatType.FragGrenade1)

                .AddPerkLevel()
                .Description("Deals 5 fire DMG to all creatures within range of explosion. Also has a 30% chance to inflict Bleeding. Consumes explosives on use.")
                .Price(3)
                ...
                .AddPerkLevel()
                .Description("Deals 8 fire DMG to all creatures within range of explosion. Also has a 50% chance to inflict Bleeding. Consumes explosives on use.")
                .Price(3)
        ...
        private void ConcussionGrenade()
        {
            _builder.Create(PerkCategoryType.Devices, PerkType.ConcussionGrenade)
                ...
                .AddPerkLevel()
                .Description("Deals 3 electrical DMG to all creatures within range of explosion. Consumes explosives on use.")
                ...
                .AddPerkLevel()
                 .Description("Deals 5 electrical DMG to all creatures within range of explosion. Also has a 30% chance to inflict Knockdown. Consumes explosives on use.")
                .Price(3)
                ...
                .AddPerkLevel()
                .Description("Deals 8 electrical DMG to all creatures within range of explosion. Also has a 50% chance to inflict Knockdown. Consumes explosives on use.")
                .Price(3)
        ...
        private void IonGrenade()
        {
            _builder.Create(PerkCategoryType.Devices, PerkType.IonGrenade)
                ...
                .AddPerkLevel()
                .Description("Deals 2 electrical DMG to all enemies within range of explosion. Consumes explosives on use.")
                .RequirementSkill(SkillType.Devices, 5)
                .RequirementCharacterType(CharacterType.Standard)
                .Price(2)
                ...
                .AddPerkLevel()
                .Description("Deals 4 electrical DMG to all enemies within range of explosion. Also has a 50% chance to inflict stun to droids. Consumes explosives on use.")
                .Price(3)
                ...
                .AddPerkLevel()
                .Description("Deals 7 electrical DMG to all enemies within range of explosion. Also has a 70% chance to inflict stun to droids. Consumes explosives on use.")
                .Price(3)
                .RequirementSkill(SkillType.Devices, 35)
                .RequirementCharacterType(CharacterType.Standard)
        ...
        private void IncendiaryBomb()
        {
            _builder.Create(PerkCategoryType.Devices, PerkType.IncendiaryBomb)
                ...
                .AddPerkLevel()
                .Description("Creates a fire field at the explosion site, dealing 2 fire DMG to all creatures who enter the area of effect for 20 seconds. Consumes explosives on use.")
                ...
                .AddPerkLevel()
                .Description("Creates a fire field at the explosion site, dealing 5 fire DMG to all creatures who enter the area of effect for 40 seconds. Consumes explosives on use.")
                .Price(3)
                ...
                .AddPerkLevel()
                .Description("Creates a fire field at the explosion site, dealing 8 fire DMG to all creatures who enter the area of effect for 60 seconds. Consumes explosives on use.")
                .Price(3)
        ...
        private void GasBomb()
        {
            _builder.Create(PerkCategoryType.Devices, PerkType.GasBomb)
                ...
                .AddPerkLevel()
                .Description("Creates a poison field at the explosion site, dealing 2 poison DMG to all creatures who enter the area of effect for 18 seconds. Consumes explosives on use.")
                ...
                .AddPerkLevel()
                .Description("Creates a poison field at the explosion site, dealing 6 poison DMG to all creatures who enter the area of effect for 30 seconds. Consumes explosives on use.")
                .Price(3)
                ...
                .AddPerkLevel()
                .Description("Creates a poison field at the explosion site, dealing 8 poison DMG to all creatures who enter the area of effect for 48 seconds. Consumes explosives on use.")
                .Price(3)
        ...
        private void Flamethrower()
        {
            _builder.Create(PerkCategoryType.Devices, PerkType.Flamethrower)
                ...
                .AddPerkLevel()
                .Description("Deals 3 fire DMG to all targets within a cone in front of the user.")
                .RequirementSkill(SkillType.Devices, 5)
                .RequirementCharacterType(CharacterType.Standard)
                .Price(2)
                ...
                .AddPerkLevel()
                .Description("Deals 5 fire DMG to all targets within a cone in front of the user. Also has a 30% chance to inflict Burning.")
                .Price(3)
                .RequirementSkill(SkillType.Devices, 20)
                .RequirementCharacterType(CharacterType.Standard)
                ...
                .AddPerkLevel()
                .Description("Deals 8 fire DMG to all targets within a cone in front of the user. Also has a 50% chance to inflict Burning.")
                .Price(3)
                .RequirementSkill(SkillType.Devices, 40)
                .RequirementCharacterType(CharacterType.Standard)
        ...
        private void WristRocket()
        {
            _builder.Create(PerkCategoryType.Devices, PerkType.WristRocket)
                ...
                .AddPerkLevel()
                .Description("Inflicts 4 fire DMG to a single target.")
                .RequirementSkill(SkillType.Devices, 10)
                .RequirementCharacterType(CharacterType.Standard)
                .Price(2)
                ...
                .AddPerkLevel()
                .Description("Inflicts 6 fire DMG to a single target. Also has a 30% chance to inflict Knockdown.")
                .Price(3)
                .RequirementSkill(SkillType.Devices, 25)
                .RequirementCharacterType(CharacterType.Standard)
                ...
                .AddPerkLevel()
                .Description("Inflicts 10 fire DMG to a single target. Also has a 50% chance to inflict Knockdown.")
                .Price(3)
                .RequirementSkill(SkillType.Devices, 40)
                .RequirementCharacterType(CharacterType.Standard)
