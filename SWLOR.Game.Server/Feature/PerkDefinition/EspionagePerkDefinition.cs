    ...
    public class EspionagePerkDefinition : IPerkListDefinition
    {
        ...
        private void Stealth()
        {
            _builder.Create(PerkCategoryType.EspionageInfiltrator, PerkType.Stealth)
                ...
                .AddPerkLevel()
                .Description("Improves NWN's built-in Stealth mode to grant +10 Stealth while active. Drains 2 STM every 6 seconds, breaks on hostile action, and can only be entered while out of combat.")
                .Price(3)
                ...
                .AddPerkLevel()
                .Description("Improves NWN's built-in Stealth mode to grant +15 Stealth while active. Drains 2 STM every 6 seconds, breaks on hostile action, and can only be entered while out of combat.")
                .Price(3)
                ...
                .AddPerkLevel()
                .Description("Improves NWN's built-in Stealth mode to grant +20 Stealth while active. Drains 2 STM every 6 seconds, breaks on hostile action, and can only be entered while out of combat.")
                .Price(4)
