    ...
    public class FirstAidPerkDefinition : IPerkListDefinition
    {
        ...
        private void CombatEnhancement()
        {
            _builder.Create(PerkCategoryType.FirstAid, PerkType.CombatEnhancement)
                ...
                .AddPerkLevel()
                .Description("Increases the MGT, PER, and VIT of a single target by 1 for 15 minutes. Consumes stim pack on use. PER increase does not stack with Force Inspiration.")
                .Price(3)
                .RequirementSkill(SkillType.FirstAid, 25)
                .RequirementCharacterType(CharacterType.Standard)
                ...
                .AddPerkLevel()
                .Description("Increases the MGT, PER, and VIT of a single target by 2 for 15 minutes. Consumes stim pack on use. PER increase does not stack with Force Inspiration.")
                .Price(3)
                .RequirementSkill(SkillType.FirstAid, 35)
                .RequirementCharacterType(CharacterType.Standard)
                ...
                .AddPerkLevel()
                .Description("Increases the MGT, PER, and VIT of a single target by 3 for 15 minutes. Consumes stim pack on use. PER increase does not stack with Force Inspiration.")
                .Price(4)
                .RequirementSkill(SkillType.FirstAid, 45)
                .RequirementCharacterType(CharacterType.Standard)
