    ...
    public sealed class ForceDarkManipulatorPerkDefinition : IPerkListDefinition
    {
        ...
        private void CreepingTerror()
        {
            _builder.Create(PerkCategoryType.ForceDark, PerkType.CreepingTerror)
                ...
                .AddPerkLevel()
                .Description("Creates a visible 5m field within 15m for 12 seconds. Enemies inside are Hobbled and take 10 force DMG plus WIL scaling every 3 seconds.")
                .Price(2)
                ...
                .AddPerkLevel()
                .Description("Creates a visible 5m field within 15m for 15 seconds. Enemies inside are Hobbled and take 14 force DMG plus WIL scaling every 3 seconds.")
                .Price(3)
