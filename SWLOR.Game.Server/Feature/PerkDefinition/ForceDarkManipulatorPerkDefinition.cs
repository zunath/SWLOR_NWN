    ...
    public sealed class ForceDarkManipulatorPerkDefinition : IPerkListDefinition
    {
        ...
        private void CreepingTerror()
        {
            _builder.Create(PerkCategoryType.ForceDark, PerkType.CreepingTerror)
                ...
                .AddPerkLevel()
                .Description("Creates a visible 4m field of grasping dark energy for 12 seconds. Enemies inside take 6 force DMG plus WIL scaling every 3 seconds and are Hobbled while inside.")
                .Price(2)
                ...
                .AddPerkLevel()
                .Description("Creates a visible 4m field of grasping dark energy for 15 seconds. Enemies inside take 8 force DMG plus WIL scaling every 3 seconds and are Hobbled while inside.")
                .Price(3)
                ...
                .AddPerkLevel()
                .Description("Creates a visible 5m field of grasping dark energy for 18 seconds. Enemies inside take 10 force DMG plus WIL scaling every 3 seconds and are Hobbled while inside.")
                .Price(4)
        ...
        private void ForceChoke()
        {
            _builder.Create(PerkCategoryType.ForceDark, PerkType.ForceChoke)
                ...
                .AddPerkLevel()
                .Description("Immobilizes one target for 2 seconds, interrupts activation, and deals 8 force DMG plus WIL scaling over the duration.")
                .Price(2)
                ...
                .AddPerkLevel()
                .Description("Immobilizes one target for 3 seconds, interrupts activation, and deals 16 force DMG plus WIL scaling over the duration.")
                .Price(3)
                ...
                .AddPerkLevel()
                .Description("Immobilizes one target for 4 seconds, interrupts activation, and deals 24 force DMG plus WIL scaling over the duration.")
                .Price(4)
                ...
                .AddPerkLevel()
                .Description("Immobilizes one target for 5 seconds, interrupts activation, and deals 34 force DMG plus WIL scaling over the duration.")
                .Price(4)
