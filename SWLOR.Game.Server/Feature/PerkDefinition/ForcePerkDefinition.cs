    ...
    public class ForcePerkDefinition : IPerkListDefinition
    {
        ...
        private void Disturbance()
        {
            _builder.Create(PerkCategoryType.ForceLight, PerkType.Disturbance)
                ...
                .AddPerkLevel()
                .Description("Deals 10 DMG, scaling with your Willpower Score, to a single target and reduces target's accuracy by 20 with a 12DC will check for one minute.")
                .Price(2)
                .RequirementSkill(SkillType.Force, 25)
                .RequirementCharacterType(CharacterType.ForceSensitive)
                .RequirementCannotHavePerk(PerkType.ForceSpark)
                ...
                .AddPerkLevel()
                .Description("Deals 20 DMG, scaling with your Willpower Score, to a single target and reduces target's accuracy by 30 with a 14DC will check for one minute.")
                .Price(2)
                .RequirementSkill(SkillType.Force, 45)
                .RequirementCharacterType(CharacterType.ForceSensitive)
                .RequirementCannotHavePerk(PerkType.ForceSpark)
