    ...
    public sealed class ForceUniversalPerkDefinition : IPerkListDefinition
    {
        ...
        private void ForcePush()
        {
            _builder.Create(PerkCategoryType.ForceUniversal, PerkType.ForcePush)
                ...
                .AddPerkLevel()
                .Description("Deals 8 force DMG to one target in a 5m cone, knocks down for 6 seconds, and slows movement for 12 seconds.")
                .Price(2)
                ...
                .AddPerkLevel()
                .Description("Deals 12 force DMG to up to 2 targets in an 8m cone, knocks down for 6 seconds, and slows movement for 12 seconds.")
                .Price(3)
                ...
                .AddPerkLevel()
                .Description("Deals 18 force DMG to up to 3 targets in a 10m cone, knocks down for 6 seconds, and slows movement for 12 seconds.")
                .Price(4)
