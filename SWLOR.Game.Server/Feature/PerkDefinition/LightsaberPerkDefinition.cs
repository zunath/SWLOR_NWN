    ...
    public class LightsaberPerkDefinition: IPerkListDefinition
    {
        ...
        private void DeflectingReturn()
        {
            _builder.Create(PerkCategoryType.LightsaberOffense, PerkType.DeflectingReturn)
                ...
                .Description("Gain +5 Ranged Deflection. When your Ranged Deflection negates a directly targeted ranged weapon auto-attack, reflect 20% of the attack's damage back to its source, up to 50% of your normal weapon damage. Triggers at most once every 6 seconds.")
                .IncreasesStat(StatType.RangedDeflection, 5)
                .IncreasesStat(StatType.RangedDeflectionReflectionPercent, 20)
                ...
                .AddPerkLevel()
                .Description("Gain +8 Ranged Deflection. When your Ranged Deflection negates a directly targeted ranged weapon auto-attack, reflect 30% of the attack's damage back to its source, up to 75% of your normal weapon damage. Triggers at most once every 6 seconds.")
                .IncreasesStat(StatType.RangedDeflection, 8)
                .IncreasesStat(StatType.RangedDeflectionReflectionPercent, 30)
                .IncreasesStat(StatType.RangedDeflectionReflectionCapPercent, 75)
                .Price(4)
                .RequirementSkill(SkillType.Lightsaber, 25)
                .RequirementCharacterType(CharacterType.ForceSensitive)

                .AddPerkLevel()
                .Description("Gain +12 Ranged Deflection. When your Ranged Deflection negates a directly targeted ranged weapon auto-attack, reflect 40% of the attack's damage back to its source, up to 100% of your normal weapon damage. Triggers at most once every 6 seconds.")
                .IncreasesStat(StatType.RangedDeflection, 12)
                .IncreasesStat(StatType.RangedDeflectionReflectionPercent, 40)
                .IncreasesStat(StatType.RangedDeflectionReflectionCapPercent, 100)
                .Price(4)
                .RequirementSkill(SkillType.Lightsaber, 45)
                .RequirementCharacterType(CharacterType.ForceSensitive);
        }
        ...
        private void AegisEternal()
        {
            _builder.Create(PerkCategoryType.LightsaberOffense, PerkType.AegisEternal)
                ...
                .Description("For 30 seconds, enter Perfect Aegis, replacing Saber Ward: convert 40% of incoming physical damage to Force damage and gain + 8% Defense, + 12% Force Defense, and + 25% Enmity. Embattled is treated as 5 stacks and Deflecting Return reflects 50% of damage, up to 125% of your normal weapon damage.")
                .Price(6)
                .RequirementSkill(SkillType.Lightsaber, 50)
                .RequirementCharacterType(CharacterType.ForceSensitive)
