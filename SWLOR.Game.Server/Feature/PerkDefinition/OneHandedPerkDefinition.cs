    ...
    public class OneHandedPerkDefinition : IPerkListDefinition
    {
        ...
        private void SaberStrike()
        {
            _builder.Create(PerkCategoryType.OneHandedLightsaber, PerkType.SaberStrike)
                ...
                .AddPerkLevel()
                .Description("Your next attack deals an additional 6.5 DMG and has a 50% chance to inflict Breach, reducing evasion for 30 seconds.")
                .Price(2)
                .RequirementSkill(SkillType.OneHanded, 5)
                .RequirementCharacterType(CharacterType.ForceSensitive)
                ...
                .AddPerkLevel()
                .Description("Your next attack deals an additional 8.0 DMG and has a 75% chance to inflict Breach, reducing evasion for 1 minute.")
                .Price(3)
                .RequirementSkill(SkillType.OneHanded, 20)
                .RequirementCharacterType(CharacterType.ForceSensitive)
                ...
                .AddPerkLevel()
                .Description("Your next attack deals an additional 11.5 DMG and has a 100% chance to inflict Breach, reducing evasion for 1 minute.")
                .Price(3)
                .RequirementSkill(SkillType.OneHanded, 35)
                .RequirementCharacterType(CharacterType.ForceSensitive)
