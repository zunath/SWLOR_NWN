    ...
    public class PistolPerkDefinition: IPerkListDefinition
    {
        ...
        private void SnapRoll()
        {
            _builder.Create(PerkCategoryType.PistolSkirmisher, PerkType.SnapRoll)
                ...
                .IncreasesStat(StatType.AbilityUsedEvasionPercentAdjustmentSkillType, (int)SkillType.Pistol)
                .IncreasesStat(StatType.AbilityUsedEvasionPercentAdjustment, 12)
                .IncreasesStat(StatType.AbilityUsedEvasionDurationSeconds, 30)
                .Price(4)
        ...
        private void LuckyChamber()
        {
            _builder.Create(PerkCategoryType.PistolGunslinger, PerkType.LuckyChamber)
                ...
                .IncreasesStat(StatType.AutoAttackCycleCriticalRateSkillType, (int)SkillType.Pistol)
                .IncreasesStat(StatType.AutoAttackCycleCriticalRateRequiredCount, 4)
                .IncreasesStat(StatType.AutoAttackCycleCriticalRatePercentAdjustment, 10)
                .Price(2)
                .RequirementSkill(SkillType.Pistol, 5);
        }
