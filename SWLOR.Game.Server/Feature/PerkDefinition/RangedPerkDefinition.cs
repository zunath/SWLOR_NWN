    ...
    public class RangedPerkDefinition : IPerkListDefinition
    {
        ...
        private void CripplingShot(PerkBuilder builder)
        {
            builder.Create(PerkCategoryType.RangedRifle, PerkType.CripplingShot)
                ...
                .AddPerkLevel()
                .Description("Your next attack deals an additional 12 DMG and has a 50% chance to inflict Bind for 30 seconds.")
                .Price(2)
                .RequirementSkill(SkillType.Ranged, 5)
                .RequirementCharacterType(CharacterType.Standard)
                ...
                .AddPerkLevel()
                .Description("Your next attack deals an additional 21 DMG and has a 75% chance to inflict Bind for 1 minute.")
                .Price(3)
                .RequirementSkill(SkillType.Ranged, 20)
                .RequirementCharacterType(CharacterType.Standard)
                ...
                .AddPerkLevel()
                .Description("Your next attack deals an additional 34 DMG and has a 100% chance to inflict Bind for 1 minute.")
                .Price(3)
                .RequirementSkill(SkillType.Ranged, 35)
                .RequirementCharacterType(CharacterType.Standard)
