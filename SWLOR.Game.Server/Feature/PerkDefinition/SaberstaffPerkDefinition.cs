    ...
    public class SaberstaffPerkDefinition: IPerkListDefinition
    {
        ...
        private void EnergizedForms()
        {
            _builder.Create(PerkCategoryType.SaberstaffConduit, PerkType.EnergizedForms)
                ...
                .Description("Using a Force ability causes your next saberstaff attack within 18 seconds to deal +15 DMG. Using a saberstaff ability reduces the FP cost of your next Force ability within 18 seconds by 2.")
                ...
                .IncreasesStat(StatType.AbilityUsedNextSkillFPCostAdjustmentWindowSeconds, 18)
                .Price(2)
        ...
        private void SpinningDeflection()
        {
            _builder.Create(PerkCategoryType.SaberstaffTempest, PerkType.SpinningDeflection)
                ...
                .Description("Gain +5 Attack Deflection. After deflecting an attack, reduce Circle Slash's cooldown by 1 second and your next Circle Slash within 18 seconds deals +8 DMG.")
                ...
                .IncreasesStat(StatType.DeflectionNextAbilityDamageBonusDurationSeconds, 18)
                .Price(2)
                .RequirementSkill(SkillType.Saberstaff, 22)
                .RequirementCharacterType(CharacterType.ForceSensitive)

                .AddPerkLevel()
                .Description("Gain +10 Attack Deflection total. After deflecting an attack, reduce Circle Slash's cooldown by 1 second and your next Circle Slash within 18 seconds deals +8 DMG. Deflecting an attack restores 4 FP once every 6 seconds.")
