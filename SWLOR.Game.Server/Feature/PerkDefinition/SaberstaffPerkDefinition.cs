    ...
    public class SaberstaffPerkDefinition: IPerkListDefinition
    {
        ...
        private void SpinningDeflection()
        {
            _builder.Create(PerkCategoryType.SaberstaffTempest, PerkType.SpinningDeflection)
                ...
                .IncreasesStat(StatType.SaberstaffAreaAbilityMinTargetsBuffThreshold, 1)
                .IncreasesStat(StatType.SaberstaffAreaAbilityAttackDeflection, 3)
                .IncreasesStat(StatType.SaberstaffAreaAbilityBuffDurationSeconds, 30)
                .Price(2)
                .RequirementSkill(SkillType.Saberstaff, 8)
                .RequirementCharacterType(CharacterType.ForceSensitive)
                ...
                .IncreasesStat(StatType.SaberstaffAreaAbilityMinTargetsBuffThreshold, 1)
                .IncreasesStat(StatType.SaberstaffAreaAbilityAttackDeflection, 5)
                .IncreasesStat(StatType.SaberstaffAreaAbilityBuffDurationSeconds, 30)
                .Price(4)
                .RequirementSkill(SkillType.Saberstaff, 22)
                .RequirementCharacterType(CharacterType.ForceSensitive)
                ...
                .IncreasesStat(StatType.SaberstaffAreaAbilityMinTargetsBuffThreshold, 1)
                .IncreasesStat(StatType.SaberstaffAreaAbilityAttackDeflection, 7)
                .IncreasesStat(StatType.SaberstaffAreaAbilityBuffDurationSeconds, 30)
                .Price(4)
                .RequirementSkill(SkillType.Saberstaff, 45)
                .RequirementCharacterType(CharacterType.ForceSensitive);
