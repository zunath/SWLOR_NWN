    ...
    public class StaffPerkDefinition: IPerkListDefinition
    {
        ...
        private void BreakPosture()
        {
            _builder.Create(PerkCategoryType.StaffCrusher, PerkType.BreakPosture)
                ...
                .Description("Critical hits with any weapon inflict Exposed, reducing Defense by 10% for 10 seconds.")
                .IncreasesStat(StatType.CriticalTargetDefensePercentAdjustment, -10)
                .IncreasesStat(StatType.CriticalTargetDefenseDurationSeconds, 10)
                .Price(2)
