    ...
    public class TwinBladePerkDefinition: IPerkListDefinition
    {
        ...
        private void Momentum()
        {
            _builder.Create(PerkCategoryType.TwinBladeCyclone, PerkType.Momentum)
                ...
                .IncreasesStat(StatType.TwinBladeAreaAbilityHasteDurationSeconds, 30)
        ...
        private void SpinningRhythm()
        {
            _builder.Create(PerkCategoryType.TwinBladeCyclone, PerkType.SpinningRhythm)
                ...
                .IncreasesStat(StatType.TwinBladeAreaAbilityMinTargetsHasteThreshold, 2)
                .IncreasesStat(StatType.TwinBladeAreaAbilityHastePercentAdjustment, 2)
                .IncreasesStat(StatType.TwinBladeAreaAbilityHasteDurationSeconds, 30)
                .IncreasesStat(StatType.TwinBladeAreaAbilityHastePercentMax, 6)
                .Price(2)
                ...
                .IncreasesStat(StatType.TwinBladeAreaAbilityMinTargetsHasteThreshold, 2)
                .IncreasesStat(StatType.TwinBladeAreaAbilityHastePercentAdjustment, 3)
                .IncreasesStat(StatType.TwinBladeAreaAbilityHasteDurationSeconds, 30)
                .IncreasesStat(StatType.TwinBladeAreaAbilityHastePercentMax, 9)
                .Price(4)
                ...
                .IncreasesStat(StatType.TwinBladeAreaAbilityMinTargetsHasteThreshold, 2)
                .IncreasesStat(StatType.TwinBladeAreaAbilityHastePercentAdjustment, 4)
                .IncreasesStat(StatType.TwinBladeAreaAbilityHasteDurationSeconds, 30)
                .IncreasesStat(StatType.TwinBladeAreaAbilityHastePercentMax, 12)
                .Price(4)
        ...
        private void SweepingAdvance()
        {
            _builder.Create(PerkCategoryType.TwinBladeCyclone, PerkType.SweepingAdvance)
                ...
                .IncreasesStat(StatType.TwinBladeAreaAbilityStaminaRestorePerTarget, 2)
                .IncreasesStat(StatType.TwinBladeAreaAbilityStaminaRestoreMax, 6)
                .Price(4)
