    ...
    public class BeastMasteryCapstoneQuestDefinition : IQuestListDefinition
    {
        ...
        private void PrimalOverrunFoundation()
        {
            _builder.Create(PrimalOverrunFoundationQuestId, "Blood on the Old Trail")
                ...
                .AddState()
                .SetStateJournalText(
                    "Nalka Rinn gave you the Dathomir Grotto Apex Den Key when you accepted this quest. Use it to enter the trial area; it is listed under Key Items. Nalka Rinn wants six Primal Overrun adepts cleared out of the Dathomir Grotto Apex Den on Dathomir. Secure the Primal Overrun Grotto Track Slate they carry.")
        ...
        private void UntouchableInstinctFoundation()
        {
            _builder.Create(UntouchableInstinctFoundationQuestId, "First Frost")
                ...
                .AddState()
                .SetStateJournalText(
                    "Voro Thane gave you the Dathomir Grotto Apex Den Key when you accepted this quest. Use it to enter the trial area; it is listed under Key Items. Voro Thane wants six Untouchable Instinct adepts cleared out of the Dathomir Grotto Apex Den on Dathomir. Secure the Untouchable Instinct Grotto Track Slate they carry.")
        ...
        private void ForceBondedBeastFoundation()
        {
            _builder.Create(ForceBondedBeastFoundationQuestId, "Rite of First Thread")
                ...
                .AddState()
                .SetStateJournalText(
                    "Eshka Korr gave you the Dathomir Grotto Apex Den Key when you accepted this quest. Use it to enter the trial area; it is listed under Key Items. Eshka Korr wants six Force-Bonded Beast adepts cleared out of the Dathomir Grotto Apex Den on Dathomir. Secure the Force-Bonded Beast Grotto Track Slate they carry.")
        ...
        private void ApexBiteFoundation()
        {
            _builder.Create(ApexBiteFoundationQuestId, "Pen Count: Six Short")
                ...
                .AddState()
                .SetStateJournalText(
                    "Talra Venn gave you the Dathomir Tarn Jungle Preserve Key when you accepted this quest. Use it to enter the trial area; it is listed under Key Items. Talra Venn wants six Apex Bite adepts cleared out of the Dathomir Tarn Jungle Preserve on Dathomir. Secure the Apex Bite Tarn Hunt Tally they carry.")
        ...
        private void UnbreakableBeastFoundation()
        {
            _builder.Create(UnbreakableBeastFoundationQuestId, "Take It And Stand")
                ...
                .AddState()
                .SetStateJournalText(
                    "Oren Krast gave you the Dathomir Tarn Jungle Preserve Key when you accepted this quest. Use it to enter the trial area; it is listed under Key Items. Oren Krast wants six Unbreakable Beast adepts cleared out of the Dathomir Tarn Jungle Preserve on Dathomir. Secure the Unbreakable Beast Tarn Hunt Tally they carry.")
        ...
        private void AlphaRhythmFoundation()
        {
            _builder.Create(AlphaRhythmFoundationQuestId, "Off the Beat")
                ...
                .AddState()
                .SetStateJournalText(
                    "Mira Syth gave you the Dathomir Tarn Jungle Preserve Key when you accepted this quest. Use it to enter the trial area; it is listed under Key Items. Mira Syth wants six Alpha Rhythm adepts cleared out of the Dathomir Tarn Jungle Preserve on Dathomir. Secure the Alpha Rhythm Tarn Hunt Tally they carry.")
