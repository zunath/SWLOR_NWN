    ...
    public class ForceCapstoneQuestDefinition : IQuestListDefinition
    {
        ...
        private void LastStandOfTheLightFoundation()
        {
            _builder.Create(LastStandOfTheLightFoundationQuestId, "Lower Your Voice")
                ...
                .AddState()
                .SetStateJournalText(
                    "Seris Nahl gave you the Korriban Sith Crypt Depths Key when you accepted this quest. Use it to enter the trial area; it is listed under Key Items. Sith adepts rehearse a corrupted last-stand rite in the Korriban Sith Crypt Depths. Defeat 6 Last Stand of the Light adepts and recover the Last Stand of the Light Crypt Trial Tablet.")
        ...
        private void HungerOfTheDarkFoundation()
        {
            _builder.Create(HungerOfTheDarkFoundationQuestId, "An Appetite Worth Teaching")
                ...
                .AddState()
                .SetStateJournalText(
                    "Neth Kyr gave you the Korriban Sith Crypt Depths Key when you accepted this quest. Use it to enter the trial area; it is listed under Key Items. A coven of Hunger of the Dark adepts feeds on stolen power in the Korriban Sith Crypt Depths. Defeat 6 of them and recover the Hunger of the Dark Crypt Trial Tablet.")
        ...
        private void EclipseOfResolveFoundation()
        {
            _builder.Create(EclipseOfResolveFoundationQuestId, "Provisional Pass")
                ...
                .AddState()
                .SetStateJournalText(
                    "Acolyte Varn gave you the Korriban Sith Crypt Depths Key when you accepted this quest. Use it to enter the trial area; it is listed under Key Items. A failed cell of Eclipse of Resolve adepts drills a corrupted doctrine in the Korriban Sith Crypt Depths. Defeat 6 of them and recover the Eclipse of Resolve Crypt Trial Tablet.")
