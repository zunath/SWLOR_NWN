...
namespace SWLOR.Game.Server.Feature.QuestDefinition
{
    public class HuntersGuildQuestDefinition : IQuestListDefinition
    {
        ...
        public Dictionary<string, QuestDetail> BuildQuests()
        {
            ...
            BuildKillTask("hun_tsk_816", NPCGroupType.Dantooine_ThuneHerdLeader, 10, 4);
            BuildKillTask("hun_tsk_817", NPCGroupType.Dantooine_DantariShaman, 10, 4);
            BuildKillTask("hun_tsk_818", NPCGroupType.Dantooine_DantariHunter, 10, 4);
            BuildKillTask("hun_tsk_819", NPCGroupType.Dantooine_Gizka, 10, 4);
            BuildKillTask("hun_tsk_820", NPCGroupType.Dantooine_HiveKinrath, 10, 4);
            BuildKillTask("hun_tsk_821", NPCGroupType.Dantooine_Iriaz, 10, 4);
            BuildKillTask("hun_tsk_822", NPCGroupType.Dantoonie_PlainsThune, 10, 4);
            BuildKillTask("hun_tsk_823", NPCGroupType.Dantooine_KinrathQueen, 10, 4);
            BuildKillTask("hun_tsk_824", NPCGroupType.Dantooine_VoritorLizard, 10, 4);
            BuildKillTask("hun_tsk_825", NPCGroupType.Dantooine_BolBoss, 10, 4);
