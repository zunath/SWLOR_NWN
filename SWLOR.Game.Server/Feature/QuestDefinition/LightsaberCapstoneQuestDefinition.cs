    ...
    public class LightsaberCapstoneQuestDefinition : IQuestListDefinition
    {
        ...
        private void SaberStormFoundation()
        {
            _builder.Create(SaberStormFoundationQuestId, "Footwork Before Fury")
                ...
                .AddState()
                .SetStateJournalText(
                    "Talan Rees gave you the Dantooine Jedi Enclave Trial Halls Key when you accepted this quest. Use it to enter the trial area; it is listed under Key Items. Defeat 6 Saber Storm adepts in the outer ring of the Dantooine Jedi Enclave Trial Halls on Dantooine and secure the Saber Storm Enclave Trial Slate.")
        ...
        private void GuardianMasterFoundation()
        {
            _builder.Create(GuardianMasterFoundationQuestId, "While I Stand")
                ...
                .AddState()
                .SetStateJournalText(
                    "Miris Aven gave you the Dantooine Jedi Enclave Trial Halls Key when you accepted this quest. Use it to enter the trial area; it is listed under Key Items. Defeat 6 Guardian Master adepts in the outer ward of the Dantooine Jedi Enclave Trial Halls on Dantooine and secure the Guardian Master Enclave Trial Slate.")
