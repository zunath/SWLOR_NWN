    ...
    public class SpearCapstoneQuestDefinition : IQuestListDefinition
    {
        ...
        private void ForcebaneFoundation()
        {
            _builder.Create(ForcebaneFoundationQuestId, "Reach Ends Ritual")
                ...
                .AddState()
                .SetStateJournalText(
                    "Maar Veth gave you the Korriban Forge Caverns Key when you accepted this quest. Use it to enter the trial area; it is listed under Key Items. Kill six Forcebane adepts at the outer forges of the Korriban Forge Caverns on Korriban and secure the Forcebane Forge Heat Ledger.")
        ...
        private void CripplingDefenseFoundation()
        {
            _builder.Create(CripplingDefenseFoundationQuestId, "Open Trials, No Purse")
                ...
                .AddState()
                .SetStateJournalText(
                    "Dax Rell gave you the Smuggler's Moon Fight Club Backrooms Key when you accepted this quest. Use it to enter the trial area; it is listed under Key Items. Kill six Crippling Defense adepts in the sign-up rooms of the Smuggler's Moon Fight Club Backrooms on Nar Shaddaa and secure the Crippling Defense Backroom Bout Ledger.")
