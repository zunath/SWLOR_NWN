    ...
    public class ThrowingCapstoneQuestDefinition : IQuestListDefinition
    {
        ...
        private void RainOfSteelFoundation()
        {
            _builder.Create(RainOfSteelFoundationQuestId, "Shortage on the Manifest")
                ...
                .AddState()
                .SetStateJournalText(
                    "Varik Dane gave you the Czerka Arms Test Range Key when you accepted this quest. Use it to enter the trial area; it is listed under Key Items. Enter the Czerka Arms Test Range on Smuggler's Moon and defeat 6 Rain of Steel adepts, then recover the Rain of Steel Czerka Test Docket from their trial.")
        ...
        private void PerfectFlurryFoundation()
        {
            _builder.Create(PerfectFlurryFoundationQuestId, "The Warm-Up Act")
                ...
                .AddState()
                .SetStateJournalText(
                    "Selka Vorn gave you the Hutlar Qion Test Site Key when you accepted this quest. Use it to enter the trial area; it is listed under Key Items. Enter the Hutlar Qion Test Site on Hutlar and defeat 6 Perfect Flurry adepts on the open range, then recover the Perfect Flurry Qion Test Log.")
