...
namespace SWLOR.Game.Server.Feature.ShipModuleDefinition
{
    public class AssaultConcussionMissileModuleDefinition : IShipModuleListDefinition
    {
        ...
        {
            AssaultConcussionMissile("acm_launch_1", "Assault Concussion Missile Launcher I", "ACM Launcher", "Requires an assault concussion missile. Its massive warhead deals immense damage (200) to enemy capital ships, but cannot target subcapital ships.", 200);
