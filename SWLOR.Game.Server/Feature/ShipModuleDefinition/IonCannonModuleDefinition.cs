...
namespace SWLOR.Game.Server.Feature.ShipModuleDefinition
{
    public class IonCannonModuleDefinition : IShipModuleListDefinition
    {
        ...
        public Dictionary<string, ShipModuleDetail> BuildShipModules()
        {
            ...
            IonCannon("cap_turbo_1", "Capital Ship Turbolaser I", "Cap Turbo I", "A corvette's main guns. 35 DMG.", 5, 15f, 20, 45);
            IonCannon("cap_turbo_2", "Capital Ship Turbolaser II", "Cap Turbo II", "A frigate's main guns. 35 DMG.", 5, 12f, 20, 45);
            IonCannon("cap_turbo_3", "Capital Ship Turbolaser III", "Cap Turbo III", "A cruiser's main guns. 50 DMG.", 5, 15f, 20, 60);
            IonCannon("cap_turbo_4", "Capital Ship Turbolaser IV", "Cap Turbo IV", "A heavy cruiser's main guns. 50 DMG.", 5, 12f, 20, 60);
            IonCannon("cap_turbo_5", "Capital Ship Turbolaser V", "Cap Turbo V", "A battlecruiser's main guns. 60 DMG.", 5, 15f, 20, 75);
            IonCannon("cap_turbo_6", "Capital Ship Turbolaser VI", "Cap Turbo VI", "A battleship's main guns. 75 DMG.", 5, 15f, 20, 90);
            IonCannon("cap_turbo_7", "Capital Ship Turbolaser VII", "Cap Turbo VII", "A dreadnought's main guns. 75 DMG.", 5, 12f, 20, 90);
