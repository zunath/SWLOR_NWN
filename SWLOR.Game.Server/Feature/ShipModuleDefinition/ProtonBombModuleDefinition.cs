...
namespace SWLOR.Game.Server.Feature.ShipModuleDefinition
{
    public class ProtonBombModuleDefinition : IShipModuleListDefinition
    {
        ...
        public ProtonBombModuleDefinition(IRandomService random, ICombatService combatService, ISpaceService spaceService, IEnmityService enmityService, ICombatPointService combatPointService)
        {
            _random = random;
