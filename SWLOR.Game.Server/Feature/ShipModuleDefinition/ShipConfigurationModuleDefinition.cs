...
namespace SWLOR.Game.Server.Feature.ShipModuleDefinition
{
    public class ShipConfigurationModuleDefinition : IShipModuleListDefinition
    {
        ...
        public Dictionary<string, ShipModuleDetail> BuildShipModules()
        {
            ...
            ShipConfig("npc_cap1", "Boss Conf 1", "iit_ess8_121", 1, 0, 0, 0, 20, 0, 15, 10, 10, 5, 5, 0);
            ShipConfig("npc_cap2", "Boss Conf 2", "iit_ess8_121", 1, 0, 0, 5, 50, 5, 37, 20, 5, 10, 0, 0);
            ShipConfig("npc_cap3", "Boss Conf 3", "iit_ess8_121", 1, 0, 0, 10, 100, 10, 75, 10, 50, 15, 0, 0);
            ShipConfig("npc_cap4", "Boss Conf 4", "iit_ess8_121", 1, 0, 0, 20, 150, 20, 100, 20, 75, 20, 0, 0);
            ShipConfig("npc_cap5", "Boss Conf 5", "iit_ess8_121", 1, 0, 0, 30, 250, 30, 175, 30, 125, 30, 0, 0);
            ...
            ShipConfig("con_cap1", "NPC Cap Conf 1", "iit_ess8_121", 1, 0, 0, 30, 250, 30, 175, 30, 125, 30, 0, 0);
            ShipConfig("con_cap2", "NPC Cap Conf 2", "iit_ess8_121", 1, 0, 0, 30, 275, 30, 190, 30, 140, 30, 0, 0);
            ShipConfig("con_cap3", "NPC Cap Conf 3", "iit_ess8_121", 1, 0, 0, 30, 300, 30, 205, 30, 155, 30, 0, 0);
            ShipConfig("con_cap4", "NPC Cap Conf 4", "iit_ess8_121", 1, 0, 0, 30, 325, 30, 220, 30, 170, 30, 0, 0);
            ShipConfig("con_cap5", "NPC Cap Conf 5", "iit_ess8_121", 1, 0, 0, 30, 350, 30, 235, 30, 195, 30, 0, 0);
            ShipConfig("con_cap6", "NPC Cap Conf 6", "iit_ess8_121", 1, 0, 0, 30, 375, 30, 250, 30, 210, 30, 0, 0);
            ShipConfig("con_cap7", "NPC Cap Conf 7", "iit_ess8_121", 1, 0, 0, 30, 400, 30, 275, 30, 225, 30, 0, 0);
