...
{
    public sealed class AdhesiveGrenadeStatusEffect : StatusEffectBase
    {
        private readonly int _movementSpeedPenaltyPercent;

        public override string Name => "Adhesive Grenade";
        public override EffectIconType Icon => EffectIconType.AdhesiveGrenadeStatusEffect;
        ...
        public AdhesiveGrenadeStatusEffect()
            : this(50)
        {
        }

        public AdhesiveGrenadeStatusEffect(int movementSpeedPenaltyPercent)
        {
        ...
        {
            return new AdhesiveGrenadeStatusEffect(_movementSpeedPenaltyPercent);
        }
    }
}
