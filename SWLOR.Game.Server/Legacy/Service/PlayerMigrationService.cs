    ...
    public static class PlayerMigrationService
    {
        ...
        private static void OnModuleEnter()
        {
            ...
            if (dbPlayer.VersionNumber < 3)
            {
                ...
                Creature.RemoveFeat(player, Feat.DeprecatedForceBreach); // Force Breach
                Creature.RemoveFeat(player, Feat.DeprecatedForceLightning); // Force Lightning
                Creature.RemoveFeat(player, Feat.DeprecatedForceHeal1); // Force Heal
                Creature.RemoveFeat(player, Feat.DeprecatedDarkHeal); // Dark Heal
                Creature.RemoveFeat(player, Feat.DeprecatedForceSpread); // Force Spread
                Creature.RemoveFeat(player, Feat.DeprecatedDarkSpread); // Dark Spread
                Creature.RemoveFeat(player, Feat.DeprecatedForcePush); // Force Push
                Creature.RemoveFeat(player, Feat.DeprecatedForceAura); // Force Aura
                Creature.RemoveFeat(player, Feat.DeprecatedDrainLife); // Drain Life
                Creature.RemoveFeat(player, Feat.DeprecatedChainspell); // Chainspell
            ...
            if (dbPlayer.VersionNumber < 5)
            {
                Creature.RemoveFeat(player, Feat.DeprecatedForceBreach); // Force Breach
                Creature.RemoveFeat(player, Feat.DeprecatedForceLightning); // Force Lightning
                Creature.RemoveFeat(player, Feat.DeprecatedForceHeal1); // Force Heal I
                Creature.RemoveFeat(player, Feat.DeprecatedAbsorptionField); // Absorption Field
                Creature.RemoveFeat(player, Feat.DeprecatedForceSpread); // Force Spread
                Creature.RemoveFeat(player, Feat.DeprecatedForcePush); // Force Push
                Creature.RemoveFeat(player, Feat.DeprecatedForceAura); // Force Aura
                Creature.RemoveFeat(player, Feat.DeprecatedDrainLife); // Drain Life
                Creature.RemoveFeat(player, Feat.DeprecatedChainspell); // Chainspell
                Creature.RemoveFeat(player, Feat.DeprecatedForceHeal2); // Force Heal II
                Creature.RemoveFeat(player, Feat.DeprecatedForceHeal3); // Force Heal III
                Creature.RemoveFeat(player, Feat.DeprecatedForceHeal4); // Force Heal IV
            ...
            if (dbPlayer.VersionNumber < 8)
            {
                ...
                {
                    Creature.AddFeat(player, Feat.PointBlankShot);
                }

                // Rapid Reload
                if (PerkService.GetPCPerkByID(player.GlobalID, (int) PerkType.RapidReload) != null)
                {
                    Creature.AddFeat(player, Feat.RapidReload);
                }
