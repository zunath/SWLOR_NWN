  ...
  return;
   ...
   location nLoc19 = GetLocation(nObj19); //Get invisible object location
    ...
    GestaltStartCutscene    (oPC,"mycutscene",true,true,true,true,2);
     ...
     ApplyEffectToObject(DurationType.Permanent,nEff,oFan10); //Apply effect in invisible object - this effect NOT VISIBLE, but the sounds and move in screen continue
    ...
    AssignCommand(oPC, SpeakString("*The voice again surges through your mind.* Your power over the galaxy will allow you to decide the fate of others. What would you do if the life of another was in your hands?"));
     ...
     ApplyEffectToObject(DurationType.Permanent,nEff11,oFan11);
     ...
     ApplyEffectToObject(DurationType.Permanent,nEff12,oFan12);
     ...
     AssignCommand(oFan12,ActionEquipItem(lightsaber,InventorySlot.RightHand));
     ...
     ApplyEffectToObject(DurationType.Permanent,nEff13,oFan13);
     ...
     ApplyEffectToObject(DurationType.Permanent,nEff14,oFan14);
    ...
    AssignCommand(oFan14,ActionEquipItem(lightsaber2,InventorySlot.RightHand));
