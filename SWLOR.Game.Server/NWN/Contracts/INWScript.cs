...
namespace SWLOR.Game.Server.NWN.Contracts
{
    public interface INWScript
    {
        ...
        void ClearAllActions(int nClearCombatState = NWScript.NWScript.FALSE);
        ...
        void ActionMoveToLocation(Location lDestination, int bRun = NWScript.NWScript.FALSE);
        void ActionMoveToObject(Object oMoveTo, int bRun = NWScript.NWScript.FALSE, float fRange = 1.0f);
        void ActionMoveAwayFromObject(Object oFleeFrom, int bRun = NWScript.NWScript.FALSE, float fMoveAwayRange = 40.0f);
        ...
        void ActionAttack(Object oAttackee, int bPassive = NWScript.NWScript.FALSE);
        ...
        void ActionSpeakString(string sStringToSpeak, int nTalkVolume = NWScript.NWScript.TALKVOLUME_TALK);
        ...
        void SetCameraFacing(float fDirection, float fDistance = -1.0f, float fPitch = -1.0f, int nTransitionType = NWScript.NWScript.CAMERA_TRANSITION_TYPE_SNAP);
        void PlaySound(string sSoundName);
        Object GetSpellTargetObject();
        void ActionCastSpellAtObject(int nSpell, Object oTarget, int nMetaMagic = NWScript.NWScript.METAMAGIC_ANY, int bCheat = NWScript.NWScript.FALSE, int nDomainLevel = 0, int nProjectilePathType = NWScript.NWScript.PROJECTILE_PATH_TYPE_DEFAULT, int bInstantSpell = NWScript.NWScript.FALSE);
        ...
        Effect EffectDamage(int nDamageAmount, int nDamageType = NWScript.NWScript.DAMAGE_TYPE_MAGICAL, int nDamagePower = NWScript.NWScript.DAMAGE_POWER_NORMAL);
        ...
        Effect EffectSummonCreature(string sCreatureResref, int nVisualEffectId = NWScript.NWScript.VFX_NONE, float fDelaySeconds = 0.0f, int nUseAppearAnimation = 0);
        ...
        int FortitudeSave(Object oCreature, int nDC, int nSaveType = NWScript.NWScript.SAVING_THROW_TYPE_NONE, Object oSaveVersus = null);
        int ReflexSave(Object oCreature, int nDC, int nSaveType = NWScript.NWScript.SAVING_THROW_TYPE_NONE, Object oSaveVersus = null);
        int WillSave(Object oCreature, int nDC, int nSaveType = NWScript.NWScript.SAVING_THROW_TYPE_NONE, Object oSaveVersus = null);
        int GetSpellSaveDC();
        Effect MagicalEffect(Effect eEffect);
        Effect SupernaturalEffect(Effect eEffect);
        Effect ExtraordinaryEffect(Effect eEffect);
        Effect EffectACIncrease(int nValue, int nModifyType = NWScript.NWScript.AC_DODGE_BONUS, int nDamageType = NWScript.NWScript.AC_VS_DAMAGE_TYPE_ALL);
        int GetAC(Object oObject, int nForFutureUse = 0);
        Effect EffectSavingThrowIncrease(int nSave, int nValue, int nSaveType = NWScript.NWScript.SAVING_THROW_TYPE_ALL);
        Effect EffectAttackIncrease(int nBonus, int nModifierType = NWScript.NWScript.ATTACK_BONUS_MISC);
        Effect EffectDamageReduction(int nAmount, int nDamagePower, int nLimit = 0);
        Effect EffectDamageIncrease(int nBonus, int nDamageType = NWScript.NWScript.DAMAGE_TYPE_MAGICAL);
        ...
        Object GetFirstObjectInShape(int nShape, float fSize, Location lTarget, int bLineOfSight = NWScript.NWScript.FALSE, int nObjectFilter = NWScript.NWScript.OBJECT_TYPE_CREATURE, Vector? vOrigin = null);
        Object GetNextObjectInShape(int nShape, float fSize, Location lTarget, int bLineOfSight = NWScript.NWScript.FALSE, int nObjectFilter = NWScript.NWScript.OBJECT_TYPE_CREATURE, Vector? vOrigin = null);
        Effect EffectEntangle();
        void SignalEvent(Object oObject, NWScript.Event evToRun);
        NWScript.Event EventUserDefined(int nUserDefinedEventNumber);
        Effect EffectDeath(int nSpectacularDeath = NWScript.NWScript.FALSE, int nDisplayFeedback = NWScript.NWScript.TRUE);
        ...
        int GetAbilityScore(Object oCreature, int nAbilityType, int nBaseAbilityScore = NWScript.NWScript.FALSE);
        ...
        int TouchAttackMelee(Object oTarget, int bDisplayFeedback = NWScript.NWScript.TRUE);
        int TouchAttackRanged(Object oTarget, int bDisplayFeedback = NWScript.NWScript.TRUE);
        Effect EffectParalyze();
        Effect EffectSpellImmunity(int nImmunityToSpell = NWScript.NWScript.SPELL_ALL_SPELLS);
        Effect EffectDeaf();
        ...
        Effect EffectVisualEffect(int nVisualEffectId, int nMissEffect = NWScript.NWScript.FALSE);
        Object GetFactionWeakestMember(Object oFactionMember = null, int bMustBeVisible = NWScript.NWScript.TRUE);
        Object GetFactionStrongestMember(Object oFactionMember = null, int bMustBeVisible = NWScript.NWScript.TRUE);
        Object GetFactionMostDamagedMember(Object oFactionMember = null, int bMustBeVisible = NWScript.NWScript.TRUE);
        Object GetFactionLeastDamagedMember(Object oFactionMember = null, int bMustBeVisible = NWScript.NWScript.TRUE);
        ...
        Object GetFactionWorstAC(Object oFactionMember = null, int bMustBeVisible = NWScript.NWScript.TRUE);
        Object GetFactionBestAC(Object oFactionMember = null, int bMustBeVisible = NWScript.NWScript.TRUE);
        void ActionSit(Object oChair);
        int GetListenPatternNumber();
        void ActionJumpToObject(Object oToJumpTo, int bWalkStraightLineToPoint = NWScript.NWScript.TRUE);
        ...
        void AdjustAlignment(Object oSubject, int nAlignment, int nShift, int bAllPartyMembers = NWScript.NWScript.TRUE);
        void ActionWait(float fSeconds);
        void SetAreaTransitionBMP(int nPredefinedAreaTransition, string sCustomAreaTransitionBMP = "");
        void ActionStartConversation(Object oObjectToConverseWith, string sDialogResRef = "", int bPrivateConversation = NWScript.NWScript.FALSE, int bPlayHello = NWScript.NWScript.TRUE);
        void ActionPauseConversation();
        void ActionResumeConversation();
        Effect EffectBeam(int nBeamVisualEffect, Object oEffector, int nBodyPart, int bMissEffect = NWScript.NWScript.FALSE);
        ...
        void SpeakString(string sStringToSpeak, int nTalkVolume = NWScript.NWScript.TALKVOLUME_TALK);
        ...
        Object GetNearestObject(int nObjectType = NWScript.NWScript.OBJECT_TYPE_ALL, Object oTarget = null, int nNth = 1);
        ...
        void ActionCastSpellAtLocation(int nSpell, Location lTargetLocation, int nMetaMagic = NWScript.NWScript.METAMAGIC_ANY, int bCheat = NWScript.NWScript.FALSE, int nProjectilePathType = NWScript.NWScript.PROJECTILE_PATH_TYPE_DEFAULT, int bInstantSpell = NWScript.NWScript.FALSE);
        ...
        Object GetPCSpeaker();
        string GetStringByStrRef(int nStrRef, int nGender = NWScript.NWScript.GENDER_MALE);
        void ActionSpeakStringByStrRef(int nStrRef, int nTalkVolume = NWScript.NWScript.TALKVOLUME_TALK);
        void DestroyObject(Object oDestroy, float fDelay = 0.0f);
        Object GetModule();
        Object CreateObject(int nObjectType, string sTemplate, Location lLocation, int bUseAppearAnimation = NWScript.NWScript.FALSE, string sNewTag = "");
        NWScript.Event EventSpellCastAt(Object oCaster, int nSpell, int bHarmful = NWScript.NWScript.TRUE);
        Object GetLastSpellCaster();
        int GetLastSpell();
        int GetUserDefinedEventNumber();
        int GetSpellId();
        string RandomName(int nNameType = NWScript.NWScript.NAME_FIRST_GENERIC_MALE);
        Effect EffectPoison(int nPoisonType);
        Effect EffectDisease(int nDiseaseType);
        Effect EffectSilence();
        string GetName(Object oObject, int bOriginalName = NWScript.NWScript.FALSE);
        ...
        Object GetFirstInPersistentObject(Object oPersistentObject = null, int nResidentObjectType = NWScript.NWScript.OBJECT_TYPE_CREATURE, int nPersistentZone = NWScript.NWScript.PERSISTENT_ZONE_ACTIVE);
        Object GetNextInPersistentObject(Object oPersistentObject = null, int nResidentObjectType = NWScript.NWScript.OBJECT_TYPE_CREATURE, int nPersistentZone = NWScript.NWScript.PERSISTENT_ZONE_ACTIVE);
        ...
        NWScript.Event EventConversation();
        ...
        int GetReflexAdjustedDamage(int nDamage, Object oTarget, int nDC, int nSaveType = NWScript.NWScript.SAVING_THROW_TYPE_NONE, Object oSaveVersus = null);
        ...
        int GetSkillRank(int nSkill, Object oTarget = null, int nBaseSkillRank = NWScript.NWScript.FALSE);
        ...
        void SetIsDestroyable(int bDestroyable, int bRaiseable = NWScript.NWScript.TRUE, int bSelectableWhenDead = NWScript.NWScript.FALSE);
        ...
        Effect VersusAlignmentEffect(Effect eEffect, int nLawChaos = NWScript.NWScript.ALIGNMENT_ALL, int nGoodEvil = NWScript.NWScript.ALIGNMENT_ALL);
        ...
        void ActionMoveAwayFromLocation(Location lMoveAwayFrom, int bRun = NWScript.NWScript.FALSE, float fMoveAwayRange = 40.0f);
        ...
        void AddJournalQuestEntry(string szPlotID, int nState, Object oCreature, int bAllPartyMembers = NWScript.NWScript.TRUE, int bAllPlayers = NWScript.NWScript.FALSE, int bAllowOverrideHigher = NWScript.NWScript.FALSE);
        void RemoveJournalQuestEntry(string szPlotID, Object oCreature, int bAllPartyMembers = NWScript.NWScript.TRUE, int bAllPlayers = NWScript.NWScript.FALSE);
        string GetPCPublicCDKey(Object oPlayer, int nSinglePlayerCDKey = NWScript.NWScript.FALSE);
        ...
        Effect EffectTurned();
        Object GetFirstFactionMember(Object oMemberOfFaction, int bPCOnly = NWScript.NWScript.TRUE);
        Object GetNextFactionMember(Object oMemberOfFaction, int bPCOnly = NWScript.NWScript.TRUE);
        void ActionForceMoveToLocation(Location lDestination, int bRun = NWScript.NWScript.FALSE, float fTimeout = 30.0f);
        void ActionForceMoveToObject(Object oMoveTo, int bRun = NWScript.NWScript.FALSE, float fRange = 1.0f, float fTimeout = 30.0f);
        ...
        void SetIsTemporaryFriend(Object oTarget, Object oSource = null, int bDecays = NWScript.NWScript.FALSE, float fDurationInSeconds = 180.0f);
        void SetIsTemporaryEnemy(Object oTarget, Object oSource = null, int bDecays = NWScript.NWScript.FALSE, float fDurationInSeconds = 180.0f);
        void SetIsTemporaryNeutral(Object oTarget, Object oSource = null, int bDecays = NWScript.NWScript.FALSE, float fDurationInSeconds = 180.0f);
        ...
        void ActionEquipMostDamagingMelee(Object oVersus = null, int bOffHand = NWScript.NWScript.FALSE);
        void ActionEquipMostDamagingRanged(Object oVersus = null);
        int GetItemACValue(Object oItem);
        void ActionRest(int bCreatureToEnemyLineOfSightCheck = NWScript.NWScript.FALSE);
        void ExploreAreaForPlayer(Object oArea, Object oPlayer, int bExplored = NWScript.NWScript.TRUE);
        ...
        int GetIsWeaponEffective(Object oVersus = null, int bOffHand = NWScript.NWScript.FALSE);
        int GetLastSpellHarmful();
        NWScript.Event EventActivateItem(Object oItem, Location lTarget, Object oTarget = null);
        ...
        void TakeGoldFromCreature(int nAmount, Object oCreatureToTakeFrom, int bDestroy = NWScript.NWScript.FALSE);
        int IsInConversation(Object oObject);
        Effect EffectAbilityDecrease(int nAbility, int nModifyBy);
        Effect EffectAttackDecrease(int nPenalty, int nModifierType = NWScript.NWScript.ATTACK_BONUS_MISC);
        Effect EffectDamageDecrease(int nPenalty, int nDamageType = NWScript.NWScript.DAMAGE_TYPE_MAGICAL);
        Effect EffectDamageImmunityDecrease(int nDamageType, int nPercentImmunity);
        Effect EffectACDecrease(int nValue, int nModifyType = NWScript.NWScript.AC_DODGE_BONUS, int nDamageType = NWScript.NWScript.AC_VS_DAMAGE_TYPE_ALL);
        Effect EffectMovementSpeedDecrease(int nPercentChange);
        Effect EffectSavingThrowDecrease(int nSave, int nValue, int nSaveType = NWScript.NWScript.SAVING_THROW_TYPE_ALL);
        ...
        Effect EffectConcealment(int nPercentage, int nMissType = NWScript.NWScript.MISS_CHANCE_TYPE_NORMAL);
        Effect EffectDarkness();
        Effect EffectDispelMagicAll(int nCasterLevel = NWScript.NWScript.USE_CREATURE_LEVEL);
        Effect EffectUltravision();
        Effect EffectNegativeLevel(int nNumLevels, int bHPBonus = NWScript.NWScript.FALSE);
        Effect EffectPolymorph(int nPolymorphSelection, int nLocked = NWScript.NWScript.FALSE);
        ...
        Effect EffectSpellLevelAbsorption(int nMaxSpellLevelAbsorbed, int nTotalSpellLevelsAbsorbed = 0, int nSpellSchool = NWScript.NWScript.SPELL_SCHOOL_GENERAL);
        Effect EffectDispelMagicBest(int nCasterLevel = NWScript.NWScript.USE_CREATURE_LEVEL);
        void ActivatePortal(Object oTarget, string sIPaddress = "", string sPassword = "", string sWaypointTag = "", int bSeemless = NWScript.NWScript.FALSE);
        int GetNumStackedItems(Object oItem);
        void SurrenderToEnemies();
        Effect EffectMissChance(int nPercentage, int nMissChanceType = NWScript.NWScript.MISS_CHANCE_TYPE_NORMAL);
        ...
        Object GetNearestTrapToObject(Object oTarget = null, int nTrapDetected = NWScript.NWScript.TRUE);
        ...
        void ActionCastFakeSpellAtObject(int nSpell, Object oTarget, int nProjectilePathType = NWScript.NWScript.PROJECTILE_PATH_TYPE_DEFAULT);
        void ActionCastFakeSpellAtLocation(int nSpell, Location lTarget, int nProjectilePathType = NWScript.NWScript.PROJECTILE_PATH_TYPE_DEFAULT);
        ...
        void FloatingTextStrRefOnCreature(int nStrRefToDisplay, Object oCreatureToFloatAbove, int bBroadcastToFaction = NWScript.NWScript.TRUE);
        void FloatingTextStringOnCreature(string sStringToDisplay, Object oCreatureToFloatAbove, int bBroadcastToFaction = NWScript.NWScript.TRUE);
        ...
        void SetPlaceableIllumination(Object oPlaceable = null, int bIlluminate = NWScript.NWScript.TRUE);
        ...
        Object GetFirstPC();
        Object GetNextPC();
        int SetTrapDetectedBy(Object oTrap, Object oDetector, int bDetected = NWScript.NWScript.TRUE);
        ...
        void PopUpDeathGUIPanel(Object oPC, int bRespawnButtonEnabled = NWScript.NWScript.TRUE, int bWaitForHelpButtonEnabled = NWScript.NWScript.TRUE, int nHelpStringReference = 0, string sHelpString = "");
        ...
        Object CopyItem(Object oItem, Object oTargetInventory = null, int bCopyVars = NWScript.NWScript.FALSE);
        ...
        ItemProperty ItemPropertyUnlimitedAmmo(int nAmmoDamage = NWScript.NWScript.IP_CONST_UNLIMITEDAMMO_BASIC);
        ...
        Effect EffectSpellFailure(int nPercent = 100, int nSpellSchool = NWScript.NWScript.SPELL_SCHOOL_GENERAL);
        void SpeakStringByStrRef(int nStrRef, int nTalkVolume = NWScript.NWScript.TALKVOLUME_TALK);
        void SetCutsceneMode(Object oCreature, int nInCutscene = NWScript.NWScript.TRUE, int nLeftClickingEnabled = NWScript.NWScript.FALSE);
        Object GetLastPCToCancelCutscene();
        float GetDialogSoundLength(int nStrRef);
        void FadeFromBlack(Object oCreature, float fSpeed = NWScript.NWScript.FADE_SPEED_MEDIUM);
        void FadeToBlack(Object oCreature, float fSpeed = NWScript.NWScript.FADE_SPEED_MEDIUM);
        ...
        int LevelUpHenchman(Object oCreature, int nClass = NWScript.NWScript.CLASS_TYPE_INVALID, int bReadyAllSpells = NWScript.NWScript.FALSE, int nPackage = NWScript.NWScript.PACKAGE_INVALID);
        ...
        void DoWhirlwindAttack(int bDisplayFeedback = NWScript.NWScript.TRUE, int bImproved = NWScript.NWScript.FALSE);
        ...
        void PlaySoundByStrRef(int nStrRef, int nRunAsAction = NWScript.NWScript.TRUE);
        ...
        Object CopyItemAndModify(Object oItem, int nType, int nIndex, int nNewValue, int bCopyVars = NWScript.NWScript.FALSE);
        ...
        void SetLockKeyRequired(Object oObject, int nKeyRequired = NWScript.NWScript.TRUE);
        void SetLockKeyTag(Object oObject, string sNewKeyTag);
        void SetLockLockable(Object oObject, int nLockable = NWScript.NWScript.TRUE);
        void SetLockUnlockDC(Object oObject, int nNewUnlockDC);
        void SetLockLockDC(Object oObject, int nNewLockDC);
        void SetTrapDisarmable(Object oTrapObject, int nDisarmable = NWScript.NWScript.TRUE);
        void SetTrapDetectable(Object oTrapObject, int nDetectable = NWScript.NWScript.TRUE);
        void SetTrapOneShot(Object oTrapObject, int nOneShot = NWScript.NWScript.TRUE);
        ...
        Object CreateTrapAtLocation(int nTrapType, Location lLocation, float fSize = 2.0f, string sTag = "", int nFaction = NWScript.NWScript.STANDARD_FACTION_HOSTILE, string sOnDisarmScript = "", string sOnTrapTriggeredScript = "");
        void CreateTrapOnObject(int nTrapType, Object oObject, int nFaction = NWScript.NWScript.STANDARD_FACTION_HOSTILE, string sOnDisarmScript = "", string sOnTrapTriggeredScript = "");
        ...
        void SetTrapRecoverable(Object oTrapObject, int nRecoverable = NWScript.NWScript.TRUE);
        ...
        void SetTrapActive(Object oTrapObject, int nActive = NWScript.NWScript.TRUE);
        void LockCameraPitch(Object oPlayer, int bLocked = NWScript.NWScript.TRUE);
        void LockCameraDistance(Object oPlayer, int bLocked = NWScript.NWScript.TRUE);
        void LockCameraDirection(Object oPlayer, int bLocked = NWScript.NWScript.TRUE);
        Object GetPlaceableLastClickedBy();
        int GetInfiniteFlag(Object oItem);
        void SetInfiniteFlag(Object oItem, int bInfinite = NWScript.NWScript.TRUE);
        ...
        string GetDescription(Object oObject, int bOriginalDescription = NWScript.NWScript.FALSE, int bIdentifiedDescription = NWScript.NWScript.TRUE);
        void SetDescription(Object oObject, string sNewDescription = "", int bIdentifiedDescription = NWScript.NWScript.TRUE);
        Object GetPCChatSpeaker();
        string GetPCChatMessage();
        int GetPCChatVolume();
        void SetPCChatMessage(string sNewChatMessage = "");
        void SetPCChatVolume(int nTalkVolume = NWScript.NWScript.TALKVOLUME_TALK);
