...
namespace SWLOR.Game.Server.Perk.ForceAlter
{
    public class ForceBreach: IPerkHandler
    {
        ...
        {
            int damage;
            var intMod = creature.IntelligenceModifier;
            ...
            NWScript.ApplyEffectToObject(DurationType.Instant, NWScript.EffectVisualEffect(VisualEffect.Vfx_Imp_Silence), target);
        }
