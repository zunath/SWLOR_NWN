...
{
    public class ImprovedCriticalBlasterRifles : ImprovedCriticalBase
    {
        public override PerkType PerkType => PerkType.ImprovedCriticalBlasterRifles;
        public override string Name => "Improved Critical - Rifles";
        public override bool IsActive => true;
        public override string Description => "Improves the critical hit chance when using blaster rifles.";
