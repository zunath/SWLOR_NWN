...
namespace SWLOR.Game.Server.Perk.Weapons
{
    public class WeaponFocusBatons: WeaponFocusBase
    {
		...
		{
			{
				1, new PerkLevel(3, "You gain the Weapon Focus feat which grants a +1 attack bonus when equipped with a baton weapon.",
			...
			{
				2, new PerkLevel(4, "You gain the Weapon Specialization feat which grants a +2 damage when equipped with a baton weapon.",
				new Dictionary<SkillType, int>
				{
