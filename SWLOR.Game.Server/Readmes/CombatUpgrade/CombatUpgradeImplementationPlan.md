...
### Force, Devices, Leadership, First Aid, Espionage
...
2. Force, Devices, Leadership, First Aid, and Espionage.
...
- Smoke-test Force, Devices, Leadership, First Aid, Espionage, and Beast Mastery.

## Current Known Local Follow-Up

The current feature branch worktree contains partial Heavy Armor activation-time penalty carryover:
