...
- Three net-new shared engine systems back the redesign: physical-to-Force damage conversion (Saber Ward), Soresu Pressure stacking (Surrounded Not Outmatched / Master of Soresu), and bounded Deflecting-Return weapon reflection triggered off an Attack Deflect of a directly targeted ranged attack.
