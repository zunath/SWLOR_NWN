...
- Implemented the missing Heavy Vibroblade active ability slice: feat grants, recast groups, ability definitions, queued strikes, self/party buffs, and runtime hooks for Life Siphon, Soul Ascension, Soul Devourer Stance recoil, Blazing Spikes reflection, Flash, Rampart, Absolute Defense, Bastion Stance, Soul Storm, Soul Sacrifice, and Essence Drain.
