...
- Detection is calculated as `PER + WIL + equipment + perk/status bonuses`; Detect mode adds +5. NPC Detection keeps scaling with those stats but is capped at 50. Players are not capped, so ratings above 50 require player investment.
