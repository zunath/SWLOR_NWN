...
- Poisoncraft tiers unlock at 0/15/28/40/48; Trapcraft tiers at 0/18/30/45, with Master Saboteur providing tier 5 at 50; Slicing tiers at 0/22/30/42/48. `EspionageProgression` owns these gates and training limits. Core recipes do not require dropped schematics or unrelated perks.
...
3. Right-click a new and an older saved Snare Kit, choose Activate Item, and remain still. One kit should deploy at your feet and be consumed after successful placement. Moving or failing the spacing check must preserve the stack. Trigger it with a hostile NPC after arming.
