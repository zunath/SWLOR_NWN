...
| Duration bonuses exceeded the hard-control budget | Bonuses could extend an authored 30-second control beyond 30 seconds. | The final duration is capped at 30 seconds after outgoing bonuses and resistance. Soft debuffs retain their duration bonuses. Resistance feedback compares the final constrained durations, including any earlier expiration inherited by control conversion. |
