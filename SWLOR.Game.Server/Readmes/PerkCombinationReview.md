...
**Latest completed full suite: 2,727 passed, zero failed, zero skipped**, before the final triggered-damage review fixes. Those additional fixes passed **208 focused tests**, including typed mitigation, conversion, self-applied subdual duration, ricochet conditions, target selection and independent per-cast rider limits. Builds succeeded with existing nullable-reference/annotation warnings and no errors, and skipped the Windows post-build deploy as required. Ricochet Toss's generator output was checked against its complete authored payload. Final PR validation records the full suite after these changes.
