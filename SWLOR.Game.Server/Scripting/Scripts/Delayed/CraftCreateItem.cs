...
namespace SWLOR.Game.Server.Scripting.Scripts.Delayed
{
    public class CraftCreateItem: IScript
    {
        ...
        private void RunCreateItem(NWPlayer player)
        {
            ...
            BaseStructure baseStructure = blueprint.BaseStructureID == null ? null : DataService.BaseStructure.GetByID(blueprint.BaseStructureID);
