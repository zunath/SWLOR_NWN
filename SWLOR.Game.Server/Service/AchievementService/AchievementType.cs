...
namespace SWLOR.Game.Server.Service.AchievementService
{
    public enum AchievementType
    {
        ...
        [Achievement("Explore Dantooine Field", "Explore Dantooine's Fields.", true)]
        ExploreDantooineField = 112,
        ...
        [Achievement("Explore Dantooine Kinrath Cave", "Explore Dantooine's Kinrath Tunnels.", true)]
        ExploreDantooineKinrathTunnel = 115,

        [Achievement("Explore Dantooine Wild Plains", "Explore Dantooine's Wild Plains.", true)]
        ExploreDantooineWildPlains = 116,

        [Achievement("Explore Dantooine South Plains", "Explore Dantooine's Tribe.", true)]
        ExploreDantooineTribe = 117,

        [Achievement("Explore Dantooine Abandon Warehouse", "Explore Dantooine's Abandon Base.", true)]
        ExploreDantooineAbandonWare = 118,
