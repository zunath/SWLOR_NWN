...
namespace SWLOR.Game.Server.Service.ConversationService
{
    ...
    public sealed class ConversationRuntime : IConversationRuntime
    {
        ...
        private readonly Dictionary<string, Action<ConversationContext, IReadOnlyList<string>, string>> _actions = new();
        ...
        public void RegisterAction(
            string key,
            Action<ConversationContext, IReadOnlyList<string>, string> handler)
        {
            ValidateRegistration(key, handler);
        ...
        public void ExecuteAction(ConversationContext context, ConversationAction action)
        {
            ...
            handler(context, action.Arguments, action.OncePerPlayerId);
        }
