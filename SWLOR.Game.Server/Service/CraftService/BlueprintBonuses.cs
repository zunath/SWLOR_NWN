    ...
    internal class BlueprintBonuses
    {
        ...
        private List<BlueprintBonus> Tier1ArmorCombatBonuses()
        {
            var list = new List<BlueprintBonus>
            {
                ...
                new(14, EnhancementSubType.ResistanceElectrical, 2),
                new(7, EnhancementSubType.ResistanceElectrical, 3),
                new(14, EnhancementSubType.ResistanceFire, 2),
                new(7, EnhancementSubType.ResistanceFire, 3),
                new(14, EnhancementSubType.ResistanceIce, 2),
                new(7, EnhancementSubType.ResistanceIce, 3),
                new(14, EnhancementSubType.ResistancePoison, 2),
                new(7, EnhancementSubType.ResistancePoison, 3),
                new(10, EnhancementSubType.ResistanceMind, 1),
                new(5, EnhancementSubType.ResistanceMind, 2),
                new(10, EnhancementSubType.ResistanceMobility, 1),
                new(5, EnhancementSubType.ResistanceMobility, 2),
                new(10, EnhancementSubType.ResistanceTrauma, 1),
                new(5, EnhancementSubType.ResistanceTrauma, 2),
                new(10, EnhancementSubType.ResistanceDisruption, 1),
                new(5, EnhancementSubType.ResistanceDisruption, 2),
        ...
        private List<BlueprintBonus> Tier2ArmorCombatBonuses()
        {
            var list = new List<BlueprintBonus>
            {
                ...
                new(16, EnhancementSubType.ResistanceElectrical, 3),
                new(10, EnhancementSubType.ResistanceElectrical, 4),
                new(4, EnhancementSubType.ResistanceElectrical, 5),
                new(16, EnhancementSubType.ResistanceFire, 3),
                new(10, EnhancementSubType.ResistanceFire, 4),
                new(4, EnhancementSubType.ResistanceFire, 5),
                new(16, EnhancementSubType.ResistanceIce, 3),
                new(10, EnhancementSubType.ResistanceIce, 4),
                new(4, EnhancementSubType.ResistanceIce, 5),
                new(16, EnhancementSubType.ResistancePoison, 3),
                new(10, EnhancementSubType.ResistancePoison, 4),
                new(4, EnhancementSubType.ResistancePoison, 5),
                new(12, EnhancementSubType.ResistanceMind, 2),
                new(7, EnhancementSubType.ResistanceMind, 3),
                new(2, EnhancementSubType.ResistanceMind, 4),
                new(12, EnhancementSubType.ResistanceMobility, 2),
                new(7, EnhancementSubType.ResistanceMobility, 3),
                new(2, EnhancementSubType.ResistanceMobility, 4),
                new(12, EnhancementSubType.ResistanceTrauma, 2),
                new(7, EnhancementSubType.ResistanceTrauma, 3),
                new(2, EnhancementSubType.ResistanceTrauma, 4),
                new(12, EnhancementSubType.ResistanceDisruption, 2),
                new(7, EnhancementSubType.ResistanceDisruption, 3),
                new(2, EnhancementSubType.ResistanceDisruption, 4),
        ...
        private List<BlueprintBonus> Tier3ArmorCombatBonuses()
        {
            var list = new List<BlueprintBonus>
            {
                ...
                new(16, EnhancementSubType.ResistanceElectrical, 4),
                new(10, EnhancementSubType.ResistanceElectrical, 5),
                new(4, EnhancementSubType.ResistanceElectrical, 6),
                new(16, EnhancementSubType.ResistanceFire, 4),
                new(10, EnhancementSubType.ResistanceFire, 5),
                new(4, EnhancementSubType.ResistanceFire, 6),
                new(16, EnhancementSubType.ResistanceIce, 4),
                new(10, EnhancementSubType.ResistanceIce, 5),
                new(4, EnhancementSubType.ResistanceIce, 6),
                new(16, EnhancementSubType.ResistancePoison, 4),
                new(10, EnhancementSubType.ResistancePoison, 5),
                new(4, EnhancementSubType.ResistancePoison, 6),
                new(12, EnhancementSubType.ResistanceMind, 3),
                new(7, EnhancementSubType.ResistanceMind, 4),
                new(2, EnhancementSubType.ResistanceMind, 5),
                new(12, EnhancementSubType.ResistanceMobility, 3),
                new(7, EnhancementSubType.ResistanceMobility, 4),
                new(2, EnhancementSubType.ResistanceMobility, 5),
                new(12, EnhancementSubType.ResistanceTrauma, 3),
                new(7, EnhancementSubType.ResistanceTrauma, 4),
                new(2, EnhancementSubType.ResistanceTrauma, 5),
                new(12, EnhancementSubType.ResistanceDisruption, 3),
                new(7, EnhancementSubType.ResistanceDisruption, 4),
                new(2, EnhancementSubType.ResistanceDisruption, 5),
        ...
        private List<BlueprintBonus> Tier1FoodBonuses()
        {
            var list = new List<BlueprintBonus>
            {
                ...
                // Resistance
                new(4, EnhancementSubType.FoodBonusElectricalResistance, 2),
                new(2, EnhancementSubType.FoodBonusElectricalResistance, 3),
                new(4, EnhancementSubType.FoodBonusFireResistance, 2),
                new(2, EnhancementSubType.FoodBonusFireResistance, 3),
                new(4, EnhancementSubType.FoodBonusIceResistance, 2),
                new(2, EnhancementSubType.FoodBonusIceResistance, 3),
                new(4, EnhancementSubType.FoodBonusPoisonResistance, 2),
                new(2, EnhancementSubType.FoodBonusPoisonResistance, 3),
                new(3, EnhancementSubType.FoodBonusMindResistance, 1),
                new(1, EnhancementSubType.FoodBonusMindResistance, 2),
                new(3, EnhancementSubType.FoodBonusMobilityResistance, 1),
                new(1, EnhancementSubType.FoodBonusMobilityResistance, 2),
                new(3, EnhancementSubType.FoodBonusTraumaResistance, 1),
                new(1, EnhancementSubType.FoodBonusTraumaResistance, 2),
                new(3, EnhancementSubType.FoodBonusDisruptionResistance, 1),
                new(1, EnhancementSubType.FoodBonusDisruptionResistance, 2),
            };
        ...
        private List<BlueprintBonus> Tier2FoodBonuses()
        {
            var list = new List<BlueprintBonus>
            {
                ...
                // Resistance
                new(5, EnhancementSubType.FoodBonusElectricalResistance, 3),
                new(3, EnhancementSubType.FoodBonusElectricalResistance, 4),
                new(1, EnhancementSubType.FoodBonusElectricalResistance, 5),
                new(5, EnhancementSubType.FoodBonusFireResistance, 3),
                new(3, EnhancementSubType.FoodBonusFireResistance, 4),
                new(1, EnhancementSubType.FoodBonusFireResistance, 5),
                new(5, EnhancementSubType.FoodBonusIceResistance, 3),
                new(3, EnhancementSubType.FoodBonusIceResistance, 4),
                new(1, EnhancementSubType.FoodBonusIceResistance, 5),
                new(5, EnhancementSubType.FoodBonusPoisonResistance, 3),
                new(3, EnhancementSubType.FoodBonusPoisonResistance, 4),
                new(1, EnhancementSubType.FoodBonusPoisonResistance, 5),
                new(4, EnhancementSubType.FoodBonusMindResistance, 2),
                new(2, EnhancementSubType.FoodBonusMindResistance, 3),
                new(1, EnhancementSubType.FoodBonusMindResistance, 4),
                new(4, EnhancementSubType.FoodBonusMobilityResistance, 2),
                new(2, EnhancementSubType.FoodBonusMobilityResistance, 3),
                new(1, EnhancementSubType.FoodBonusMobilityResistance, 4),
                new(4, EnhancementSubType.FoodBonusTraumaResistance, 2),
                new(2, EnhancementSubType.FoodBonusTraumaResistance, 3),
                new(1, EnhancementSubType.FoodBonusTraumaResistance, 4),
                new(4, EnhancementSubType.FoodBonusDisruptionResistance, 2),
                new(2, EnhancementSubType.FoodBonusDisruptionResistance, 3),
        ...
        private List<BlueprintBonus> Tier3FoodBonuses()
        {
            var list = new List<BlueprintBonus>
            {
                ...
                // Resistance
                new(5, EnhancementSubType.FoodBonusElectricalResistance, 4),
                new(3, EnhancementSubType.FoodBonusElectricalResistance, 5),
                new(1, EnhancementSubType.FoodBonusElectricalResistance, 6),
                new(5, EnhancementSubType.FoodBonusFireResistance, 4),
                new(3, EnhancementSubType.FoodBonusFireResistance, 5),
                new(1, EnhancementSubType.FoodBonusFireResistance, 6),
                new(5, EnhancementSubType.FoodBonusIceResistance, 4),
                new(3, EnhancementSubType.FoodBonusIceResistance, 5),
                new(1, EnhancementSubType.FoodBonusIceResistance, 6),
                new(5, EnhancementSubType.FoodBonusPoisonResistance, 4),
                new(3, EnhancementSubType.FoodBonusPoisonResistance, 5),
                new(1, EnhancementSubType.FoodBonusPoisonResistance, 6),
                new(4, EnhancementSubType.FoodBonusMindResistance, 3),
                new(2, EnhancementSubType.FoodBonusMindResistance, 4),
                new(1, EnhancementSubType.FoodBonusMindResistance, 5),
                new(4, EnhancementSubType.FoodBonusMobilityResistance, 3),
                new(2, EnhancementSubType.FoodBonusMobilityResistance, 4),
                new(1, EnhancementSubType.FoodBonusMobilityResistance, 5),
                new(4, EnhancementSubType.FoodBonusTraumaResistance, 3),
                new(2, EnhancementSubType.FoodBonusTraumaResistance, 4),
                new(1, EnhancementSubType.FoodBonusTraumaResistance, 5),
                new(4, EnhancementSubType.FoodBonusDisruptionResistance, 3),
                new(2, EnhancementSubType.FoodBonusDisruptionResistance, 4),
                new(1, EnhancementSubType.FoodBonusDisruptionResistance, 5),
            };
