namespace SWLOR.Game.Server.Service.CraftService
{
    public enum RecipeType
    {
        ...
        ControlUnitAlpha = 4022,
        ControlUnitBeta = 4023,
        ControlUnitGamma = 4024,
        ControlUnitDelta = 4025,
        ControlUnitEpsilon = 4026,
        LogicUnitAlpha = 4027,
        LogicUnitBeta = 4028,
        LogicUnitGamma = 4029,
        LogicUnitDelta = 4030,
        LogicUnitEpsilon = 4031,
        CachingUnitAlpha = 4032,
        CachingUnitBeta = 4033,
        CachingUnitGamma = 4034,
        CachingUnitDelta = 4035,
        CachingUnitEpsilon = 4036,
        DroidBrainAlpha = 4037,
        DroidBrainBeta = 4038,
        DroidBrainGamma = 4039,
        DroidBrainDelta = 4040,
        DroidBrainEpsilon = 4041,
        DroidSensorAlpha = 4042,
        DroidSensorBeta = 4043,
        DroidSensorGamma = 4044,
        DroidSensorDelta = 4045,
        DroidSensorEpsilon = 4046,
        ManipulatorArmAlpha = 4047,
        ManipulatorArmBeta = 4048,
        ManipulatorArmGamma = 4049,
        ManipulatorArmDelta = 4050,
        ManipulatorArmEpsilon = 4051,
        DischargeUnitAlpha = 4052,
        DischargeUnitBeta = 4053,
        DischargeUnitGamma = 4054,
        DischargeUnitDelta = 4055,
        DischargeUnitEpsilon = 4056,
        DroidMotiveSystemAlpha = 4057,
        DroidMotiveSystemBeta = 4058,
        DroidMotiveSystemGamma = 4059,
        DroidMotiveSystemDelta = 4060,
        DroidMotiveSystemEpsilon = 4061,
        DiagnosticCircuitAlpha = 4062,
        DiagnosticCircuitBeta = 4063,
        DiagnosticCircuitGamma = 4064,
        DiagnosticCircuitDelta = 4065,
        DiagnosticCircuitEpsilon = 4066,
        DroidPowerSupplyAlpha = 4067,
        DroidPowerSupplyBeta = 4068,
        DroidPowerSupplyGamma = 4069,
        DroidPowerSupplyDelta = 4070,
        DroidPowerSupplyEpsilon = 4071,
        DroidChassisAlpha = 4072,
        DroidChassisBeta = 4073,
        DroidChassisGamma = 4074,
        DroidChassisDelta = 4075,
        DroidChassisEpsilon = 4076,
    }
}
