...
namespace SWLOR.Game.Server.Service
{
    ...
    public static class CutsceneService
    {
        ...
        {
            if (oDestination == null) oDestination = new uint();
        ...
        {
            string sName = GetLocalString(GetModule(), "cutscene");
            DelayCommand(fDelay, () => DoSetSpeed(sName, new uint(), sActor, fTime, fDistance, run));
        ...
        {
            string sName = GetLocalString(GetModule(), "cutscene");
            DelayCommand(fDelay, () => DoMove(sName, new uint(), sActor, oDestination, run, fRange, fTime, sDestination, bTowards));
            RegisterActor(sName, new uint(), sActor);
        }
        ...
        {
            string sName = GetLocalString(GetModule(), "cutscene");
            DelayCommand(fDelay, () => DoJump(sName, new uint(), sActor, oTarget, sTarget, true));
            RegisterActor(sName, new uint(), sActor);
        }
        ...
        {
            string sName = GetLocalString(GetModule(), "cutscene");
            DelayCommand(fDelay, () => DoJump(sName, new uint(), sActor, oTarget, sTarget));
            RegisterActor(sName, new uint(), sActor);
        }
        ...
        {
            string sName = GetLocalString(GetModule(), "cutscene");
            DelayCommand(fDelay, () => DoAnimate(sName, new uint(), sActor, iAnim, fDuration, fSpeed, true));
            RegisterActor(sName, new uint(), sActor);
        }
        ...
        {
            string sName = GetLocalString(GetModule(), "cutscene");
            DelayCommand(fDelay, () => DoAnimate(sName, new uint(), sActor, iAnim, fDuration, fSpeed));
            RegisterActor(sName, new uint(), sActor);
        }
        ...
        {
            string sName = GetLocalString(GetModule(), "cutscene");
            DelayCommand(fDelay, () => DoSpeak(sName, new uint(), sActor, sLine, iAnimation, fDuration, fSpeed, true));
            RegisterActor(sName, new uint(), sActor);
        }
        ...
        {
            string sName = GetLocalString(GetModule(), "cutscene");
            DelayCommand(fDelay, () => DoSpeak(sName, new uint(), sActor, sLine, iAnimation, fDuration, fSpeed));
            RegisterActor(sName, new uint(), sActor);
        }
        ...
        {
            string sName = GetLocalString(GetModule(), "cutscene");
            DelayCommand(fDelay, () => DoConversation(sName, new uint(), sActor, oTarget, sConv, sTarget, bGreet));
            RegisterActor(sName, new uint(), sActor);
        }
        ...
        {
            string sName = GetLocalString(GetModule(), "cutscene");
            DelayCommand(fDelay, () => DoFace(sName, new uint(), sActor, oTarget, iFace, fFace, true));
            RegisterActor(sName, new uint(), sActor);
        }
        ...
        {
            string sName = GetLocalString(GetModule(), "cutscene");
            DelayCommand(fDelay, () => DoFace(sName, new uint(), sActor, oTarget, iFace, fFace, false));
            RegisterActor(sName, new uint(), sActor);
        }
        ...
        {
            string sName = GetLocalString(GetModule(), "cutscene");
            DelayCommand(fDelay, () => DoEquip(sName, new uint(), sActor, iSlot, oItem, sItem));
            RegisterActor(sName, new uint(), sActor);
        }
        ...
        {
            string sName = GetLocalString(GetModule(), "cutscene");
            DelayCommand(fDelay, () => DoUnequip(sName, new uint(), sActor, iSlot, oItem, sItem));
            RegisterActor(sName, new uint(), sActor);
        }
        ...
        {
            string sName = GetLocalString(GetModule(), "cutscene");
            DelayCommand(fDelay, () => DoAttack(sName, new uint(), sActor, oTarget, bPassive, sTarget));
            RegisterActor(sName, new uint(), sActor);
        }
        ...
        {
            string sName = GetLocalString(GetModule(), "cutscene");
            DelayCommand(fDelay, () => DoSpellCast(sName, new uint(), sActor, oTarget, iSpell, bFake, iPath, sTarget, bCheat, bInstant, iLevel, iMeta));
            RegisterActor(sName, new uint(), sActor);
        }
        ...
        {
            string sName = GetLocalString(GetModule(), "cutscene");
            DelayCommand(fDelay, () => DoEffect(sName, new uint(), "", oTarget, sTarget, eFect, iDuration, fDuration));
        }
        ...
        {
            string sName = GetLocalString(GetModule(), "cutscene");
            DelayCommand(fDelay, () => DoEffect(sName, new uint(), sActor, oTarget, sTarget, eFect, iDuration, fDuration, true));
            RegisterActor(sName, new uint(), sActor);
        }
        ...
        {
            string sName = GetLocalString(GetModule(), "cutscene");
            DelayCommand(fDelay, () => DoCreate(sName, new uint(), sActor, oTarget, sTarget, iType, sRef, sTag, iAnim, iStack, bCreateOn, true));
            RegisterActor(sName, new uint(), sActor);
        }
        ...
        {
            string sName = GetLocalString(GetModule(), "cutscene");
            DelayCommand(fDelay, () => DoCreate(sName, new uint(), "", oTarget, sTarget, iType, sRef, sTag, iAnim, iStack, bCreateOn));
        }
        ...
        private static void DoCopy(string sName, NWObject oSource, NWObject oTarget, string sTarget, string sTag, bool bCreateOn)
        {
            ...
            else { CopyObject(oSource, GetLocation(oTarget), new uint(), sTag); }
        }
        ...
        private static void DoClone(string sName, NWObject oPC, NWObject oTarget, string sTarget, string sTag, bool bInvisible)
        {
            ...
            if (sTarget != "") { oTarget = GetObjectByTag(sTarget); }
            NWObject oClone = CopyObject(oPC, GetLocation(oTarget), new uint(), sTag);
        ...
        {
            string sName = GetLocalString(GetModule(), "cutscene");
            DelayCommand(fDelay, () => DoPickUp(sName, new uint(), sActor, oItem, sItem));
            RegisterActor(sName, new uint(), sActor);
        }
        ...
        {
            string sName = GetLocalString(GetModule(), "cutscene");
            DelayCommand(fDelay, () => DoSit(sName, new uint(), sActor, oChair, sChair));
            RegisterActor(sName, new uint(), sActor);
        }
        ...
        public static void PlaySound(float fDelay, NWCreature oActor, string sSound, string sActor = "")
        {
            ...
            if (sActor != "") { RegisterActor(sName, new uint(), sActor); }
        ...
        private static void DoSoundObject(string sName, NWObject oSound, bool bOn, float fDuration, int iVolume, NWObject oPosition)
        {
            ...
            if (fDuration > 0.0) { DelayCommand(fDuration, () => DoSoundObject(sName, oSound, !bOn, 0.0f, 128, new uint())); }
        ...
        {
            string sName = GetLocalString(GetModule(), "cutscene");
            DelayCommand(fDelay, () => DoDoor(sName, new uint(), sActor, oDoor, bLock, false));
            RegisterActor(sName, new uint(), sActor);
        }
        ...
        {
            string sName = GetLocalString(GetModule(), "cutscene");
            DelayCommand(fDelay, () => DoDoor(sName, new uint(), sActor, oDoor, bUnlock, true));
            RegisterActor(sName, new uint(), sActor);
        }
        ...
        {
            string sName = GetLocalString(GetModule(), "cutscene");
            DelayCommand(fDelay, () => DoWait(sName, new uint(), sActor, fPause));
            RegisterActor(sName, new uint(), sActor);
        }
        ...
        {
            string sName = GetLocalString(GetModule(), "cutscene");
            DelayCommand(fDelay, () => DoDestroy(sName, new uint(), sActor, oTarget, sTarget, true));
            RegisterActor(sName, new uint(), sActor);
        }
        ...
        {
            string sName = GetLocalString(GetModule(), "cutscene");
            DelayCommand(fDelay, () => DoDestroy(sName, new uint(), "", oTarget, sTarget, false));
        }
