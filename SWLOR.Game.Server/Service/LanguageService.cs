    ...
    public static class LanguageService
    {
        ...
        public static int GetColour(SkillType language)
        {
            ...
            switch (language)
            {
                ...
                case SkillType.Togruti: r = 0; g = 100; b = 150; break;
                case SkillType.Rodese: r = 50; g = 100; b = 0; break;
                case SkillType.KelDor: r = 150; g = 100; b = 0; break;
            }
            ...
            get
            {
                if (_languages == null)
                {
                    var languages = new List<LanguageCommand>
                    {
                        ...
                        new LanguageCommand("Togruti", SkillType.Togruti, new []{"togruti", "togruta"}),
                        new LanguageCommand("Rodese", SkillType.Rodese, new []{"rodese", "rodian"}),
                        new LanguageCommand("Kel Dor", SkillType.KelDor, new []{"keldor", "dorian", "keldorian", "keldorese", "dorese"})
                    };
