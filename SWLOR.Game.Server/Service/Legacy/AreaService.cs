    ...
    public static class AreaService
    {
        ...
        private static void OnModuleLoad()
        {
            ...
            foreach (var area in areas)
            {
                ...
                int width = NWScript.GetAreaSize(Dimension.Width, area.Object);
                int height = NWScript.GetAreaSize(Dimension.Height, area.Object);
        ...
        private static void BakeArea(NWArea area)
        {
            ...
            for (int x = 0; x < arraySizeX; x++)
            {
                ...
                {
                    Location checkLocation = NWScript.Location(area.Object, NWScript.Vector3(x * AreaBakeStep, y * AreaBakeStep), 0.0f);
        ...
        private static void OnAreaEnter()
        {
            ...
            int playerCount = Core.NWNX.Area.GetNumberOfPlayersInArea(area);
            if (playerCount > 0)
