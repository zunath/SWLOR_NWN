...
namespace SWLOR.Game.Server.Service
{
    public static class LightsaberWorkbench
    {
        ...
        private static readonly List<SaberHiltPart> _lightsaberHilts = new()
        {
            ...
            new SaberHiltPart(71, "Hilt 7.1", "iwswglsbr_b_071"),
            new SaberHiltPart(81, "Hilt 8.1 (Curved)", "ui_lsh_081", true),
            new SaberHiltPart(91, "Hilt 9.1", "iwswglsbr_b_091"),
            new SaberHiltPart(101, "Hilt 10.1", "iwswglsbr_b_101"),
            ...
            new SaberHiltPart(191, "Hilt 19.1 (Curved)", "ui_lsh_191", true),
            new SaberHiltPart(201, "Hilt 20.1 (Curved)", "ui_lsh_201", true),
            new SaberHiltPart(211, "Hilt 21.1", "ui_lsh_211"),
            new SaberHiltPart(221, "Hilt 22.1", "ui_lsh_221"),
            new SaberHiltPart(231, "Hilt 23.1 (Curved)", "ui_lsh_231", true),
            new SaberHiltPart(232, "Hilt 23.2 (Curved)", "ui_lsh_232", true),
            new SaberHiltPart(241, "Hilt 24.1", "ui_lsh_241"),
            new SaberHiltPart(242, "Hilt 24.2 (Curved, Jedi)", "ui_lsh_242", true),
            new SaberHiltPart(243, "Hilt 24.3 (Curved, Empire)", "ui_lsh_243", true),
        ...
        private static readonly List<SaberBladeColor> _bladeColors = new()
        {
            ...
            new SaberBladeColor("Green", 13, 33, 13, "ui_lsc_green"),
