...
{
    public interface IAdministrationPluginService
    {
        /// <summary>
        ...
        /// </remarks>
        void DeletePlayerCharacter(uint pc, bool bPreserveBackup = true, string kickMessage = "");
        ...
        /// </remarks>
        bool GetPlayOption(AdministrationOptionType option);
        ...
        /// </remarks>
        void SetPlayOption(AdministrationOptionType option, bool value);
        ...
        /// </remarks>
        bool DeleteTURD(string playerName, string characterName);
        ...
        /// </remarks>
        bool GetDebugValue(AdministrationDebugType type);
        ...
        /// </remarks>
        void SetDebugValue(AdministrationDebugType type, bool state);
