...
public interface IAreaPluginService
{
    ...
    /// </remarks>
    int GetNumberOfPlayersInArea(uint area);
    ...
    /// </remarks>
    PvPSettingType GetPVPSetting(uint area);
    ...
    /// </remarks>
    void SetPVPSetting(uint area, PvPSettingType pvpSetting);
    ...
    /// </remarks>
    int GetAreaSpotModifier(uint area);
    ...
    /// Useful for creating areas with enhanced or reduced visibility conditions.
    /// </remarks>
    void SetAreaSpotModifier(uint area, int spotModifier);
    ...
    /// </remarks>
    int GetAreaListenModifier(uint area);
    ...
    /// Useful for creating areas with enhanced or reduced hearing conditions.
    /// </remarks>
    void SetAreaListenModifier(uint area, int listenModifier);
    ...
    /// </remarks>
    bool GetNoRestingAllowed(uint area);
    ...
    /// This is useful for dangerous or hostile areas where resting would be inappropriate.
    /// </remarks>
    void SetNoRestingAllowed(uint area, bool bNoRestingAllowed);
    ...
    /// Higher wind levels create more dramatic environmental effects.
    /// </remarks>
    void SetWindPower(uint area, int windPower);
    ...
    /// </remarks>
    int GetWeatherChance(uint area, WeatherEffectType type);
    ...
    /// </remarks>
    void SetWeatherChance(uint area, WeatherEffectType type, int chance);
    ...
    /// </remarks>
    float GetFogClipDistance(uint area);
    ...
    /// Lower values improve performance but reduce visibility range.
    /// </remarks>
    void SetFogClipDistance(uint area, float distance);
    ...
    /// </remarks>
    int GetShadowOpacity(uint area);
    ...
    /// Higher values create darker, more prominent shadows.
    /// </remarks>
    void SetShadowOpacity(uint area, int shadowOpacity);
    ...
    /// </remarks>
    AreaDayNightCycleType GetDayNightCycle(uint area);
    ...
    /// </remarks>
    void SetDayNightCycle(uint area, AreaDayNightCycleType type);
    ...
    /// </remarks>
    int GetSunMoonColors(uint area, AreaLightColorType type);
    ...
    /// </remarks>
    void SetSunMoonColors(uint area, AreaLightColorType type, int color);
    ...
    /// </remarks>
    uint CreateTransition(uint area, uint target, float x, float y, float z, float size = 2.0f,
        string tag = "");
    ...
    /// </remarks>
    bool GetTileAnimationLoop(uint area, float tileX, float tileY, int animLoop);
    ...
    /// </remarks>
    void SetTileAnimationLoop(uint area, float tileX, float tileY, int animLoop, bool enabled);
    ...
    /// </remarks>
    uint CreateGenericTrigger(uint area, float x, float y, float z, string tag = "",
        float size = 1.0f);
    ...
    /// </remarks>
    void AddObjectToExclusionList(uint oObject);
    ...
    /// </remarks>
    void RemoveObjectFromExclusionList(uint oObject);
    ...
    /// </remarks>
    bool ExportGIT(uint oArea, string sFileName = "", bool bExportVarTable = true, bool bExportUUID = true, int nObjectFilter = 0, string sAlias = "NWNX");
    ...
    /// </remarks>
    TileInfo GetTileInfo(uint oArea, float fTileX, float fTileY);
    ...
    /// <returns>True if the export was successful, false if it failed.</returns>
    /// <remarks>
    /// The .are file contains the area's basic properties, terrain, and elements.
    /// This is useful for backing up areas or transferring them between modules.
    /// The filename should be lowercase and will become the area's resource reference.
    /// </remarks>
    bool ExportARE(uint oArea, string sFileName, string sNewName = "", string sNewTag = "", string sAlias = "NWNX");
    ...
    /// </remarks>
    int GetAmbientSoundDay(uint oArea);
    ...
    /// </remarks>
    int GetAmbientSoundNight(uint oArea);
    ...
    /// </remarks>
    int GetAmbientSoundDayVolume(uint oArea);
    ...
    /// Volume values typically range from 0 (silent) to 100 (maximum volume).
    /// </remarks>
    int GetAmbientSoundNightVolume(uint oArea);
    ...
    /// </remarks>
    uint CreateSoundObject(uint oArea, Vector3 vPosition, string sResRef);
    ...
    /// </remarks>
    void RotateArea(uint oArea, int nRotation);
    ...
    /// </remarks>
    TileInfo GetTileInfoByTileIndex(uint oArea, int nTileIndex);
    ...
    /// </remarks>
    bool GetPathExists(uint oArea, Vector3 vStart, Vector3 vEnd, int nMaxDepth);
    ...
    /// </remarks>
    void SetAreaFlags(uint oArea, int nFlags);
    ...
    /// </remarks>
    AreaWind GetAreaWind(uint oArea);
    ...
    /// </remarks>
    void SetDefaultObjectUiDiscoveryMask(uint oArea, int nObjectTypes, int nMask, bool bForceUpdate = false);
}