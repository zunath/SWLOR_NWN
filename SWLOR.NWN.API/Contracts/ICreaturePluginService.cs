...
public interface ICreaturePluginService
{
    /// <summary>
    ...
    /// </remarks>
    void AddFeat(uint creature, FeatType feat);
    ...
    /// The feat will be immediately available to the creature.
    /// </remarks>
    void AddFeatByLevel(uint creature, FeatType feat, int level);
    ...
    /// </remarks>
    void RemoveFeat(uint creature, FeatType feat);
    ...
    /// </remarks>
    bool GetKnowsFeat(uint creature, FeatType feat);
    ...
    /// </remarks>
    int GetFeatCountByLevel(uint creature, int level);
    ...
    /// </remarks>
    FeatType GetFeatByLevel(uint creature, int level, int index);
    ...
    /// </remarks>
    int GetFeatCount(uint creature);
    ...
    /// </remarks>
    FeatType GetFeatByIndex(uint creature, int index);
    ...
    /// </remarks>
    bool GetMeetsFeatRequirements(uint creature, FeatType feat);
    ...
    /// </remarks>
    SpecialAbilitySlot GetSpecialAbility(uint creature, int index);
    ...
    /// </remarks>
    int GetSpecialAbilityCount(uint creature);
    ...
    /// </remarks>
    void AddSpecialAbility(uint creature, SpecialAbilitySlot ability);
    ...
    /// Use GetSpecialAbilityCount() to determine the valid index range.
    /// </remarks>
    void RemoveSpecialAbility(uint creature, int index);
    ...
    /// Use GetSpecialAbilityCount() to determine the valid index range.
    /// </remarks>
    void SetSpecialAbility(uint creature, int index, SpecialAbilitySlot ability);
    ...
    /// </remarks>
    ClassType GetClassByLevel(uint creature, int level);
    ...
    /// </remarks>
    void SetBaseAC(uint creature, int ac);
    ...
    /// </remarks>
    void SetRawAbilityScore(uint creature, AbilityType ability, int value);
    ...
    /// </remarks>
    int GetRawAbilityScore(uint creature, AbilityType ability);
    ...
    /// </remarks>
    void ModifyRawAbilityScore(uint creature, AbilityType ability, int modifier);
    ...
    /// </remarks>
    int GetPrePolymorphAbilityScore(uint creature, AbilityType ability);
    ...
    /// </remarks>
    int GetRemainingSpellSlots(uint creature, ClassType classId, int level);
    ...
    /// </remarks>
    void SetRemainingSpellSlots(uint creature, ClassType classId, int level, int slots);
    ...
    /// </remarks>
    void RemoveKnownSpell(uint creature, ClassType classId, int level, int spellId);
    ...
    /// </remarks>
    void AddKnownSpell(uint creature, ClassType classId, int level, int spellId);
    ...
    /// </remarks>
    int GetMaxSpellSlots(uint creature, ClassType classId, int level);
    ...
    /// </remarks>
    int GetMaxHitPointsByLevel(uint creature, int level);
    ...
    /// </remarks>
    void SetMaxHitPointsByLevel(uint creature, int level, int value);
    ...
    /// </remarks>
    void SetMovementRate(uint creature, MovementRateType rate);
    ...
    /// </remarks>
    float GetMovementRateFactor(uint creature);
    ...
    /// </remarks>
    void SetMovementRateFactor(uint creature, float factor);
    ...
    /// </remarks>
    void SetAlignmentGoodEvil(uint creature, int value);
    ...
    /// </remarks>
    void SetAlignmentLawChaos(uint creature, int value);
    ...
    /// </remarks>
    void SetSkillRank(uint creature, NWNSkillType skill, int rank);
    ...
    /// </remarks>
    void SetClassByPosition(uint creature, int position, ClassType classId, bool updateLevels = true);
    ...
    /// </remarks>
    void SetBaseAttackBonus(uint creature, int bab);
    ...
    /// </remarks>
    int GetAttacksPerRound(uint creature, bool bBaseAPR);
    ...
    /// </remarks>
    void RestoreFeats(uint creature);
    ...
    /// </remarks>
    void RestoreSpecialAbilities(uint creature);
    ...
    /// </remarks>
    void RestoreItems(uint creature);
    ...
    /// </remarks>
    void SetSize(uint creature, CreatureSizeType creatureSize);
    ...
    /// </remarks>
    int GetSkillPointsRemaining(uint creature);
    ...
    /// The value should be reasonable for the creature's level and class.
    /// </remarks>
    void SetSkillPointsRemaining(uint creature, int skillpoints);
    ...
    /// </remarks>
    void SetRacialType(uint creature, RacialType racialtype);
    ...
    /// </remarks>
    MovementType GetMovementType(uint creature);
    ...
    /// </remarks>
    void SetWalkRateCap(uint creature, float fWalkRate);
    ...
    /// </remarks>
    void SetGold(uint creature, int gold);
    ...
    /// </remarks>
    void SetCorpseDecayTime(uint creature, int decayTimeMs);
    ...
    /// </remarks>
    int GetBaseSavingThrow(uint creature, int which);
    ...
    /// </remarks>
    void SetBaseSavingThrow(uint creature, SavingThrowCategoryType which, int value);
    ...
    /// </remarks>
    void LevelUp(uint creature, ClassType classId, int count = 1);
    ...
    /// </remarks>
    void LevelDown(uint creature, int count = 1);
    ...
    /// </remarks>
    void SetChallengeRating(uint creature, float fCR);
    ...
    /// </remarks>
    int GetAttackBonus(uint creature, bool isMelee = true, bool isTouchAttack = false,
    ...
    /// </remarks>
    int GetHighestLevelOfFeat(uint creature, int feat);
    ...
    /// </remarks>
    int GetFeatRemainingUses(uint creature, FeatType feat);
    ...
    /// </remarks>
    int GetFeatTotalUses(uint creature, FeatType feat);
    ...
    /// </remarks>
    void SetFeatRemainingUses(uint creature, FeatType feat, int uses);
    ...
    /// </remarks>
    int GetTotalEffectBonus(uint creature, BonusType bonusType = BonusType.Attack,
    ...
    /// </remarks>
    void SetOriginalName(uint creature, string name, bool isLastName);
    ...
    /// </remarks>
    string GetOriginalName(uint creature, bool isLastName);
    ...
    /// </remarks>
    void SetSpellResistance(uint creature, int sr);
    ...
    /// </remarks>
    void SetAnimalCompanionName(uint creature, string name);
    ...
    /// </remarks>
    void SetFamiliarName(uint creature, string name);
    ...
    /// </remarks>
    bool GetDisarmable(uint creature);
    ...
    /// </remarks>
    void SetDisarmable(uint creature, bool isDisarmable);
    ...
    /// </remarks>
    void SetDomain(uint creature, ClassType @class, int index, int domain);
    ...
    /// </remarks>
    void SetSpecialization(uint creature, ClassType @class, int school);
    ...
    /// </remarks>
    void SetFaction(uint creature, int factionId);
    ...
    /// </remarks>
    bool GetFlatFooted(uint creature);
    ...
    /// </remarks>
    string SerializeQuickbar(uint creature);
    ...
    /// </remarks>
    bool DeserializeQuickbar(uint creature, string serializedQuickbar);
    ...
    /// </remarks>
    void SetEncounter(uint creature, uint encounter);
    ...
    /// </remarks>
    uint GetEncounter(uint creature);
    ...
    /// </remarks>
    void OverrideDamageLevel(uint creature, int damageLevel);
    ...
    /// </remarks>
    bool GetIsBartering(uint creature);
    ...
    /// </remarks>
    void SetLastItemCasterLevel(uint creature, int casterLevel);
    ...
    /// </remarks>
    int GetLastItemCasterLevel(uint creature);
    ...
    /// </remarks>
    int GetArmorClassVersus(uint attacked, uint versus, bool touch = false);
    ...
    /// </remarks>
    void JumpToLimbo(uint creature);
    ...
    /// </remarks>
    void SetCriticalMultiplierModifier(uint creature, int modifier, int hand = 0, bool persist = false, BaseItemType baseItemType = BaseItemType.Invalid);
    ...
    /// </remarks>
    int GetCriticalMultiplierModifier(uint creature, int hand = 0, BaseItemType baseItemType = BaseItemType.Invalid);
    ...
    /// Persistence is activated each server reset by first use of either 'SetCriticalMultiplier*' functions.
    /// </remarks>
    void SetCriticalMultiplierOverride(uint creature, int @override, int hand = 0, bool persist = false, BaseItemType baseItemType = BaseItemType.Invalid);
    ...
    /// </remarks>
    int GetCriticalMultiplierOverride(uint creature, int hand = 0, BaseItemType baseItemType = BaseItemType.Invalid);
    ...
    /// </remarks>
    void SetCriticalRangeModifier(uint creature, int modifier, int hand = 0, bool persist = false, BaseItemType baseItemType = BaseItemType.Invalid);
    ...
    /// Returns 0 if no modifier is set or if there's an error.
    /// </remarks>
    int GetCriticalRangeModifier(uint creature, int hand = 0, BaseItemType baseItemType = BaseItemType.Invalid);
    ...
    /// </remarks>
    void SetCriticalRangeOverride(uint creature, int @override, int hand = 0, bool persist = false, BaseItemType baseItemType = BaseItemType.Invalid);
    ...
    /// Returns 0 if no override is set or if there's an error.
    /// </remarks>
    int GetCriticalRangeOverride(uint creature, int hand = 0, BaseItemType baseItemType = BaseItemType.Invalid);
    ...
    /// </remarks>
    void AddAssociate(uint creature, uint associate, int associateType);
    ...
    /// </remarks>
    int GetWalkAnimation(uint creature);
    ...
    /// </remarks>
    void SetWalkAnimation(uint creature, int animation);
    ...
    /// </remarks>
    void SetAttackRollOverride(uint creature, int roll, int modifier);
    ...
    /// </remarks>
    void SetParryAllAttacks(uint creature, bool parry);
    ...
    /// </remarks>
    bool GetNoPermanentDeath(uint creature);
    ...
    /// This is typically used for important NPCs or special creatures.
    /// </remarks>
    void SetNoPermanentDeath(uint creature, bool noPermanentDeath);
    ...
    /// </remarks>
    Vector3 ComputeSafeLocation(uint creature, Vector3 position, float radius = 20.0f, bool walkStraightLineRequired = true);
    ...
    /// </remarks>
    void DoPerceptionUpdateOnCreature(uint creature, uint targetCreature);
    ...
    /// </remarks>
    float GetPersonalSpace(uint creature);
    ...
    /// Larger values mean the creature needs more space around it.
    /// </remarks>
    void SetPersonalSpace(uint creature, float personalSpace);
    ...
    /// </remarks>
    float GetCreaturePersonalSpace(uint creature);
    ...
    /// This is different from the general personal space and is specific to creature-to-creature interactions.
    /// </remarks>
    void SetCreaturePersonalSpace(uint creature, float creaturePersonalSpace);
    ...
    /// The height is used for determining if the creature can fit in certain spaces.
    /// </remarks>
    void SetHeight(uint creature, float height);
    ...
    /// </remarks>
    float GetHitDistance(uint creature);
    ...
    /// This affects melee combat range and AI behavior.
    /// </remarks>
    void SetHitDistance(uint creature, float hitDistance);
    ...
    /// </remarks>
    float GetPreferredAttackDistance(uint creature);
    ...
    /// This affects AI behavior and combat positioning.
    /// </remarks>
    void SetPreferredAttackDistance(uint creature, float preferredAttackDistance);
    ...
    /// </remarks>
    int GetArmorCheckPenalty(uint creature);
    ...
    /// The penalty is usually negative (reduces skill checks).
    /// </remarks>
    int GetShieldCheckPenalty(uint creature);
    ...
    /// </remarks>
    void SetBypassEffectImmunity(uint creature, int immunityType, int chance = 100, bool persist = false);
    ...
    /// </remarks>
    int GetBypassEffectImmunity(uint creature, int immunityType);
    ...
    /// </remarks>
    int GetNumberOfBonusSpells(uint creature, int multiClass, int spellLevel);
    ...
    /// </remarks>
    void ModifyNumberBonusSpells(uint creature, int multiClass, int spellLevel, int delta);
    ...
    /// </remarks>
    void SetCasterLevelModifier(uint creature, ClassType classId, int modifier, bool persist = false);
    ...
    /// Returns 0 if no modifier is set or if there's an error.
    /// </remarks>
    int GetCasterLevelModifier(uint creature, ClassType classId);
    ...
    /// This affects spell power, duration, and other caster level dependent effects.
    /// </remarks>
    void SetCasterLevelOverride(uint creature, ClassType classId, int casterLevel, bool persist = false);
    ...
    /// </remarks>
    int GetCasterLevelOverride(uint creature, ClassType classId);
}