...
public interface IEventsPluginService
{
    ...
    /// </remarks>
    void UnsubscribeEvent(string evt, string script);
    ...
    /// </remarks>
    bool SignalEvent(string evt, uint target);
    ...
    /// </remarks>
    string GetEventData(string tag);
    ...
    void ToggleDispatchListMode(string sEvent, string sScript, bool bEnable);
    ...
    void AddObjectToDispatchList(string sEvent, string sScript, uint oObject);
    ...
    void RemoveObjectFromDispatchList(string sEvent, string sScript, uint oObject);
    ...
    void ToggleIDWhitelist(string sEvent, bool bEnable);
    ...
    void AddIDToWhitelist(string sEvent, int nID);
    ...
    /// <param name="nID">The ID.</param>
    /// <remarks>See ToggleIDWhitelist for valid events and ID types.</remarks>
    void RemoveIDFromWhitelist(string sEvent, int nID);
}