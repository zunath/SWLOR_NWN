...
{
    public interface IFeedbackPluginService
    {
        /// <summary>
        ...
        /// </remarks>
        bool GetFeedbackMessageHidden(FeedbackMessageTypes messageType, uint? player = null);
        ...
        /// </remarks>
        void SetFeedbackMessageHidden(FeedbackMessageTypes messageType, bool hide, uint? player = null);
        ...
        /// Personal settings override global settings when both are configured.
        /// </remarks>
        bool GetCombatLogMessageHidden(CombatLogMessageType messageType, uint? player = null);
        ...
        /// Changes take effect immediately and persist until modified again.
        /// </remarks>
        void SetCombatLogMessageHidden(CombatLogMessageType messageType, bool hide, uint? player = null);
        ...
        /// Personal settings override global settings when both are configured.
        /// </remarks>
        bool GetJournalUpdatedMessageHidden(uint? player = null);
        ...
        /// Changes take effect immediately and persist until modified again.
        /// </remarks>
        void SetFeedbackMessageMode(bool whiteList);
        ...
        /// Changes take effect immediately and persist until modified again.
        /// </remarks>
        void SetCombatLogMessageMode(bool whiteList);
    }
}