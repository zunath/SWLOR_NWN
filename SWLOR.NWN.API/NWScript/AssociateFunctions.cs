...
namespace SWLOR.NWN.API.NWScript
{
    public partial class NWScript
    {
        ...
        /// </summary>
        /// <param name="oTarget">The target to initialize (default: OBJECT_INVALID)</param>
        ...
        /// <param name="oAssociate">The associate to remove (default: OBJECT_INVALID)</param>
        ...
        /// <param name="oMaster">The master to get the associate for (default: OBJECT_INVALID)</param>
        ...
        /// <param name="oHenchman">The henchman to add (default: OBJECT_INVALID)</param>
        ...
        /// <param name="oHenchman">The henchman to remove (default: OBJECT_INVALID)</param>
        ...
        /// </summary>
        /// <param name="oMaster">The master to get the henchman for (default: OBJECT_INVALID)</param>
        ...
        /// </summary>
        /// <param name="oMaster">The master to summon the animal companion for (default: OBJECT_INVALID)</param>
        ...
        /// </summary>
        /// <param name="oMaster">The master to summon the familiar for (default: OBJECT_INVALID)</param>
        ...
        /// </summary>
        /// <param name="oAssociate">The associate to get the last command for (default: OBJECT_INVALID)</param>
        ...
        /// </summary>
        /// <param name="oAssociate">The associate to get the master for (default: OBJECT_INVALID)</param>
