...
namespace SWLOR.NWN.API.NWScript
{
    public partial class NWScriptService
    {
        ...
        public bool GetItemCursedFlag(uint oItem)
        {
        ...
        public void SetItemCursedFlag(uint oItem, bool nCursed)
        {
        ...
        public uint CreateItemOnObject(string sResRef, uint oTarget = OBJECT_INVALID, int nStackSize = 1,
            string sNewTag = "")
        {
        ...
        public Effect EffectDeath(bool nSpectacularDeath = false, bool nDisplayFeedback = true)
        {
        ...
        public Effect EffectCurse(int nStrMod = 1, int nDexMod = 1, int nConMod = 1, int nIntMod = 1,
        ...
        public Effect EffectSavingThrowIncrease(int nSave, int nValue,
        ...
        public Effect EffectAccuracyIncrease(int nBonus, AttackBonusType nModifierType = AttackBonusType.Misc)
        {
        ...
        public Effect EffectDamageReduction(int nAmount, DamagePowerType nDamagePower, int nLimit = 0)
        {
        ...
        public Effect EffectDamageIncrease(int nBonus, DamageType nDamageType = DamageType.Force)
        {
        ...
        public Effect GetFirstEffect(uint oCreature)
        {
        ...
        public Effect GetNextEffect(uint oCreature)
        {
        ...
        public void RemoveEffect(uint oCreature, Effect eEffect)
        {
        ...
        public bool GetIsEffectValid(Effect eEffect)
        {
        ...
        public uint GetEffectCreator(Effect eEffect)
        {
        ...
        /// <remarks>This should be applied as an instantaneous effect.</remarks>
        public Effect EffectDamage(int nDamageAmount, DamageType nDamageType = DamageType.Force,
        ...
        public Effect EffectAbilityIncrease(AbilityType nAbilityToIncrease, int nModifyBy)
        {
        ...
        public Effect EffectDamageResistance(DamageType nDamageType, int nAmount, int nLimit = 0)
        {
        ...
        public Effect EffectSummonCreature(string sCreatureResref, VisualEffectType nVisualEffectId = VisualEffectType.Vfx_Com_Sparks_Parry,
        ...
        public Effect EffectSpellFailure(int nPercent = 100,
        ...
        public Effect EffectSwarm(int nLooping, string sCreatureTemplate1, string sCreatureTemplate2 = "",
        ...
        /// <remarks>You must use the DAMAGE_BONUS_* constants! Using other values may result in odd behavior.</remarks>
        public Effect EffectDamageShield(int nDamageAmount, ItemPropertyDamageBonusType nRandomAmount, DamageType nDamageType)
        {
        ...
        public Effect EffectMissChance(int nPercentage, MissChanceType nMissChanceType = MissChanceType.Normal)
        {
        ...
        public Effect EffectInvisibility(InvisibilityType nInvisibilityType)
        {
        ...
        public Effect EffectConcealment(int nPercentage, MissChanceType nMissType = MissChanceType.Normal)
        {
        ...
        public Effect EffectNegativeLevel(int nNumLevels, bool bHPBonus = false)
        {
        ...
        public Effect EffectPolymorph(int nPolymorphSelection, bool nLocked = false)
        {
        ...
        public Effect EffectAbilityDecrease(AbilityType nAbility, int nModifyBy)
        {
        ...
        /// <remarks>On SWLOR, this is used for Accuracy.</remarks>
        public Effect EffectAccuracyDecrease(int nPenalty, AttackBonusType nModifierType = AttackBonusType.Misc)
        {
        ...
        public Effect EffectDamageDecrease(int nPenalty, DamageType nDamageType = DamageType.Force)
        {
        ...
        /// <remarks>Possible save types: SAVING_THROW_ALL, SAVING_THROW_FORT, SAVING_THROW_REFLEX, SAVING_THROW_WILL</remarks>
        public Effect EffectSavingThrowDecrease(int nSave, int nValue,
            SavingThrowType nSaveType = SavingThrowType.All)
        {
        ...
        public Event EventActivateItem(uint oItem, Location lTarget, uint oTarget = OBJECT_INVALID)
        {
            if (oTarget == OBJECT_INVALID)
                oTarget = OBJECT_SELF;
        ...
        public Effect VersusAlignmentEffect(Effect eEffect,
        ...
        /// <returns>The modified effect</returns>
        public Effect VersusRacialTypeEffect(Effect eEffect, RacialType nRacialType)
        {
        ...
        public Effect EffectSkillIncrease(NWNSkillType nSkill, int nValue)
        {
        ...
        public Effect EffectDamageImmunityIncrease(DamageType nDamageType, int nPercentImmunity)
        {
        ...
        public Effect EffectImmunity(ImmunityType nImmunityType)
        {
        ...
        public Effect EffectPoison(PoisonType nPoisonType)
        {
        ...
        public Effect EffectDisease(DiseaseType nDiseaseType)
        {
        ...
        public Effect EffectBeam(VisualEffectType nBeamVisualEffect, uint oEffector, BodyNodeType nBodyPart, bool bMissEffect = false)
        {
        ...
        public Effect EffectVisualEffect(VisualEffectType visualEffectID, bool nMissEffect = false, float fScale = 1.0f, Vector3 vTranslate = new(), Vector3 vRotate = new())
        {
        ...
        public void ApplyEffectToObject(DurationType nDurationType, Effect eEffect, uint oTarget,
        ...
        public EffectScriptType GetEffectType(Effect eEffect)
        {
        ...
        public Effect EffectAreaOfEffect(AreaOfEffectType nAreaEffect, string sOnEnterScript = "",
        ...
        public Effect EffectSpellImmunity(SpellType nImmunityToSpell = SpellType.AllSpells)
        {
        ...
        public int GetEffectInteger(Effect eEffect, int nIndex)
        {
        ...
        /// <remarks>Some experimentation will be needed to find the right index for the value you wish to determine.</remarks>
        public float GetEffectFloat(Effect eEffect, int nIndex)
        {
        ...
        /// <remarks>Some experimentation will be needed to find the right index for the value you wish to determine.</remarks>
        public string GetEffectString(Effect eEffect, int nIndex)
        {
        ...
        /// <remarks>Some experimentation will be needed to find the right index for the value you wish to determine.</remarks>
        public uint GetEffectObject(Effect eEffect, int nIndex)
        {
        ...
        /// <remarks>Some experimentation will be needed to find the right index for the value you wish to determine.</remarks>
        public Vector3 GetEffectVector(Effect eEffect, int nIndex)
        {
        ...
        public Effect EffectRunScript(string sOnAppliedScript = "", string sOnRemovedScript = "", string sOnIntervalScript = "", float fInterval = 0.0f, string sData = "")
        {
        ...
        public Effect GetLastRunScriptEffect()
        {
        ...
        public int GetLastRunScriptEffectScriptType()
        {
        ...
        public Effect HideEffectIcon(Effect eEffect)
        {
        ...
        public Effect EffectIcon(EffectIconType nIconId)
        {
        ...
        public Effect UnyieldingEffect(Effect eEffect)
        {
        ...
        public Effect IgnoreEffectImmunity(Effect eEffect)
        {
        ...
        public string GetEffectLinkId(Effect eEffect)
        {
        ...
        public Effect EffectBonusFeat(int nFeat)
        {
        ...
        public Effect EffectTimeStopImmunity()
        {
        ...
        /// <returns>The modified effect</returns>
        public Effect SetEffectCreator(Effect eEffect, uint oCreator)
        {
        ...
        /// <returns>The modified effect</returns>
        public Effect SetEffectCasterLevel(Effect eEffect, int nCasterLevel)
        {
        ...
        /// <returns>The modified effect</returns>
        public Effect SetEffectSpellId(Effect eEffect, SpellType nSpellId)
        {
