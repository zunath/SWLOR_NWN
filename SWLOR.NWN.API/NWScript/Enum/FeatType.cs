namespace SWLOR.NWN.API.NWScript.Enum
{
    public enum FeatType
    {
        ...
        BloodPatternTrait = 1404,
        RuptureSetupTrait = 1405,
        ComboPressureTrait = 1406,
        OpenArteryTrait = 1407,
        MeasuredCutsTrait = 1408,
        ...
        VeiledStrike4 = 2771,
        EscapeArtist1 = 2772,
        ToxicSpitTechnique = 2773,
        FrostSpitTechnique = 2774,
        RakingClawsTechnique = 2775,
        SonicShriekTechnique = 2776,
        TailSweepTechnique = 2777,
        StaticWebTechnique = 2778,
        GoringChargeTechnique = 2779,
        ToxicCloudTechnique = 2780,
        ScorchingBreathTechnique = 2781,
        TerrifyingBellowTechnique = 2782,
        CombatAnalyzerTrait = 2783,
        TechniquePotencyTrait = 2784,
        AnalyzerMemoryTrait = 2785,
        PatternRecognitionTrait = 2786,
        ApexCollapseTechnique = 2787,
        ArcPulseTechnique = 2788,
        BarbedVolleyTechnique = 2789,
        BloodFrenzyFlurryTechnique = 2790,
        BonecrusherBiteTechnique = 2791,
        BraceBreakerTechnique = 2792,
        BrutalBashTechnique = 2793,
        CapacitorSurgeTechnique = 2794,
        ChitinGuardTechnique = 2795,
        ConcussiveChallengeTechnique = 2796,
        CripplingTalonsTechnique = 2797,
        CrossfireDrillTechnique = 2798,
        CryoBileTechnique = 2799,
        DarkShockTechnique = 2800,
        DisorientingScreechTechnique = 2801,
        DreadWaveTechnique = 2802,
        EssenceScarTechnique = 2803,
        FinalEclipseTechnique = 2804,
        FinalLineTechnique = 2805,
        FinalMandateTechnique = 2806,
        FinalSuppressionTechnique = 2807,
        FinishingDriveTechnique = 2808,
        ForceRendTechnique = 2809,
        ForceSunderTechnique = 2810,
        GlacialSlimeTechnique = 2811,
        GrenadeBurstTechnique = 2812,
        HoarfrostGlobTechnique = 2813,
        HoldfastSlamTechnique = 2814,
        InfernoBlastTechnique = 2815,
        InnerCircleBindTechnique = 2816,
        InnerCirclePounceTechnique = 2817,
        InnerCircleSurgeTechnique = 2818,
        InnerCircleVolleyTechnique = 2819,
        InnerRingFlurryTechnique = 2820,
        InnerVoidTechnique = 2821,
        IonBurstTechnique = 2822,
        IronCarapaceTechnique = 2823,
        LastBastionTechnique = 2824,
        LockstepCrushTechnique = 2825,
        MaulingBiteTechnique = 2826,
        MercilessAngleTechnique = 2827,
        MindSpikeTechnique = 2828,
        NullShockTechnique = 2829,
        OpeningCutTechnique = 2830,
        OverloadShotTechnique = 2831,
        PackHarrierTechnique = 2832,
        PermafrostRuptureTechnique = 2833,
        PiercingQuillsTechnique = 2834,
        PouncingStrikeTechnique = 2835,
        PrecisionShotTechnique = 2836,
        PressureLockTechnique = 2837,
        RallyBreakerTechnique = 2838,
        RangefinderShotTechnique = 2839,
        RendingBiteTechnique = 2840,
        RendingCarveTechnique = 2841,
        RimePounceTechnique = 2842,
        RupturingQuakeTechnique = 2843,
        SavageRoarTechnique = 2844,
        SeismicSlamTechnique = 2845,
        SerratedSlashTechnique = 2846,
        ShrapnelBurstTechnique = 2847,
        SignalSnareTechnique = 2848,
        SnapRushTechnique = 2849,
        StaticBurstTechnique = 2850,
        StimCanisterTechnique = 2851,
        SuppressingShotTechnique = 2852,
        SustainBurnTechnique = 2853,
        TacticalMarkTechnique = 2854,
        TargetLockTechnique = 2855,
        VenomSprayTechnique = 2856,
        WardenClampTechnique = 2857,
        WardenMarkTechnique = 2858,
        WardenMaulTechnique = 2859,
        WardenOrderTechnique = 2860,
        WardenRendTechnique = 2861,
