namespace SWLOR.NWN.API.NWScript.Enum
{
    public enum ItemPropertyType
    {
        ...
        EnzymeColor = 129,
        Blueprint = 130,
        ShieldDeflection = 131,
        AttackDeflection = 132,
        CriticalRate = 133,
        Enmity = 134,
        Haste = 135,
        Slow = 136,
        AccuracyModifier = 137,
        RecastReductionModifier = 138,
        DefenseBypassModifier = 139,
        HealingModifier = 140,
        FPRestoreOnHit = 141,
        DefenseModifier = 142,
        ForceDefenseModifier = 143,
        AttackModifier = 144,
        ForceAttackModifier = 145,
        EvasionModifier = 146,
        Might = 147,
        Perception = 148,
        Vitality = 149,
