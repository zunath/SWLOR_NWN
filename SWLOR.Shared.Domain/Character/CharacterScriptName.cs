namespace SWLOR.Shared.Domain.Character
{
    internal class CharacterScriptName
    {
        ...
        public const string OnCharacterSTMRegenChanged = "char_stmreg_chg";
        public const string OnCharacterRecastReductionChanged = "char_recast_chg";
        ...
        public const string OnCharacterForceAttackChanged = "char_fatk_chg";
        ...
        public const string OnCharacterWillpowerChanged = "char_will_chg";
        public const string OnCharacterSocialChanged = "char_social_chg";
        public const string OnCharacterShieldDeflectionChanged = "char_shdefl_chg";
        public const string OnCharacterAttackDeflectionChanged = "char_atkdefl_chg";
        public const string OnCharacterCriticalRateChanged = "char_crit_chg";
        ...
        public const string OnCharacterDamageReductionChanged = "char_dmgred_chg";
        public const string OnCharacterForceDefenseChanged = "char_fdef_chg";
        public const string OnCharacterQueuedDMGBonusChanged = "char_qdmg_chg";
        public const string OnCharacterParalysisChanged = "char_para_chg";
        public const string OnCharacterAccuracyModifierChanged = "char_accmod_chg";
        public const string OnCharacterRecastReductionModifierChanged = "char_rcmod_chg";
        public const string OnCharacterDefenseBypassModifierChanged = "char_defbp_chg";
        public const string OnCharacterHealingModifierChanged = "char_hlmod_chg";
        public const string OnCharacterFPRestoreOnHitChanged = "char_fprest_chg";
        public const string OnCharacterDefenseModifierChanged = "char_defmod_chg";
        public const string OnCharacterForceDefenseModifierChanged = "char_fdefmod_chg";
        public const string OnCharacterExtraAttackModifierChanged = "char_extatkmod_chg";
        public const string OnCharacterAttackModifierChanged = "char_atkmod_chg";
        public const string OnCharacterForceAttackModifierChanged = "char_fatkmod_chg";
