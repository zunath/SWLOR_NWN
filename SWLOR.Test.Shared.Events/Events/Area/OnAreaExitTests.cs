...
namespace SWLOR.Test.Shared.Events.Events.Area
{
    ...
    public class OnAreaExitTests
    {
        ...
        {
            // Act
            var eventData1 = new OnAreaExit();
            var eventData2 = new OnAreaExit();
        ...
        public void Script_ReturnsCorrectScriptName()
        {
            ...
            // Assert
            Assert.That(eventData.Script, Is.EqualTo("area_exit"));
        }
    }
}
