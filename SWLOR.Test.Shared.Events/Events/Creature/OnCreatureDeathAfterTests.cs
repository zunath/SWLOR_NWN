...
{
    [TestFixture]
    public class OnCreatureDeathAfterTests
    {
        [Test]
        public void Constructor_SetsTimestamp()
        {
            ...
            // Act
            var eventData = new OnCreatureDeathAfter();
        ...
        {
            // Act
            var eventData1 = new OnCreatureDeathAfter();
            var eventData2 = new OnCreatureDeathAfter();
        ...
        public void Script_ReturnsCorrectScriptName()
        {
            ...
            // Assert
            Assert.That(eventData.Script, Is.EqualTo("crea_death_aft"));
        }
    }
}
