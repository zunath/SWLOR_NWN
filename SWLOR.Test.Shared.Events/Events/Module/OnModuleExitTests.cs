...
{
    [TestFixture]
    public class OnModuleExitTests
    {
        [Test]
        public void Constructor_SetsTimestamp()
        {
            ...
            // Act
            var eventData = new OnModuleExit();
        ...
        {
            // Act
            var eventData1 = new OnModuleExit();
            var eventData2 = new OnModuleExit();
        ...
        public void Script_ReturnsCorrectScriptName()
        {
            ...
            // Assert
            Assert.That(eventData.Script, Is.EqualTo("mod_exit"));
        }
    }
}
