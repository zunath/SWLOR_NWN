...
{
    [TestFixture]
    public class OnMaterialChangeAfterTests
    {
        [Test]
        public void Constructor_ShouldCreateInstance()
        {
            // Act
            var eventInstance = new OnMaterialChangeAfter();

            // Assert
            Assert.That(eventInstance, Is.Not.Null);
            Assert.That(eventInstance.Script, Is.EqualTo("material_chg_aft"));
        }
        ...
        {
            // Arrange
            var event1 = new OnMaterialChangeAfter();
            var event2 = new OnMaterialChangeAfter();
