...
{
    [TestFixture]
    public class OnMaterialChangeBeforeTests
    {
        [Test]
        public void Constructor_ShouldCreateInstance()
        {
            // Act
            var eventInstance = new OnMaterialChangeBefore();

            // Assert
            Assert.That(eventInstance, Is.Not.Null);
            Assert.That(eventInstance.Script, Is.EqualTo("material_chg_bef"));
        }
        ...
        {
            // Arrange
            var event1 = new OnMaterialChangeBefore();
            var event2 = new OnMaterialChangeBefore();
