...
{
    [TestFixture]
    public class OnPartyInviteBeforeTests
    {
        [Test]
        public void Constructor_ShouldCreateInstance()
        {
            // Act
            var eventInstance = new OnPartyInviteBefore();

            // Assert
            Assert.That(eventInstance, Is.Not.Null);
            Assert.That(eventInstance.Script, Is.EqualTo("pty_invite_bef"));
        }
        ...
        {
            // Arrange
            var event1 = new OnPartyInviteBefore();
            var event2 = new OnPartyInviteBefore();
