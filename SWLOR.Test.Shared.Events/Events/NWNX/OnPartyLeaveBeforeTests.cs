...
{
    [TestFixture]
    public class OnPartyLeaveBeforeTests
    {
        [Test]
        public void Constructor_ShouldCreateInstance()
        {
            // Act
            var eventInstance = new OnPartyLeaveBefore();

            // Assert
            Assert.That(eventInstance, Is.Not.Null);
            Assert.That(eventInstance.Script, Is.EqualTo("pty_leave_bef"));
        }
        ...
        {
            // Arrange
            var event1 = new OnPartyLeaveBefore();
            var event2 = new OnPartyLeaveBefore();
