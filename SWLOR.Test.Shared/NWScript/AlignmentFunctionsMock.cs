...
namespace SWLOR.NWN.API.NWScript
{
    public partial class NWScriptServiceMock
    {
        ...
        public ReputationData GetReputation(uint oTarget, uint oSource = OBJECT_INVALID)
        {
            var key = $"{oTarget}|{oSource}";
            return _reputationData.GetValueOrDefault(key, new ReputationData { Type = ReputationType.Neutral });
        }
