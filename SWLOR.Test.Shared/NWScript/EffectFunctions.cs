...
namespace SWLOR.NWN.API.NWScript
{
    public partial class NWScriptServiceMock
    {
        ...
        public Vector3 GetEffectVector(Effect eEffect, int nIndex) { var data = _effectVectors.GetValueOrDefault(eEffect, new Vector3[10]); return nIndex >= 0 && nIndex < data.Length ? data[nIndex] : Vector3.Zero; }
