namespace SWLOR.Test.Shared.NWScriptMocks
{
    public partial class NWScriptServiceMock
    {
        ...
        // Additional utility methods from INWScriptService
        // Note: Most methods from TempFunctionsMock.cs have been distributed to their appropriate files
        // This file contains general utility functions that don't fit into specific categories

        // Helper methods for testing
        public Dictionary<uint, string> GetObjectUUIDs() => _objectUUIDs;
        public Dictionary<string, uint> GetUUIDToObject() => _uuidToObject;
