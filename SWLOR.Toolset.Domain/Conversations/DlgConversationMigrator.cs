...
public static class DlgConversationMigrator
{
    ...
    private static readonly Dictionary<string, OperationMapping[]> CustomActions =
        new(StringComparer.OrdinalIgnoreCase)
        {
            ...
            ["ouvmag_cntrbande"] = [new OperationMapping("action-open-store", "tosche_contrebande_cantina")],
            ["ouvmag_cntrbnd_c"] = [new OperationMapping("action-open-store", "tosche_cantina_contrebande")],
