                ...
                Groups = new[]
                {
                    new FieldGroup
                    {
                        ...
                        Fields = new[]
                        {
                            ...
                            new FieldDescriptor { Label = "Description", FieldName = "DescIdentified", Kind = EditorKind.LocString, FieldType = GffFieldType.CExoLocString, Description = "Shown once the item is identified - the text players actually read." },
                            new FieldDescriptor { Label = "Unidentified Description", FieldName = "Description", Kind = EditorKind.LocString, FieldType = GffFieldType.CExoLocString },
