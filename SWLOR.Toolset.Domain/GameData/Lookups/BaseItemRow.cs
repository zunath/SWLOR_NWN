...
{
    /// <summary>
    /// baseitems.2da's label, ModelType, and StorePanel columns, keyed by row - what a UTI's
    ...
    public sealed record BaseItemRow(int Id, string Label, int ModelType, int StorePanel = 4);
}
