    ...
    public class CreatureEditorTests
    {
        ...
        public async Task CreatureEditorView_RendersItsConditionalVariablesTab()
        {
            ...
            try
            {
                ...
                appearanceSections.Items.Cast<TabItem>().Single(tab => tab.Header?.ToString() == "Tints")
                    .IsVisible.Should().BeFalse("this editor was constructed without a tint-map catalog");
