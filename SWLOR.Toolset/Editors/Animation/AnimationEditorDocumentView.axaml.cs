...
public partial class AnimationEditorDocumentView : UserControl
{
    ...
    private void Attach()
    {
        if (_viewModel != null) { _viewModel.PickOpenPath = null; _viewModel.PickSavePath = null; _viewModel.Stop(); }
    ...
    private void UpdatePreview()
    {
        ...
        var visible = this.FindControl<TabControl>("PreviewTabs")?.SelectedIndex == 1;
        _viewModel?.SetPreviewVisible(visible);
        this.FindControl<ModelPreviewControl>("ModelPreview")?.SetHostVisible(visible);
    }
}
