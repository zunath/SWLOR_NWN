...
{
    /// <summary>An ambient-sound blueprint open as a document tab.</summary>
    public sealed partial class SoundDocumentViewModel : Document, IEditorDocument
    {
        ...
        public event Action<SoundDocumentViewModel>? CloseRequested;

        public event Action? CatalogEntryChanged;
        public event Action<SoundDocumentViewModel, string, string>? Renamed;

        public SoundDocumentViewModel(
            string filePath,
            string resRef,
            ...
            Sources.ObjectSourceSectionViewModel? source = null)
        {
            ...
            Editor = new SoundEditorViewModel(
        ...
        public async Task<bool> TrySaveAsync()
        {
            ...
            try
            {
                ...
                var outcome = _saveCoordinator?.Save(
                    _session, ResourceType.Uts, oldResRef, targetResRef);
