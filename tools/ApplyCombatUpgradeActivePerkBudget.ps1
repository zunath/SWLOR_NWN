...
$budgetDescriptionByRow = @{
    ...
    "Rifle|18|Expose Weak Point" = "Aimed Shot marks the target for 12 seconds. Physical attacks against marked targets deal +10% damage."
    "Rifle|20|Breach Round" = "Aimed Shot ignores 25% of the target's Defense and deals +35 DMG."
    ...
    "Staff|41|Skull Rattle" = "Hostile Staff abilities deal +34 DMG and inflict Dazed for 3 seconds."
