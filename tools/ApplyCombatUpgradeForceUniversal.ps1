...
$forceRows = @(
    ...
    @{ Row = 62; PerkName = "Force Rage I"; Style = "Dark Ravager"; Alignment = "Dark"; AffinityShift = "-1" }
    ...
    @{ Row = 70; PerkName = "Force Rage II"; Style = "Dark Ravager"; Alignment = "Dark"; AffinityShift = "-1" }
    ...
    @{ Row = 76; PerkName = "Creeping Terror I"; Style = "Dark Manipulator"; Alignment = "Dark"; AffinityShift = "-1"; Description = "Creates a visible 4m field of grasping dark energy for 12 seconds. Enemies inside take 6 force DMG plus WIL scaling every 3 seconds and are Hobbled while inside."; Notes = "Reworked into a visual area denial field instead of a weaker single-target immobilize." }
    ...
    @{ Row = 80; PerkName = "Creeping Terror II"; Style = "Dark Manipulator"; Alignment = "Dark"; AffinityShift = "-1"; Description = "Creates a visible 4m field of grasping dark energy for 15 seconds. Enemies inside take 8 force DMG plus WIL scaling every 3 seconds and are Hobbled while inside."; Notes = "Replacement tier: longer duration and higher pulse damage." }
    ...
    @{ Row = 87; PerkName = "Creeping Terror III"; Style = "Dark Manipulator"; Alignment = "Dark"; AffinityShift = "-1"; Description = "Creates a visible 5m field of grasping dark energy for 18 seconds. Enemies inside take 10 force DMG plus WIL scaling every 3 seconds and are Hobbled while inside."; Notes = "Replacement tier: larger area, longer duration, and higher pulse damage." }
