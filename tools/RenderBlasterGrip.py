"""Render a blaster against the human right hand in the custom bowshot pose.
...
def main():
    ...
    # pmh0 rhand is a child of rhand_g. a_ba_med_weap bowshot keeps its rest transform.
    hook=Matrix.Translation(Vector((.0110681,0,-.0961281)))
    ...
    camera=scene.camera;camera.data.type='ORTHO';camera.data.ortho_scale=.61
    center=Vector((0,.07,-.105))
